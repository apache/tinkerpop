...
if [[ ! ${GREMLIN_SERVER_VERSION} =~ $re ]]; then
...
docker run ${TINKERPOP_TEST_DOCKER_OPTS} ${REMOVE_CONTAINER} -p 45940:45940 -p 45941:45941 -h gremlin-server-test -v "${HOME}"/.groovy:/root/.groovy \
