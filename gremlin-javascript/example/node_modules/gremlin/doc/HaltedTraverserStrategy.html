...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: HaltedTraverserStrategy</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: HaltedTraverserStrategy</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>HaltedTraverserStrategy<span class="signature">(haltedTraverserFactory)</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="HaltedTraverserStrategy"><span class="type-signature"></span>new HaltedTraverserStrategy<span class="signature">(haltedTraverserFactory)</span><span class="type-signature"></span></h4>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>haltedTraverserFactory</code></td>
...
<span class="param-type">String</span>
            ...
            <td class="description last">full qualified class name in Java of a {@code HaltedTraverserFactory} implementation</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="process_traversal-strategy.js.html">process/traversal-strategy.js</a>, <a href="process_traversal-strategy.js.html#line105">line 105</a>
    </li></ul></dd>
