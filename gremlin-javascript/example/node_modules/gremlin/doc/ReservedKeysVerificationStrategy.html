...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: ReservedKeysVerificationStrategy</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: ReservedKeysVerificationStrategy</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>ReservedKeysVerificationStrategy<span class="signature">(logWarnings, throwException, keys)</span><span class="type-signature"></span></h2>
...
<article>
    ...
    <h4 class="name" id="ReservedKeysVerificationStrategy"><span class="type-signature"></span>new ReservedKeysVerificationStrategy<span class="signature">(logWarnings, throwException, keys)</span><span class="type-signature"></span></h4>
...
<table class="params">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>logWarnings</code></td>
...
<span class="param-type">boolean</span>
            ...
            <td class="description last">determines if warnings should be written to the logger when verification fails</td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>throwException</code></td>
...
<span class="param-type">boolean</span>
            ...
            <td class="description last">determines if exceptions should be thrown when verifications fails</td>
        </tr>
...
<span class="param-type">Array.&lt;String></span>
            ...
            <td class="description last">the list of reserved keys to verify</td>
        </tr>
