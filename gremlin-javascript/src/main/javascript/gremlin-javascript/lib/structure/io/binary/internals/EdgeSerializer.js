  ...
  deserialize(buffer, fullyQualifiedFormat=true) {
    ...
    try {
      ...
      try {
        ...
        len += inVId_len; cursor = cursor.slice(inVId_len);
      } catch(e) {
      ...
      try {
        ...
        len += inVLabel_len; cursor = cursor.slice(inVLabel_len);
      } catch(e) {
      ...
      try {
        ...
        len += outVId_len; cursor = cursor.slice(outVId_len);
      } catch(e) {
      ...
      try {
        ...
        len += outVLabel_len; cursor = cursor.slice(outVLabel_len);
      } catch(e) {
      ...
      try {
        ({ v: parent, len: parent_len } = this.ioc.anySerializer.deserialize(cursor));
