...
const { typeKey, valueKey, LambdaSerializer: GraphsonLambdaSerializer } = require('../../type-serializers');
  ...
  serialize(item, fullyQualifiedFormat=true) {
    if (item === undefined || item === null)
      if (fullyQualifiedFormat)
        ...
        return Buffer.from([0x00,0x00,0x00,0x00, 0x00,0x00,0x00,0x00, 0x00,0x00,0x00,0x00]); // {language}='', {script}='', {arguments_length}=0
