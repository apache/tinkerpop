...
describe('GraphBinary.TraverserSerializer', () => {
  ...
  const cases = [
    ...
    { v:undefined,                           fq:0, b:[0x00,0x00,0x00,0x01, 0xFE,0x01], av:new Traverser(null) },
    { v:null,                                fq:1, b:[0x21, 0x01] },
    { v:null,                                fq:0, b:[0x00,0x00,0x00,0x01, 0xFE,0x01], av:new Traverser(null) },

    { v:new Traverser(-1, 0),                      b:[0x00,0x00,0x00,0x00, 0x01,0x00,0xFF,0xFF,0xFF,0xFF] },
    { v:new Traverser('abC', 2),                   b:[0x00,0x00,0x00,0x02, 0x03,0x00, 0x00,0x00,0x00,0x03, 0x61,0x62,0x43] },
    ...
    { des:1, err:/unexpected {bulk} length/, fq:1, b:[0x21,0x00] },
    { des:1, err:/unexpected {bulk} length/,       b:[0x11] },
    { des:1, err:/unexpected {bulk} length/,       b:[0x11,0x22,0x33] },
    { des:1, err:/{bulk} is less than zero/,       b:[0xFF,0xFF,0xFF,0xFF] }, // TODO: is it correct expectation that bulk must be >= 0?
    { des:1, err:/{bulk} is less than zero/,       b:[0x80,0x00,0x00,0x00] },
  ];
