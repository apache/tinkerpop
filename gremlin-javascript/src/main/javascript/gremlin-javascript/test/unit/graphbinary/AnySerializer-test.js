...
describe('GraphBinary.AnySerializer', () => {
  ...
  describe('#serialize', () => {
    [
      ...
      */
      ...
      // OffestDateTimeSerializer
      { v:new Date(1651436603000),
          b:[DataType.OFFSETDATETIME,0x00, 0x00,0x00,0x07,0xe6,0x05,0x01,0x00,0x00,0x42,0xc2,0x77,0xbd,0x8e,0x00,0x00,0x00,0x00,0x00] },
  ...
  describe('#deserialize', () =>
    [
      ...
      // GType
      { v:null,                                   b:[0x30,0x01] },
      { v:new t.EnumValue('GType','BYTE'),        b:[0x30,0x00, 0x03,0x00, 0x00,0x00,0x00,0x04, ...from('BYTE')] },
