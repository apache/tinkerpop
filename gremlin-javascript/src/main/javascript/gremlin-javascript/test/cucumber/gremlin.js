...
const gremlins = {
    ...
    g_V_unionXconstantX1X_constantX2X_constantX3XX: [function({g, xx1, xx3, xx2, vid2}) { return g.V(vid2).union(__.constant(xx1), __.constant(xx2), __.constant(xx3)) }], 
    ...
    g_withSideEffectXa_g_VX2XX_VX1X_out_whereXneqXaXX: [function({g, vid2, vid1}) { return g.withSideEffect("a", vid2).V(vid1).out().where(__.id().where(P.neq("a"))) }], 
    ...
    g_withSideEffectXb_bX_VXaX_addEXknowsX_toXbX_propertyXweight_0_5X: [function({g, vid6, vid1}) { return g.addV("person").property("name", "marko").property("age", 29).as("marko").addV("person").property("name", "vadas").property("age", 27).as("vadas").addV("software").property("name", "lop").property("lang", "java").as("lop").addV("person").property("name", "josh").property("age", 32).as("josh").addV("software").property("name", "ripple").property("lang", "java").as("ripple").addV("person").property("name", "peter").property("age", 35).as("peter").addE("knows").from_("marko").to("vadas").property("weight", 0.5).addE("knows").from_("marko").to("josh").property("weight", 1.0).addE("created").from_("marko").to("lop").property("weight", 0.4).addE("created").from_("josh").to("ripple").property("weight", 1.0).addE("created").from_("josh").to("lop").property("weight", 0.4).addE("created").from_("peter").to("lop").property("weight", 0.2) }, function({g, vid6, vid1}) { return g.withSideEffect("b", vid6).V(vid1).addE("knows").to("b").property("weight", 0.5) }, function({g, vid6, vid1}) { return g.E() }, function({g, vid6, vid1}) { return g.V(vid1).bothE() }, function({g, vid6, vid1}) { return g.V(vid1).inE("knows") }, function({g, vid6, vid1}) { return g.V(vid1).outE("knows") }, function({g, vid6, vid1}) { return g.V(vid1).bothE("knows").has("weight", 0.5) }, function({g, vid6, vid1}) { return g.V(vid6).bothE() }, function({g, vid6, vid1}) { return g.V(vid6).inE("knows") }, function({g, vid6, vid1}) { return g.V(vid6).outE("knows") }, function({g, vid6, vid1}) { return g.V(vid6).bothE("knows").has("weight", 0.5) }], 
    ...
    g_injectX1_2X_asBool: [function({g, xx1}) { return g.inject(xx1).asBool() }], 
    ...
    g_injectX1_2_3_4_0x5X_asNumber_sum_asNumberXbyteX: [function({g, xx1, xx3, xx2}) { return g.inject(xx1, xx2, xx3, "4", "0x5").asNumber().sum().asNumber(N.byte_) }], 
    ...
    g_withSideEffectXx_100X_V_age_mathX__plus_xX_asNumberXlongX: [function({g, xx1}) { return g.withSideEffect("x", xx1).V().values("age").math("_ + x").asNumber(N.long_) }], 
    ...
    g_withSideEffectXa_label_knows_out_marko_in_vadasX_mergeEXselectXaXX: [function({g, xx1}) { return g.addV("person").property("name", "marko").addV("person").property("name", "vadas") }, function({g, xx1}) { return g.withSideEffect("a", xx1).mergeE(__.select("a")) }, function({g, xx1}) { return g.V().has("person", "name", "marko").out("knows").has("person", "name", "vadas") }], 
    ...
    g_injectXlabel_knows_out_marko_in_vadasX_mergeE: [function({g, xx1}) { return g.addV("person").property("name", "marko").addV("person").property("name", "vadas") }, function({g, xx1}) { return g.inject(xx1).mergeE() }, function({g, xx1}) { return g.V().has("person", "name", "marko").out("knows").has("person", "name", "vadas") }], 
