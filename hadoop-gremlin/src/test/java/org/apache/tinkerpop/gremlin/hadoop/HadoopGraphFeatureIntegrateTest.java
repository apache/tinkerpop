...
@CucumberOptions(
        tags = "not @GraphComputerOnly and not @TinkerServiceRegistry and not @InsertionOrderingRequired and not @StepWrite and not @TinkerGQL and not @MultiLabelDefault",
