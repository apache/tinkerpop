...
public class HadoopRemoteAcceptor implements RemoteAcceptor {
    ...
    public Object submit(final List<String> args) throws RemoteException {
        try {
            ...
            final TraversalVertexProgram program = TraversalVertexProgram.build().traversal(this.hadoopGraph.getClass(), GraphTraversalSource.computer(), "gremlin-groovy", script).create(this.hadoopGraph);
