...
import com.apache.tinkerpop.gremlin.groovy.plugin.AbstractGremlinPlugin;
import com.apache.tinkerpop.gremlin.groovy.plugin.IllegalEnvironmentException;
import com.apache.tinkerpop.gremlin.groovy.plugin.PluginAcceptor;
import com.apache.tinkerpop.gremlin.groovy.plugin.PluginInitializationException;
...
import com.apache.tinkerpop.gremlin.hadoop.process.computer.mapreduce.MapReduceGraphComputer;
import com.apache.tinkerpop.gremlin.hadoop.structure.HadoopConfiguration;
import com.apache.tinkerpop.gremlin.hadoop.structure.HadoopGraph;
import com.apache.tinkerpop.gremlin.hadoop.structure.hdfs.HDFSTools;
import com.apache.tinkerpop.gremlin.hadoop.structure.io.VertexWritable;
import com.apache.tinkerpop.gremlin.hadoop.structure.io.graphson.GraphSONInputFormat;
import com.apache.tinkerpop.gremlin.hadoop.structure.io.kryo.KryoInputFormat;
import com.apache.tinkerpop.gremlin.hadoop.structure.io.script.ScriptInputFormat;
import com.apache.tinkerpop.gremlin.hadoop.structure.util.ConfUtil;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.sideEffect.mapreduce.GroupCountMapReduce;
