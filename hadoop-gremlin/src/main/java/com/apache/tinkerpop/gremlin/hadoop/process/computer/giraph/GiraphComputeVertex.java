...
import com.apache.tinkerpop.gremlin.structure.strategy.StrategyVertex;
...
public final class GiraphComputeVertex extends Vertex<LongWritable, Text, NullWritable, ObjectWritable> implements WrappedVertex<TinkerVertex> {
    ...
    public GiraphComputeVertex(final com.apache.tinkerpop.gremlin.structure.Vertex vertex) {
    ...
    private static final TinkerVertex generateTinkerVertexForm(final com.apache.tinkerpop.gremlin.structure.Vertex otherVertex) {
        if (otherVertex instanceof TinkerVertex)
            ...
            try {
                ...
                final Function<DetachedVertex, com.apache.tinkerpop.gremlin.structure.Vertex> vertexMaker = detachedVertex -> DetachedVertex.addTo(tinkerGraph, detachedVertex);
