...
public class UtilitiesGremlinPluginTest {
    ...
    public void shouldPluginUtilities() throws Exception {
        ...
        assertThat(groovysh.execute("describeGraph(com.apache.tinkerpop.gremlin.tinkergraph.structure.TinkerGraph)").toString(), containsString("IMPLEMENTATION - com.apache.tinkerpop.gremlin.tinkergraph.structure.TinkerGraph"));
    }
}
