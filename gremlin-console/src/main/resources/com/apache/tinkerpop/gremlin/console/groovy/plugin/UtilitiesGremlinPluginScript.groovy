...
describeGraph = { Class<? extends com.apache.tinkerpop.gremlin.structure.Graph> c ->
    def lf = System.getProperty("line.separator")
    def optIns = c.getAnnotationsByType(com.apache.tinkerpop.gremlin.structure.Graph.OptIn)
    def optOuts = c.getAnnotationsByType(com.apache.tinkerpop.gremlin.structure.Graph.OptOut)
