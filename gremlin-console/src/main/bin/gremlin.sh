...
# Process options
MAIN_CLASS=com.apache.tinkerpop.gremlin.console.Console
while getopts "elv" opt; do
    case "$opt" in
    e) MAIN_CLASS=com.apache.tinkerpop.gremlin.groovy.jsr223.ScriptExecutor
    ...
    l) eval GREMLIN_LOG_LEVEL=\$$OPTIND
       ...
       ;;
    v) MAIN_CLASS=com.apache.tinkerpop.gremlin.util.Gremlin
    esac
done
