...
class CurrDocsCommand extends CommandSupport {
    
    private final Mediator mediator
    
    public CurrDocsCommand(final Groovysh shell, final Mediator mediator) {
	super(shell, ":currdocs", ":crrdc")
        this.mediator = mediator
    }
    
    @Override
    def Object execute(final List<String> arguments) {
        io.out.println(Console.getCurrdocs().getClassName())
    }
}
