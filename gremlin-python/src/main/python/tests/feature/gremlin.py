...
world.gremlins = {
    ...
    'g_V_hasLabelXsoftwareX_hasXname_withoutXunionXVXvid1X_outXcreatedX_valuesXnameX_VXvid3X_outXcreatedX_valuesXnameXX_foldXX': [(lambda g, vid3=None,vid1=None:g.V().has_label('software').has('name', P.without(__.union(__.V(vid1).out('created').values('name'), __.V(vid3).out('created').values('name')).fold())))], 
