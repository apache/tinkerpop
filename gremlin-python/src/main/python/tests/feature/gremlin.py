...
world.gremlins = {
    ...
    'g_V_hasXname_VXvid1X_valuesXnameXX': [(lambda g, vid1=None:g.V().has('name', __.V(vid1).values('name')))], 
    'g_V_hasXname_VXvid1X_outXknowsX_valuesXnameXX': [(lambda g, vid1=None:g.V().has('name', __.V(vid1).out('knows').values('name')))], 
    'g_V_hasXage_VXvid1X_outXknowsX_valuesXageXX': [(lambda g, vid1=None:g.V().has('age', __.V(vid1).out('knows').values('age')))], 
    'g_V_hasXname_VXvid1X_valuesXnonexistentXX': [(lambda g, vid1=None:g.V().has('name', __.V(vid1).values('nonexistent')))], 
    'g_V_hasXname_notXidentityXX': [(lambda g:g.V().has('name', __.not_(__.identity())))], 
    'g_V_hasXage_gtXVXvid1X_valuesXageXXX': [(lambda g, vid1=None:g.V().has('age', P.gt(__.V(vid1).values('age'))))], 
    'g_V_hasXage_lteXVXvid2X_valuesXageXXX': [(lambda g, vid2=None:g.V().has('age', P.lte(__.V(vid2).values('age'))))], 
    'g_V_hasXage_neqXVXvid3X_valuesXageXXX': [(lambda g, vid3=None:g.V().has('age', P.neq(__.V(vid3).values('age'))))], 
    'g_V_hasXname_eqXVXvid1X_valuesXnameXXX': [(lambda g, vid1=None:g.V().has('name', P.eq(__.V(vid1).values('name'))))], 
    'g_V_hasXage_ltXVXvid1X_valuesXageXXX': [(lambda g, vid1=None:g.V().has('age', P.lt(__.V(vid1).values('age'))))], 
    'g_V_hasXage_gteXVXvid3X_valuesXageXXX': [(lambda g, vid3=None:g.V().has('age', P.gte(__.V(vid3).values('age'))))], 
    'g_V_hasXage_eqXVXvid1X_valuesXnonexistentXXX': [(lambda g, vid1=None:g.V().has('age', P.eq(__.V(vid1).values('nonexistent'))))], 
    'g_V_hasXlabel_VXvid1X_labelXX': [(lambda g, vid1=None:g.V().has(T.label, __.V(vid1).label()))], 
    'g_V_hasXperson_name_VXvid1X_valuesXnameXX_age': [(lambda g, vid1=None:g.V().has('person', 'name', __.V(vid1).values('name')).values('age'))], 
    ...
    'g_V_hasXname_withinXVXvid1X_valuesXnonexistentX_constantXmarkoXXX': [(lambda g, vid1=None:g.V().has('name', P.within(__.V(vid1).values('nonexistent'), __.constant('marko'))))], 
    'g_V_hasXname_withinXVXvid1X_valuesXnonexistentX_VXvid1X_valuesXnonexistentXXX': [(lambda g, vid1=None:g.V().has('name', P.within(__.V(vid1).values('nonexistent'), __.V(vid1).values('nonexistent'))))], 
    'g_V_hasXname_withoutXVXvid1X_valuesXnameX_VXvid2X_valuesXnameX_VXvid3X_valuesXnameXXX': [(lambda g, vid3=None,vid2=None,vid1=None:g.V().has('name', P.without(__.V(vid1).values('name'), __.V(vid2).values('name'), __.V(vid3).values('name'))))], 
    ...
    'g_V_hasLabelXVXvid1X_labelXX': [(lambda g, vid1=None:g.V().has_label(__.V(vid1).label()))], 
    ...
    'g_V_propertiesXageX_hasKeyXVXvid1X_propertiesXageX_keyXX': [(lambda g, vid1=None:g.V().properties('age').has_key(__.V(vid1).properties('age').key()))], 
    'g_V_propertiesXageX_hasKeyXeqXVXvid1X_propertiesXageX_keyXX': [(lambda g, vid1=None:g.V().properties('age').has_key(P.eq(__.V(vid1).properties('age').key())))], 
    'g_V_propertiesXageX_hasValueXVXvid1X_valuesXageXX': [(lambda g, vid1=None:g.V().properties('age').has_value(__.V(vid1).values('age')))], 
    'g_V_propertiesXageX_hasValueXeqXVXvid1X_valuesXageXXX': [(lambda g, vid1=None:g.V().properties('age').has_value(P.eq(__.V(vid1).values('age'))))], 
    ...
    'g_V_valuesXageX_isXVXvid1X_valuesXageXX': [(lambda g, vid1=None:g.V().values('age').is_(__.V(vid1).values('age')))], 
    'g_V_valuesXnameX_isXVXvid1X_valuesXnameXX': [(lambda g, vid1=None:g.V().values('name').is_(__.V(vid1).values('name')))], 
    'g_V_valuesXageX_isXgtXVXvid1X_valuesXageXXX': [(lambda g, vid1=None:g.V().values('age').is_(P.gt(__.V(vid1).values('age'))))], 
    'g_V_valuesXageX_isXltXVXvid3X_valuesXageXXX': [(lambda g, vid3=None:g.V().values('age').is_(P.lt(__.V(vid3).values('age'))))], 
    'g_V_valuesXageX_isXneqXVXvid4X_valuesXageXXX': [(lambda g, vid4=None:g.V().values('age').is_(P.neq(__.V(vid4).values('age'))))], 
    ...
    'g_V_valuesXageX_isXVXvid1X_valuesXnonexistentXX': [(lambda g, vid1=None:g.V().values('age').is_(__.V(vid1).values('nonexistent')))], 
    'g_V_hasLabelXpersonX_valuesXageX_chooseXgtXVXvid1X_valuesXageXX_olderX': [(lambda g, vid1=None:g.V().has_label('person').values('age').choose(__.is_(P.gt(__.V(vid1).values('age'))), __.constant('older than marko'), __.constant('not older')))], 
    ...
    'g_VXvid1X_outXknowsX_valuesXageX_fold_allXgteXVXvid2X_valuesXageXXX': [(lambda g, vid2=None,vid1=None:g.V(vid1).out('knows').values('age').fold().all_(P.gte(__.V(vid2).values('age'))))], 
    'g_VXvid1X_outXknowsX_valuesXageX_fold_allXgtXVXvid2X_valuesXageXXX': [(lambda g, vid2=None,vid1=None:g.V(vid1).out('knows').values('age').fold().all_(P.gt(__.V(vid2).values('age'))))], 
    'g_VXvid1X_outXknowsX_valuesXageX_fold_anyXeqXVXvid3X_valuesXageXXX': [(lambda g, vid3=None,vid1=None:g.V(vid1).out('knows').values('age').fold().any_(P.eq(__.V(vid3).values('age'))))], 
    'g_VXvid1X_outXknowsX_valuesXageX_fold_noneXeqXVXvid4X_valuesXageXXX': [(lambda g, vid4=None,vid1=None:g.V(vid1).out('knows').values('age').fold().none(P.eq(__.V(vid4).values('age'))))], 
    'g_VXvid1X_outXknowsX_valuesXageX_fold_noneXeqXVXvid3X_valuesXageXXX': [(lambda g, vid3=None,vid1=None:g.V(vid1).out('knows').values('age').fold().none(P.eq(__.V(vid3).values('age'))))], 
    ...
    'g_V_valuesXageX_isXwithoutXVXvid1X_valuesXageX_VXvid2X_valuesXageXXX': [(lambda g, vid2=None,vid1=None:g.V().values('age').is_(P.without(__.V(vid1).values('age'), __.V(vid2).values('age'))))], 
    ...
    'g_V_valuesXageX_whereXgtXVXvid1X_valuesXageXXX': [(lambda g, vid1=None:g.V().values('age').where(P.gt(__.V(vid1).values('age'))))], 
    'g_V_valuesXageX_whereXltXVXvid3X_valuesXageXXX': [(lambda g, vid3=None:g.V().values('age').where(P.lt(__.V(vid3).values('age'))))], 
    'g_V_valuesXageX_whereXeqXVXvid1X_valuesXageXXX': [(lambda g, vid1=None:g.V().values('age').where(P.eq(__.V(vid1).values('age'))))], 
    ...
    'g_V_valuesXnameX_whereXneqXVXvid1X_valuesXnameXXX': [(lambda g, vid1=None:g.V().values('name').where(P.neq(__.V(vid1).values('name'))))], 
    'g_V_valuesXageX_whereXeqXV9999_valuesXageXXX': [(lambda g:g.V().values('age').where(P.eq(__.V(9999).values('age'))))], 
    ...
    'g_withStrategiesXReadOnlyChildVerificationStrategyX_V': [(lambda g:g.with_strategies(ReadOnlyChildVerificationStrategy()).V())], 
    'g_withStrategiesXReadOnlyChildVerificationStrategyX_V_hasXage_gtXVXvid1X_valuesXageXXX': [(lambda g, vid1=None:g.with_strategies(ReadOnlyChildVerificationStrategy()).V().has('age', P.gt(__.V(vid1).values('age'))).values('name'))], 
    'g_withStrategiesXReadOnlyChildVerificationStrategyX_V_hasXname_addVXxX_valuesXnameXX': [(lambda g:g.with_strategies(ReadOnlyChildVerificationStrategy()).V().has('name', __.add_v('x').values('name')))], 
