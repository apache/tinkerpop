...
world.gremlins = {
    ...
    'g_mergeVXlabel_person_name_markoX_optionXonMatch_label_managerX_single_label_graph': [(lambda g:g.merge_v({ T.label: 'person', 'name': 'marko' }).option(Merge.on_match, { T.label: 'manager' }))], 
    ...
    'g_V_addLabelXemployeeX_single_label_graph': [(lambda g:g.V().has_label('person').add_label('employee'))],
    'g_V_addLabelXa_bX_single_label_graph': [(lambda g:g.V().has_label('person').add_label('a', 'b'))], 
    ...
    'g_V_dropLabelXpersonX_single_label_graph': [(lambda g:g.V().has_label('person').drop_label('person'))], 
    'g_V_dropLabels_single_label_graph': [(lambda g:g.V().has_label('person').drop_labels())], 
