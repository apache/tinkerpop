...
world.gremlins = {
    ...
    'g_withXmultilabelX_V_elementMap_multilabel': [(lambda g:g.add_v('person').add_label('employee').property('name', 'marko')), (lambda g:g.with_('multilabel').V().element_map())], 
    ...
    'g_withXsinglelabelX_V_elementMap_multi_label_default': [(lambda g:g.add_v('person').add_label('employee').property('name', 'marko')), (lambda g:g.with_('singlelabel').V().element_map())], 
    ...
    'g_withXmultilabelX_E_elementMap': [(lambda g:g.add_v('person').property('name', 'marko').as_('a').add_v('person').property('name', 'josh').as_('b').add_e('knows').from_('a').to('b').property('weight', 0.5)), (lambda g:g.with_('multilabel').E().element_map())], 
    ...
    'g_V_label_deprecated_multilabel': [(lambda g:g.add_v('a', 'b').property('name', 'test')), (lambda g:g.V().label().count())], 
    'g_V_label_deprecated_multilabel_value_is_one_of_labels': [(lambda g:g.add_v('a', 'b').property('name', 'test')), (lambda g:g.V().filter_(__.label().is_(P.within('a', 'b'))))], 
    ...
    'g_V_labels_multilabel': [(lambda g:g.add_v('a', 'b')), (lambda g:g.V().labels())], 
    ...
    'g_withXmultilabelX_V_valueMap_withXtokensX_multilabel': [(lambda g:g.add_v('person').add_label('employee').property('name', 'marko')), (lambda g:g.with_('multilabel').V().value_map().with_(WithOptions.tokens))], 
    ...
    'g_withXsinglelabelX_V_valueMap_withXtokensX_multi_label_default': [(lambda g:g.add_v('person').add_label('employee').property('name', 'marko')), (lambda g:g.with_('singlelabel').V().value_map().with_(WithOptions.tokens))], 
