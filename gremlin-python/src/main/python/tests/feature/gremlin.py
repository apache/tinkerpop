...
world.gremlins = {
    ...
    'g_V_elementMap_single_label_default': [(lambda g:g.add_v('person').property('name', 'marko')), (lambda g:g.V().element_map())], 
    ...
    'g_V_valueMap_withXtokensX_single_label_default': [(lambda g:g.add_v('person').property('name', 'marko')), (lambda g:g.V().value_map().with_(WithOptions.tokens))], 
