...
world.gremlins = {
    ...
    'g_V_hasNotXlangX_name': [(lambda g:g.V().has_not('lang').values('name'))], 
    ...
    'g_V_hasXperson_name_aliceX_propertyXage_51X': [(lambda g:g.add_v('person').property('name', 'alice').property('age', 50)), (lambda g:g.V().has('person', 'name', 'alice').property('age', 51)), (lambda g:g.V().has('person', 'age', 50)), (lambda g:g.V().has('person', 'age', 51))], 
    'g_addVXpersonX_propertyXname_aliceX_propertyXage_30X_query': [(lambda g:g.add_v('person').property('name', 'alice').property('age', 30)), (lambda g:g.V().has('person', 'name', 'alice')), (lambda g:g.V().has('person', 'age', 30))], 
    ...
    'g_V_order_byXTidX_name': [(lambda g:g.V().order().by(T.id_).values('name'))], 
    'g_V_order_byXTid_descX_name': [(lambda g:g.V().order().by(T.id_, Order.desc).values('name'))], 
    'g_V_order_byXTlabelX_label': [(lambda g:g.V().order().by(T.label).label())], 
    ...
    'g_VX1X_out_path_byXlabelX': [(lambda g, vid1=None:g.V(vid1).out().path().by(T.label))], 
    'g_VX1X_out_path_byXvaluesXnameXX': [(lambda g, vid1=None:g.V(vid1).out().path().by(__.values('name')))], 
    ...
    'g_VX1X_out_out_path': [(lambda g, vid1=None:g.V(vid1).out().out().path())], 
