...
world.gremlins = {
    ...
    'g_V_hasLabelXhabitat_reptileX_branchXidentityX_optionXhasLabelXaquaticXX_optionXhasLabelXreptileXX_optionXhasLabelXhabitatXX_multilabel': [(lambda g:g.V().has_label('habitat', 'reptile').branch(__.identity()).option(__.has_label('aquatic'), __.constant('wet')).option(__.has_label('reptile'), __.constant('scaly')).option(__.has_label('habitat'), __.constant('place')))], 
    ...
    'g_V_hasLabelXhabitat_reptileX_chooseXhasLabelXaquaticX_constantXwetX_constantXdryXX_multilabel': [(lambda g:g.V().has_label('habitat', 'reptile').choose(__.has_label('aquatic'), __.constant('wet'), __.constant('dry')))], 
    'g_V_hasXname_tuxX_chooseXlabelX_optionXanimal_bird_aquatic_endangeredX_multilabel': [(lambda g:g.V().has('name', 'tux').choose(T.label).option('animal', __.constant('is-animal')).option('bird', __.constant('is-bird')).option('aquatic', __.constant('is-aquatic')).option('endangered', __.constant('is-endangered')))], 
    ...
    'g_V_valuesXintX_asNumberXGType_BIGDECIMALX_negative_isXtypeOfXGType_BIGDECIMALXX': [(lambda g:g.add_v('data').property('int', -456)), (lambda g:g.V().values('int').as_number(GType.BIGDECIMAL).is_(P.type_of(GType.BIGDECIMAL)))], 
    ...
    'g_V_valuesXintX_asNumberXGType_BIGINTX_negative_isXtypeOfXGType_BIGINTXX': [(lambda g:g.add_v('data').property('int', -456)), (lambda g:g.V().values('int').as_number(GType.BIGINT).is_(P.type_of(GType.BIGINT)))], 
    ...
    'g_V_andXhasLabelXmammalX_hasLabelXendangeredXX_name_multilabel': [(lambda g:g.V().and_(__.has_label('mammal'), __.has_label('endangered')).values('name'))], 
    ...
    'g_V_hasLabelXhabitatX_dedup_byXlabels_order_foldX_localXlabels_order_foldX_multilabel': [(lambda g:g.V().has_label('habitat').dedup().by(__.labels().order().fold()).local(__.labels().order().fold()))], 
    ...
    'g_V_hasXname_constantXmarkoXX': [(lambda g:g.V().has('name', __.constant('marko')))], 
    'g_V_hasXname_VXvid1X_outXknowsX_valuesXnameXX': [(lambda g, vid1=None:g.V().has('name', __.V(vid1).out('knows').values('name').order()))], 
    'g_V_hasXname_valuesXnonexistentXX': [(lambda g:g.V().has('name', __.values('nonexistent')))], 
    'g_V_hasXname_notXidentityXX': [(lambda g:g.V().has('name', __.not_(__.identity())))], 
    'g_V_hasXage_gtXconstantX29XXX': [(lambda g:g.V().has('age', P.gt(__.constant(29))))], 
    'g_V_hasXage_lteXconstantX27XXX': [(lambda g:g.V().has('age', P.lte(__.constant(27))))], 
    'g_V_hasXage_neqXconstantX32XXX': [(lambda g:g.V().has('age', P.neq(__.constant(32))))], 
    'g_V_hasXname_eqXconstantXmarkoXXX': [(lambda g:g.V().has('name', P.eq(__.constant('marko'))))], 
    'g_V_hasXage_ltXconstantX29XXX': [(lambda g:g.V().has('age', P.lt(__.constant(29))))], 
    'g_V_hasXage_gteXconstantX32XXX': [(lambda g:g.V().has('age', P.gte(__.constant(32))))], 
    'g_V_hasXage_eqXvaluesXnonexistentXXX': [(lambda g:g.V().has('age', P.eq(__.values('nonexistent'))))], 
    'g_V_hasXlabel_constantXpersonXX': [(lambda g:g.V().has(T.label, __.constant('person')))], 
    'g_V_hasXperson_name_constantXmarkoXX_age': [(lambda g:g.V().has('person', 'name', __.constant('marko')).values('age'))], 
    'g_V_hasXname_withinXunionXVXvid1X_outXknowsX_valuesXnameX_constantXpeterXX_foldXX': [(lambda g, vid1=None:g.V().has('name', P.within(__.union(__.V(vid1).out('knows').values('name'), __.constant('peter')).fold())))], 
    'g_V_hasXname_withinXvaluesXnonexistentX_constantXmarkoXXX': [(lambda g:g.V().has('name', P.within(__.values('nonexistent'), __.constant('marko'))))], 
    'g_V_hasXname_withinXvaluesXnonexistentX_valuesXnonexistent2XXX': [(lambda g:g.V().has('name', P.within(__.values('nonexistent'), __.values('nonexistent2'))))], 
    'g_V_hasXname_withoutXconstantXmarkoX_constantXvadasX_constantXpeterXXX': [(lambda g:g.V().has('name', P.without(__.constant('marko'), __.constant('vadas'), __.constant('peter'))))], 
    'g_V_hasXname_withinXunionXVXvid1X_outXknowsX_valuesXnameX_VXvid3X_outXcreatedX_valuesXnameXX_foldXX': [(lambda g, vid3=None,vid1=None:g.V().has('name', P.within(__.union(__.V(vid1).out('knows').values('name'), __.V(vid3).out('created').values('name')).fold())))], 
    'g_V_hasLabelXsoftwareX_hasXname_withoutXunionXVXvid1X_outXcreatedX_valuesXnameX_VXvid4X_outXcreatedX_valuesXnameXX_foldXX': [(lambda g, vid4=None,vid1=None:g.V().has_label('software').has('name', P.without(__.union(__.V(vid1).out('created').values('name'), __.V(vid4).out('created').values('name')).fold())))], 
    'g_V_hasLabelXpersonX_valuesXageX_isXwithinXunionXVXvid1X_valuesXageX_V_hasXname_lopX_inXcreatedX_valuesXageXX_foldXX': [(lambda g, vid1=None:g.V().has_label('person').values('age').is_(P.within(__.union(__.V(vid1).values('age'), __.V().has('name', 'lop').in_('created').values('age')).fold())))], 
    'g_VXvid1X_outEXknowsX_filterXinV_hasXname_withinXunionXV_hasXname_lopX_inXcreatedX_valuesXnameX_V_hasXname_rippleX_inXcreatedX_valuesXnameXX_foldXXXX': [(lambda g, vid1=None:g.V(vid1).out_e('knows').filter_(__.in_v().has('name', P.within(__.union(__.V().has('name', 'lop').in_('created').values('name'), __.V().has('name', 'ripple').in_('created').values('name')).fold()))))], 
    'g_V_hasLabelXconstantXpersonXX': [(lambda g:g.V().has_label(__.constant('person')))], 
    'g_V_hasIdXeqXVXvid1X_idXX': [(lambda g, vid1=None:g.V().has_id(P.eq(__.V(vid1).id_())))], 
    'g_V_hasIdXVXvid1X_idXX': [(lambda g, vid1=None:g.V().has_id(__.V(vid1).id_()))], 
    'g_V_propertiesXageX_hasKeyXconstantXageXX': [(lambda g:g.V().properties('age').has_key(__.constant('age')))], 
    'g_V_propertiesXageX_hasKeyXeqXconstantXageXXX': [(lambda g:g.V().properties('age').has_key(P.eq(__.constant('age'))))], 
    'g_V_propertiesXageX_hasValueXconstantX29XX': [(lambda g:g.V().properties('age').has_value(__.constant(29)))], 
    'g_V_propertiesXageX_hasValueXeqXconstantX29XXX': [(lambda g:g.V().properties('age').has_value(P.eq(__.constant(29))))], 
    'g_VXvid1X_asXaX_V_hasXage_gtXselectXaX_valuesXageXXX_valuesXnameX': [(lambda g, vid1=None:g.V(vid1).as_('a').V().has('age', P.gt(__.select('a').values('age'))).values('name'))], 
    'g_withSackX29X_V_hasXage_gtXsackXX_valuesXnameX': [(lambda g:g.with_sack(29).V().has('age', P.gt(__.sack())).values('name'))], 
    'g_V_hasXname_markoX_outEXknowsX_hasXweight_gteXconstantX05XXX': [(lambda g:g.V().has('name', 'marko').out_e('knows').has('weight', P.gte(__.constant(0.5))))], 
    'g_V_hasXlabel_aquaticX_name_multilabel': [(lambda g:g.V().has(T.label, 'aquatic').values('name'))], 
    'g_V_hasXlabel_withinXreptile_birdXX_name_multilabel': [(lambda g:g.V().has(T.label, P.within('reptile', 'bird')).values('name'))], 
    'g_V_hasXlabel_withoutXanimalXX_name_multilabel': [(lambda g:g.V().has(T.label, P.without('animal')).values('name'))], 
    ...
    'g_V_hasLabelXbirdX_name_multilabel': [(lambda g:g.V().has_label('bird').values('name'))], 
    'g_V_hasLabelXaquaticX_name_multilabel': [(lambda g:g.V().has_label('aquatic').values('name'))], 
    'g_V_hasLabelXreptile_birdX_name_multilabel': [(lambda g:g.V().has_label('reptile', 'bird').values('name'))], 
    ...
    'g_V_valuesXageX_isXoutsideX28_33XX': [(lambda g:g.V().values('age').is_(P.outside(28, 33)))], 
    ...
    'g_V_valuesXageX_isXconstantX29XX': [(lambda g:g.V().values('age').is_(__.constant(29)))], 
    'g_V_valuesXnameX_isXconstantXmarkoXX': [(lambda g:g.V().values('name').is_(__.constant('marko')))], 
    'g_V_valuesXageX_isXgtXconstantX29XXX': [(lambda g:g.V().values('age').is_(P.gt(__.constant(29))))], 
    'g_V_valuesXageX_isXltXconstantX32XXX': [(lambda g:g.V().values('age').is_(P.lt(__.constant(32))))], 
    'g_V_valuesXageX_isXneqXconstantX35XXX': [(lambda g:g.V().values('age').is_(P.neq(__.constant(35))))], 
    'g_V_valuesXageX_isXwithinXVXvid1X_outXknowsX_valuesXageXXX': [(lambda g, vid1=None:g.V().values('age').is_(P.within(__.V(vid1).out('knows').values('age').fold())))], 
    'g_V_valuesXageX_isXconstantX99999XX': [(lambda g:g.V().values('age').is_(__.constant(99999)))], 
    'g_V_hasLabelXpersonX_valuesXageX_chooseXgtXconstantX29XX_olderX': [(lambda g:g.V().has_label('person').values('age').choose(__.is_(P.gt(__.constant(29))), __.constant('older than marko'), __.constant('not older')))], 
    'g_V_hasLabelXpersonX_valuesXageX_chooseXgteXmeanAgeX_aboveX': [(lambda g:g.V().has_label('person').values('age').choose(__.is_(P.gte(__.V().has_label('person').values('age').mean())), __.constant('above average'), __.constant('below average')))], 
    'g_VXvid1X_outXknowsX_valuesXageX_fold_allXgteXconstantX27XXX': [(lambda g, vid1=None:g.V(vid1).out('knows').values('age').fold().all_(P.gte(__.constant(27))))], 
    'g_VXvid1X_outXknowsX_valuesXageX_fold_allXgtXconstantX27XXX': [(lambda g, vid1=None:g.V(vid1).out('knows').values('age').fold().all_(P.gt(__.constant(27))))], 
    'g_VXvid1X_outXknowsX_valuesXageX_fold_anyXeqXconstantX32XXX': [(lambda g, vid1=None:g.V(vid1).out('knows').values('age').fold().any_(P.eq(__.constant(32))))], 
    'g_VXvid1X_outXknowsX_valuesXageX_fold_noneXeqXconstantX35XXX': [(lambda g, vid1=None:g.V(vid1).out('knows').values('age').fold().none(P.eq(__.constant(35))))], 
    'g_VXvid1X_outXknowsX_valuesXageX_fold_noneXeqXconstantX32XXX': [(lambda g, vid1=None:g.V(vid1).out('knows').values('age').fold().none(P.eq(__.constant(32))))], 
    'g_injectXnullX_isXeqXV9999_valuesXnameXXX': [(lambda g:g.inject(None).is_(P.eq(__.V(9999).values('name'))))], 
    'g_injectXmarkoX_isXV9999_valuesXnameXX': [(lambda g:g.inject('marko').is_(__.V(9999).values('name')))], 
    'g_injectXmarkoX_chooseXeqXV9999_valuesXnameXX_matched_unmatchedX': [(lambda g:g.inject('marko').choose(__.is_(P.eq(__.V(9999).values('name'))), __.constant('matched'), __.constant('unmatched')))], 
    'g_injectXlistX_noneXeqXV9999_valuesXnameXXX': [(lambda g:g.inject(['marko', 'josh']).none(P.eq(__.V(9999).values('name'))))], 
    'g_V_hasXname_eqXV9999_valuesXnameXXX': [(lambda g:g.V().has('name', P.eq(__.V(9999).values('name'))))], 
    'g_V_valuesXageX_isXwithoutXconstantX29X_constantX32XXX': [(lambda g:g.V().values('age').is_(P.without(__.constant(29), __.constant(32))))], 
    'g_VXvid1X_asXaX_V_valuesXageX_isXgtXselectXaX_valuesXageXXX': [(lambda g, vid1=None:g.V(vid1).as_('a').V().values('age').is_(P.gt(__.select('a').values('age'))))], 
    'g_withSackX30X_V_valuesXageX_isXgtXsackXX': [(lambda g:g.with_sack(30).V().values('age').is_(P.gt(__.sack())))], 
    ...
    'g_V_notXhasLabelXanimalXX_name_multilabel': [(lambda g:g.V().not_(__.has_label('animal')).values('name'))], 
    ...
    'g_V_orXhasLabelXbirdX_hasLabelXreptileXX_name_multilabel': [(lambda g:g.V().or_(__.has_label('bird'), __.has_label('reptile')).values('name'))], 
    ...
    'g_V_valuesXageX_whereXgtXconstantX29XXX': [(lambda g:g.V().values('age').where(P.gt(__.constant(29))))], 
    'g_V_valuesXageX_whereXltXconstantX32XXX': [(lambda g:g.V().values('age').where(P.lt(__.constant(32))))], 
    'g_V_valuesXageX_whereXeqXconstantX29XXX': [(lambda g:g.V().values('age').where(P.eq(__.constant(29))))], 
    'g_V_valuesXageX_whereXwithinXVXvid1X_outXknowsX_valuesXageXXX': [(lambda g, vid1=None:g.V().values('age').where(P.within(__.V(vid1).out('knows').values('age').fold())))], 
    'g_V_valuesXnameX_whereXneqXconstantXmarkoXXX': [(lambda g:g.V().values('name').where(P.neq(__.constant('marko'))))], 
    'g_V_valuesXageX_whereXeqXconstantX99999XXX': [(lambda g:g.V().values('age').where(P.eq(__.constant(99999))))], 
    'g_V_whereXgtXVXvid1X_valuesXageXXX_byXageX_valuesXnameX': [(lambda g, vid1=None:g.V().where(P.gt(__.V(vid1).values('age'))).by('age').values('name'))], 
    'g_VX1X_asXaX_V_valuesXageX_whereXgteXconstantX0XX_andXneqXaXXX_byX_byXageX': [(lambda g, vid1=None:g.V(vid1).as_('a').V().has_label('person').values('age').where(P.gte(__.constant(0)).and_(P.neq('a'))).by().by('age'))], 
    'g_VX1X_asXaX_V_valuesXageX_whereXneqXaX_andXgtXVXvid1X_valuesXageXXXX_byX_byXageX': [(lambda g, vid1=None:g.V(vid1).as_('a').V().has_label('person').values('age').where(P.neq('a').and_(P.gt(__.V(vid1).values('age')))).by().by('age'))], 
    'g_VX1X_asXaX_V_valuesXageX_whereXeqXVXvid1X_valuesXageXX_orXeqXaXXX_byX_byXageX': [(lambda g, vid1=None:g.V(vid1).as_('a').V().has_label('person').values('age').where(P.eq(__.V(vid1).values('age')).or_(P.eq('a'))).by().by('age'))], 
    ...
    'g_V_hasXname_addVXxX_valuesXnameXX_rejected': [(lambda g:g.V().has('name', __.add_v('x').values('name')))], 
    'g_V_hasXname_V_drop_constantXxXX_rejected': [(lambda g:g.V().has('name', __.V().drop().constant('x')))], 
    'g_V_hasXname_V_mapXaddVXxXX_valuesXnameXX_rejected': [(lambda g:g.V().has('name', __.V().map(__.add_v('x')).values('name')))], 
    'g_V_hasXname_eqXaddVXxX_valuesXnameXXX_rejected': [(lambda g:g.V().has('name', P.eq(__.add_v('x').values('name'))))], 
    'g_V_hasXname_withinXaddVXxX_valuesXnameXXX_rejected': [(lambda g:g.V().has('name', P.within(__.add_v('x').values('name'))))], 
    'g_V_hasXage_gtXaddVXxX_valuesXageXXX_rejected': [(lambda g:g.V().has('age', P.gt(__.add_v('x').values('age'))))], 
    'g_V_valuesXageX_isXaddVXxX_valuesXageXX_rejected': [(lambda g:g.V().values('age').is_(__.add_v('x').values('age')))], 
    'g_V_valuesXageX_isXgtXaddVXxX_valuesXageXXX_rejected': [(lambda g:g.V().values('age').is_(P.gt(__.add_v('x').values('age'))))], 
    ...
    'g_addVXa_bX_labels': [(lambda g:g.add_v('a', 'b').labels().fold()), (lambda g:g.V().has_label('a').has_label('b'))], 
    'g_addVXa_b_cX_labels_count': [(lambda g:g.add_v('a', 'b', 'c').labels().count())], 
    ...
    'g_VXvid1X_EXoutE_idX': [(lambda g, vid1=None:g.V(vid1).E(__.out_e().id_()))], 
    'g_VXvid1X_outEXknowsX_hasXinV_name_vadasX_id_EXidentityX': [(lambda g, vid1=None:g.V(vid1).out_e('knows').filter_(__.in_v().has('name', 'vadas')).id_().E(__.identity()))], 
    'g_injectX9999X_EXidentityX': [(lambda g:g.inject(9999).E(__.identity()))], 
    'g_EXVXvid1X_outE_idX': [(lambda g, vid1=None:g.E(__.V(vid1).out_e().id_()))], 
    ...
    'g_V_elementMap': [(lambda g:g.with_('singlelabel').V().element_map())], 
    'g_V_elementMap_single_label_only_graph_default': [(lambda g:g.V().element_map())], 
    'g_V_elementMap_single_label_only_graph_multi_label_default': [(lambda g:g.V().element_map())], 
    'g_V_elementMapXname_ageX': [(lambda g:g.with_('singlelabel').V().element_map('name', 'age'))], 
    'g_EX11X_elementMap': [(lambda g, eid11=None:g.with_('singlelabel').E(eid11).element_map())], 
    'g_V_elementMapXname_age_nullX': [(lambda g:g.with_('singlelabel').V().element_map('name', 'age', None))], 
    'g_withXmultilabelX_VXmarkoX_elementMap': [(lambda g:g.with_('multilabel').V().has('name', 'marko').element_map())], 
    'g_V_elementMap_single_label_default': [(lambda g:g.add_v('person').add_label('employee').property('name', 'marko')), (lambda g:g.V().element_map())], 
    'g_withXmultilabelX_V_elementMap_multilabel': [(lambda g:g.with_('multilabel').V().has('name', 'tux').element_map('name', 'species'))], 
    'g_V_elementMap_multi_label_default': [(lambda g:g.add_v('person').add_label('employee').property('name', 'marko')), (lambda g:g.V().element_map())], 
    'g_withXsinglelabelX_V_elementMap_multi_label_default': [(lambda g:g.with_('singlelabel').V().has('name', 'lagoon').element_map('name', 'biome'))], 
    'g_V_elementMap_single_label_vertex_multi_label_default': [(lambda g:g.add_v('person').property('name', 'marko')), (lambda g:g.V().element_map())], 
    'g_withXsinglelabelX_V_elementMap_zero_label_vertex': [(lambda g:g.add_v().property('name', 'nobody')), (lambda g:g.with_('singlelabel').V().element_map())], 
    'g_withXmultilabelX_V_elementMap_zero_label_vertex': [(lambda g:g.add_v().property('name', 'nobody')), (lambda g:g.with_('multilabel').V().element_map())], 
    'g_V_elementMap_zero_label_vertex_multi_label_default': [(lambda g:g.add_v().property('name', 'nobody')), (lambda g:g.V().element_map())], 
    'g_V_elementMap_zero_label_vertex_single_label_default': [(lambda g:g.add_v().property('name', 'nobody')), (lambda g:g.V().element_map())], 
    'g_withXmultilabelX_E_elementMap': [(lambda g:g.with_('multilabel').E().has('since', 2018).has_label('livesIn').element_map())], 
    'g_E_elementMap_multi_label_default': [(lambda g:g.add_v('person').property('name', 'marko').as_('a').add_v('person').property('name', 'josh').as_('b').add_e('knows').from_('a').to('b').property('weight', 0.5)), (lambda g:g.E().element_map())], 
    'g_E_elementMap_single_label_default': [(lambda g:g.add_v('person').property('name', 'marko').as_('a').add_v('person').property('name', 'josh').as_('b').add_e('knows').from_('a').to('b').property('weight', 0.5)), (lambda g:g.E().element_map())], 
    'g_withXsinglelabelX_E_elementMap': [(lambda g:g.add_v('person').property('name', 'marko').as_('a').add_v('person').property('name', 'josh').as_('b').add_e('knows').from_('a').to('b').property('weight', 0.5)), (lambda g:g.with_('singlelabel').E().element_map())], 
    ...
    'g_V_label_single_label_graph': [(lambda g:g.V().has_label('person').label())], 
    'g_V_label_deprecated_multilabel': [(lambda g:g.V().has('name', 'tux').label().count())], 
    'g_V_label_deprecated_multilabel_value_is_one_of_labels': [(lambda g:g.V().has('name', 'tux').filter_(__.label().is_(P.within('animal', 'bird', 'aquatic', 'endangered'))))], 
    'g_E_label_deprecated_multilabel_graph': [(lambda g:g.add_v('person').as_('a').add_v('person').as_('b').add_e('knows').from_('a').to('b')), (lambda g:g.E().label())], 
    'g_V_hasLabelXpersonX_labels': [(lambda g:g.V().has_label('person').labels())], 
    'g_V_labels_multilabel': [(lambda g:g.V().has('name', 'tux').labels())], 
    'g_addVXa_bX_labels_count': [(lambda g:g.add_v('a', 'b')), (lambda g:g.V().labels().count())], 
    'g_addV_labels': [(lambda g:g.add_v()), (lambda g:g.V().labels())], 
    'g_E_labels': [(lambda g:g.E().has_label('knows').labels())], 
    'g_V_hasLabelXpersonX_labels_single_label_graph': [(lambda g:g.V().has_label('person').labels())], 
    'g_V_labels_single_label_graph': [(lambda g:g.V().labels())], 
    'g_E_labels_single_label_graph': [(lambda g:g.E().has_label('knows').labels())], 
    'g_V_hasXname_markoX_projectXlabelsX_byXT_labelsX': [(lambda g:g.V().has('name', 'marko').project('labels').by(T.labels))], 
    'g_V_hasXname_tuxX_projectXlabelsX_byXT_labelsX': [(lambda g:g.V().has('name', 'tux').project('labels').by(T.labels))], 
    'g_V_hasXT_labels_personX_valuesXnameX': [(lambda g:g.V().has(T.labels, 'person').values('name'))], 
    'g_withXmultilabelX_V_hasXT_labels_withinXbird_reptileXX_valuesXnameX': [(lambda g:g.with_('multilabel').V().has(T.labels, P.within('bird', 'reptile')).values('name'))], 
    ...
    'g_match_person_selectXpX_byXnameX': [(lambda g:g.match('MATCH (p:person)').select('p').by('name'))], 
    'g_match_personXknowsX_person_selectXa_bX_byXnameX': [(lambda g:g.match('MATCH (a:person)-[:knows]->(b:person)').select('a', 'b').by('name'))], 
    'g_match_personXknowsX_personXcreatedX_software_selectXa_b_sX_byXnameX': [(lambda g:g.match('MATCH (a:person)-[:knows]->(b:person)-[:created]->(s:software)').select('a', 'b', 's').by('name'))], 
    'g_match_softwareXreversedCreatedX_person_selectXp_sX_byXnameX': [(lambda g:g.match('MATCH (s:software)<-[:created]-(p:person)').select('p', 's').by('name'))], 
    'g_match_personXundirectedKnowsX_person_selectXa_bX_byXnameX': [(lambda g:g.match('MATCH (a:person)-[:knows]-(b:person)').select('a', 'b').by('name'))], 
    'g_match_personXname_markoX_knowsPerson_selectXp_fX_byXnameX': [(lambda g:g.match("MATCH (p:person {name: 'marko'})-[:knows]->(f:person)").select('p', 'f').by('name'))], 
    'g_match_personXname_paramX_knowsPerson_selectXp_fX_byXnameX': [(lambda g:g.match('MATCH (p:person {name: $who})-[:knows]->(f:person)', { 'who': 'marko' }).select('p', 'f').by('name'))], 
    'g_match_multiPattern_sharedVariable_whereXa_neqXbXX_selectXa_b_sX_byXnameX': [(lambda g:g.match('MATCH (a:person)-[:created]->(s:software), (b:person)-[:created]->(s)').where('a', P.neq('b')).select('a', 'b', 's').by('name'))], 
    'g_match_terminalBindingMap': [(lambda g:g.match('MATCH (a:person)-[:knows]->(b:person)'))], 
    'g_inject_match_midTraversal_selectXa_bX_byXnameX': [(lambda g:g.inject(1).match('MATCH (a:person)-[:knows]->(b:person)').select('a', 'b').by('name'))], 
    'g_match_anonymousXknowsX_person_selectXbX_byXnameX': [(lambda g:g.match('MATCH ()-[:knows]->(b:person)').select('b').by('name'))], 
    'g_match_personXage_29iX_selectXpX_byXnameX': [(lambda g:g.match('MATCH (p:person {age: 29i})').select('p').by('name'))], 
    'g_match_absentAgeProperty_selectXvX_byXnameX': [(lambda g:g.match('MATCH (v {age: null})').select('v').by('name'))], 
    'g_match_personXname_marko_age_29iX_selectXpX_byXnameX': [(lambda g:g.match("MATCH (p:person {name: 'marko', age: 29i})").select('p').by('name'))], 
    'g_match_personXknowsXeX_person_selectXeX': [(lambda g:g.match('MATCH (a:person)-[e:knows]->(b:person)').select('e'))], 
    'g_match_personXknowsXweight_1X_person_selectXa_bX_byXnameX': [(lambda g:g.match('MATCH (a:person)-[:knows {weight: 1.0}]->(b:person)').select('a', 'b').by('name'))], 
    'g_match_personXanyEdgeX_software_selectXa_bX_byXnameX': [(lambda g:g.match('MATCH (a:person)-[]->(b:software)').select('a', 'b').by('name'))], 
    ...
    'g_match_multiPattern_bridgeVariable_selectXa_b_sX_byXnameX': [(lambda g:g.match('MATCH (a:person)-[:knows]->(b:person), (b:person)-[:created]->(s:software)').select('a', 'b', 's').by('name'))], 
    'g_match_personXknowsXeVar_weight_1X_person_selectXa_e_bX': [(lambda g:g.match('MATCH (a:person)-[e:knows {weight: 1.0}]->(b:person)').select('a', 'e', 'b'))], 
    'g_match_anyXknowsX_any_selectXaX_byXnameX_concatXconstant_selectXbX_byXnameXX': [(lambda g:g.match('MATCH (a)-[:knows]->(b)').select('a').by('name').concat(__.constant(' knows '), __.select('b').by('name')))], 
    ...
    'g_mergeVXlabel_ab_name_markoX_multilabel_create': [(lambda g:g.merge_v({ T.label: ['person', 'employee'], 'name': 'marko' })), (lambda g:g.V()), (lambda g:g.V().has_label('person').has_label('employee')), (lambda g:g.V().has('name', 'marko'))], 
    'g_mergeVXlabel_abc_name_testX_multilabel_create': [(lambda g:g.merge_v({ T.label: ['a', 'b', 'c'], 'name': 'test' })), (lambda g:g.V()), (lambda g:g.V().has_label('a').has_label('b').has_label('c'))], 
    'g_mergeVXlabel_ab_name_markoX_multilabel_match': [(lambda g:g.add_v('person').add_label('employee').property('name', 'marko')), (lambda g:g.merge_v({ T.label: ['person', 'employee'], 'name': 'marko' })), (lambda g:g.V()), (lambda g:g.V().has_label('person').has_label('employee'))], 
    'g_mergeVXlabel_ab_name_markoX_multilabel_nomatch': [(lambda g:g.add_v('person').property('name', 'marko')), (lambda g:g.merge_v({ T.label: ['person', 'employee'], 'name': 'marko' })), (lambda g:g.V())], 
    'g_mergeVXlabel_person_name_markoX_optionXonMatch_label_managerX': [(lambda g:g.add_v('person').add_label('employee').property('name', 'marko')), (lambda g:g.merge_v({ T.label: 'person', 'name': 'marko' }).option(Merge.on_match, { T.label: 'manager' })), (lambda g:g.V()), (lambda g:g.V().has_label('manager')), (lambda g:g.V().has_label('person')), (lambda g:g.V().has_label('employee'))], 
    'g_mergeVXlabel_person_name_markoX_optionXonMatch_label_manager_directorX': [(lambda g:g.add_v('person').property('name', 'marko')), (lambda g:g.merge_v({ T.label: 'person', 'name': 'marko' }).option(Merge.on_match, { T.label: ['manager', 'director'] })), (lambda g:g.V()), (lambda g:g.V().has_label('manager').has_label('director')), (lambda g:g.V().has_label('person'))], 
    'g_mergeVXlabel_person_name_markoX_optionXonMatch_label_emptyX': [(lambda g:g.add_v('person').property('name', 'marko')), (lambda g:g.merge_v({ T.label: 'person', 'name': 'marko' }).option(Merge.on_match, { T.label: [] })), (lambda g:g.V()), (lambda g:g.V().has_label('person'))], 
    'g_mergeVXname_markoX_optionXonCreate_label_ab_name_markoX': [(lambda g:g.merge_v({ 'name': 'marko' }).option(Merge.on_create, { T.label: ['person', 'employee'], 'name': 'marko' })), (lambda g:g.V()), (lambda g:g.V().has_label('person').has_label('employee')), (lambda g:g.V().has('name', 'marko'))], 
    'g_mergeVXlabel_person_name_markoX_optionXonMatch_label_existingX': [(lambda g:g.add_v('person').add_label('employee').property('name', 'marko')), (lambda g:g.merge_v({ T.label: 'person', 'name': 'marko' }).option(Merge.on_match, { T.label: 'person' })), (lambda g:g.V()), (lambda g:g.V().has_label('person').has_label('employee'))], 
    'g_mergeVXlabel_ab_name_markoX_single_label_graph': [(lambda g:g.merge_v({ T.label: ['person', 'employee'], 'name': 'marko' }))], 
    'g_mergeVXlabel_person_name_markoX_optionXonCreate_label_abX_single_label_graph': [(lambda g:g.merge_v({ 'name': 'newperson' }).option(Merge.on_create, { T.label: ['person', 'employee'], 'name': 'newperson' }))], 
    'g_mergeVXlabel_person_name_markoX_optionXonMatch_label_managerX_single_label_graph': [(lambda g:g.add_v('person').property('name', 'marko')), (lambda g:g.merge_v({ T.label: 'person', 'name': 'marko' }).option(Merge.on_match, { T.label: 'manager' }))], 
    ...
    'g_V_hasLabelXhabitatX_order_byXlabels_order_foldX_name_multilabel': [(lambda g:g.V().has_label('habitat').order().by(__.labels().order().fold()).values('name'))], 
    ...
    'g_V_valueMapXtrueX': [(lambda g:g.with_('singlelabel').V().value_map(True))], 
    'g_V_valueMap_withXtokensX': [(lambda g:g.with_('singlelabel').V().value_map().with_(WithOptions.tokens))], 
    'g_V_valueMap_withXtokensX_single_label_only_graph_default': [(lambda g:g.V().value_map().with_(WithOptions.tokens))], 
    'g_V_valueMap_withXtokensX_single_label_only_graph_multi_label_default': [(lambda g:g.V().value_map().with_(WithOptions.tokens))], 
    'g_V_valueMapXname_ageX': [(lambda g:g.V().value_map('name', 'age'))], 
    'g_V_valueMapXtrue_name_ageX': [(lambda g:g.with_('singlelabel').V().value_map(True, 'name', 'age'))], 
    'g_V_valueMapXname_ageX_withXtokensX': [(lambda g:g.with_('singlelabel').V().value_map('name', 'age').with_(WithOptions.tokens))], 
    'g_V_valueMapXname_ageX_withXtokens_labelsX_byXunfoldX': [(lambda g:g.with_('singlelabel').V().value_map('name', 'age').with_(WithOptions.tokens, WithOptions.labels).by(__.unfold()))], 
    ...
    'g_V_hasLabelXpersonX_filterXoutEXcreatedXX_valueMapXtrueX': [(lambda g:g.with_('singlelabel').V().has_label('person').filter_(__.out_e('created')).value_map(True))], 
    'g_V_hasLabelXpersonX_filterXoutEXcreatedXX_valueMap_withXtokensX': [(lambda g:g.with_('singlelabel').V().has_label('person').filter_(__.out_e('created')).value_map().with_(WithOptions.tokens))], 
    ...
    'g_withXmultilabelX_VXmarkoX_valueMap_withXtokensX': [(lambda g:g.with_('multilabel').V().has('name', 'marko').value_map().with_(WithOptions.tokens))], 
    'g_V_valueMap_withXtokensX_single_label_default': [(lambda g:g.add_v('person').add_label('employee').property('name', 'marko')), (lambda g:g.V().value_map().with_(WithOptions.tokens))], 
    'g_withXmultilabelX_V_valueMap_withXtokensX_multilabel': [(lambda g:g.with_('multilabel').V().has('name', 'tux').value_map('name', 'species').with_(WithOptions.tokens))], 
    'g_V_valueMap_withXtokensX_multi_label_default': [(lambda g:g.add_v('person').add_label('employee').property('name', 'marko')), (lambda g:g.V().value_map().with_(WithOptions.tokens))], 
    'g_withXsinglelabelX_V_valueMap_withXtokensX_multi_label_default': [(lambda g:g.with_('singlelabel').V().has('name', 'lagoon').value_map('name', 'biome').with_(WithOptions.tokens))], 
    'g_withXsinglelabelX_V_valueMapXtrueX_zero_label_vertex': [(lambda g:g.add_v().property('name', 'nobody')), (lambda g:g.with_('singlelabel').V().value_map(True))], 
    'g_withXmultilabelX_V_valueMapXtrueX_zero_label_vertex': [(lambda g:g.add_v().property('name', 'nobody')), (lambda g:g.with_('multilabel').V().value_map(True))], 
    'g_V_valueMapXtrueX_zero_label_vertex_multi_label_default': [(lambda g:g.add_v().property('name', 'nobody')), (lambda g:g.V().value_map(True))], 
    'g_V_valueMapXtrueX_zero_label_vertex_single_label_default': [(lambda g:g.add_v().property('name', 'nobody')), (lambda g:g.V().value_map(True))], 
    ...
    'g_VXvid1X_id_VXidentityX_name': [(lambda g, vid1=None:g.V(vid1).id_().V(__.identity()).values('name'))], 
    'g_VXvid1_vid2X_id_VXidentityX_name': [(lambda g, vid2=None,vid1=None:g.V(vid1, vid2).id_().V(__.identity()).values('name'))], 
    'g_VXvid1X_id_asXbookmarkX_V_hasXname_joshX_VXselectXbookmarkXX_name': [(lambda g, vid1=None:g.V(vid1).id_().as_('bookmark').V().has('name', 'josh').V(__.select('bookmark')).values('name'))], 
    'g_VXvid1X_VXoutXknowsX_idX_name': [(lambda g, vid1=None:g.V(vid1).V(__.out('knows').id_()).values('name'))], 
    'g_injectX9999X_VXidentityX': [(lambda g:g.inject(9999).V(__.identity()))], 
    'g_VXVXvid1X_idX_name': [(lambda g, vid1=None:g.V(__.V(vid1).id_()).values('name'))], 
    ...
    'g_V_hasLabelXpersonX_hasXname_markoX_addLabelXemployeeX_labels': [(lambda g:g.add_v('person').property('name', 'marko')), (lambda g:g.V().has_label('person').has('name', 'marko').add_label('employee').labels().fold()), (lambda g:g.V().has_label('person').has_label('employee'))], 
    'g_V_addLabelXa_bX_labels_count': [(lambda g:g.add_v('person')), (lambda g:g.V().add_label('a', 'b').labels().count())], 
    'g_V_addLabelXexistingX_labels_count': [(lambda g:g.add_v('person')), (lambda g:g.V().add_label('person').labels().count())], 
    'g_E_addLabelXfriendX_labels_fold': [(lambda g:g.add_v('person').property('name', 'marko').as_('a').add_v('person').property('name', 'josh').as_('b').add_e('knows').from_('a').to('b')), (lambda g:g.E().add_label('friend').labels().fold())], 
    'g_V_addLabelXemployeeX_single_label_graph': [(lambda g:g.add_v('person')), (lambda g:g.V().has_label('person').add_label('employee'))], 
    'g_V_addLabelXa_bX_single_label_graph': [(lambda g:g.add_v('person')), (lambda g:g.V().has_label('person').add_label('a', 'b'))], 
    'g_V_addLabelXconstantXemployeeXX_labels_count': [(lambda g:g.add_v('person')), (lambda g:g.V().add_label(__.constant('employee')).labels().count())], 
    'g_V_addLabelXconstantXlistXa_bXXX_labels_count': [(lambda g:g.add_v('person')), (lambda g:g.V().add_label(__.constant(['a', 'b'])).labels().count())], 
    'g_V_addLabelXconstantXaX_constantXbXX_labels_count': [(lambda g:g.add_v('person')), (lambda g:g.V().add_label(__.constant('a'), __.constant('b')).labels().count())], 
    'g_V_addLabelXconstantXlistXa_bXX_constantXcXX_labels': [(lambda g:g.add_v('person')), (lambda g:g.V().add_label(__.constant(['a', 'b']), __.constant('c')).labels().fold())], 
    ...
    'g_V_dropLabelXaX_labels': [(lambda g:g.add_v('a', 'b')), (lambda g:g.V().drop_label('a').labels().fold()), (lambda g:g.V().has_label('a')), (lambda g:g.V().has_label('b'))], 
    'g_V_dropLabels_labels': [(lambda g:g.add_v('a', 'b')), (lambda g:g.V().drop_labels().labels())], 
    'g_V_dropLabelXa_bX_labels': [(lambda g:g.add_v('a', 'b', 'c')), (lambda g:g.V().drop_label('a', 'b').labels())], 
    'g_V_dropLabels_defaultLabel': [(lambda g:g.add_v('person')), (lambda g:g.V().drop_labels().labels())], 
    'g_E_dropLabelXknowsX_labels': [(lambda g:g.add_v('person').as_('a').add_v('person').as_('b').add_e('knows').from_('a').to('b')), (lambda g:g.E().drop_label('knows').labels().fold())], 
    'g_E_dropLabels_labels': [(lambda g:g.add_v('person').as_('a').add_v('person').as_('b').add_e('knows').from_('a').to('b')), (lambda g:g.E().drop_labels().labels())], 
    'g_V_dropLabelXnonExistentX_labels': [(lambda g:g.add_v('a', 'b')), (lambda g:g.V().drop_label('xyz').labels())], 
    'g_V_dropLabelXpersonX_single_label_graph': [(lambda g:g.add_v('person')), (lambda g:g.V().has_label('person').drop_label('person'))], 
    'g_V_dropLabels_single_label_graph': [(lambda g:g.add_v('person')), (lambda g:g.V().has_label('person').drop_labels())], 
    'g_V_dropLabelXconstantXaXX_labels': [(lambda g:g.add_v('a', 'b')), (lambda g:g.V().drop_label(__.constant('a')).labels().fold()), (lambda g:g.V().has_label('a')), (lambda g:g.V().has_label('b'))], 
    'g_V_dropLabelXconstantXlistXa_bXXX_labels': [(lambda g:g.add_v('a', 'b', 'c')), (lambda g:g.V().drop_label(__.constant(['a', 'b'])).labels())], 
    'g_V_dropLabelXconstantXaX_constantXbXX_labels': [(lambda g:g.add_v('a', 'b', 'c')), (lambda g:g.V().drop_label(__.constant('a'), __.constant('b')).labels())], 
    'g_V_dropLabelXconstantXlistXa_bXX_constantXcXX_labels': [(lambda g:g.add_v('a', 'b', 'c')), (lambda g:g.V().drop_label(__.constant(['a', 'b']), __.constant('c')).labels().fold())], 
    ...
    'g_V_hasLabelXhabitatX_group_byXlabelX_byXcountX': [(lambda g:g.V().has_label('habitat').group().by(T.label).by(__.count()))], 
    'g_V_hasXname_tuxX_group_byXlabelX_byXcountX': [(lambda g:g.V().has('name', 'tux').group().by(__.label()).by(__.count()))], 
    'g_V_hasLabelXreptileX_group_byXlabels_order_foldX_byXname_foldX': [(lambda g:g.V().has_label('reptile').group().by(__.labels().order().fold()).by(__.values('name').fold()))], 
    ...
    'g_V_hasXname_tuxX_groupCount_byXlabelX': [(lambda g:g.V().has('name', 'tux').group_count().by(T.label))], 
    'g_V_labels_groupCount': [(lambda g:g.V().labels().group_count())], 
    ...
    'g_injectXpoint5X': [(lambda g:g.inject(.5))], 
    'g_injectXpoint5fX': [(lambda g:g.inject(.5))], 
    'g_injectXpoint5dX': [(lambda g:g.inject(.5))], 
    'g_VXvid2X_propertyXalias_VXvid1X_valuesXnameXX': [(lambda g, vid2=None,vid1=None:g.add_v('person').property('name', 'marko').property('age', 29).add_v('person').property('name', 'vadas').property('age', 27).add_v('software').property('name', 'lop').property('lang', 'java').add_v('person').property('name', 'josh').property('age', 32).add_v('person').property('name', 'peter').property('age', 35).add_v('software').property('name', 'ripple').property('lang', 'java')), (lambda g, vid2=None,vid1=None:g.V(vid2).property('alias', __.V(vid1).values('name'))), (lambda g, vid2=None,vid1=None:g.V().has('alias', 'marko'))], 
    'g_VXvid1X_propertyXcreatorCount_VXvid1X_inXcreatedX_countX': [(lambda g, vid1=None:g.add_v('person').property('name', 'marko').property('age', 29).as_('marko').add_v('person').property('name', 'vadas').property('age', 27).add_v('software').property('name', 'lop').property('lang', 'java').as_('lop').add_v('person').property('name', 'josh').property('age', 32).as_('josh').add_v('person').property('name', 'peter').property('age', 35).as_('peter').add_v('software').property('name', 'ripple').property('lang', 'java').as_('ripple').add_e('knows').from_('marko').to(__.V().has('name', 'vadas')).add_e('knows').from_('marko').to('josh').add_e('created').from_('marko').to('lop').add_e('created').from_('josh').to('lop').add_e('created').from_('josh').to('ripple').add_e('created').from_('peter').to('lop')), (lambda g, vid1=None:g.V(vid1).property('creatorCount', __.V(vid1).in_('created').count())), (lambda g, vid1=None:g.V().has('creatorCount', long(3)))], 
    'g_VXvid1X_propertyXknownCount_outXknowsX_countX': [(lambda g, vid1=None:g.add_v('person').property('name', 'marko').property('age', 29).as_('marko').add_v('person').property('name', 'vadas').property('age', 27).as_('vadas').add_v('software').property('name', 'lop').property('lang', 'java').add_v('person').property('name', 'josh').property('age', 32).as_('josh').add_v('person').property('name', 'peter').property('age', 35).add_v('software').property('name', 'ripple').property('lang', 'java').add_e('knows').from_('marko').to('vadas').add_e('knows').from_('marko').to('josh')), (lambda g, vid1=None:g.V(vid1).property('knownCount', __.out('knows').count())), (lambda g, vid1=None:g.V().has('knownCount', long(2)))], 
    'g_VXvid1X_propertyXcreator_inXcreatedX_valuesXnameXX': [(lambda g, vid1=None:g.add_v('person').property('name', 'marko').property('age', 29).as_('marko').add_v('person').property('name', 'vadas').property('age', 27).add_v('software').property('name', 'lop').property('lang', 'java').as_('lop').add_v('person').property('name', 'josh').property('age', 32).as_('josh').add_v('person').property('name', 'peter').property('age', 35).as_('peter').add_v('software').property('name', 'ripple').property('lang', 'java').as_('ripple').add_e('knows').from_('marko').to(__.V().has('name', 'vadas')).add_e('knows').from_('marko').to('josh').add_e('created').from_('marko').to('lop').add_e('created').from_('josh').to('lop').add_e('created').from_('josh').to('ripple').add_e('created').from_('peter').to('lop')), (lambda g, vid1=None:g.V(vid1).property('creator', __.in_('created').values('name'))), (lambda g, vid1=None:g.V().has('creator'))], 
    'g_VXvid2X_propertyXVXvid1X_projectXfriendCount_softwareCreatedXX': [(lambda g, vid2=None,vid1=None:g.add_v('person').property('name', 'marko').property('age', 29).as_('marko').add_v('person').property('name', 'vadas').property('age', 27).as_('vadas').add_v('software').property('name', 'lop').property('lang', 'java').as_('lop').add_v('person').property('name', 'josh').property('age', 32).as_('josh').add_v('person').property('name', 'peter').property('age', 35).as_('peter').add_v('software').property('name', 'ripple').property('lang', 'java').as_('ripple').add_e('knows').from_('marko').to('vadas').add_e('knows').from_('marko').to('josh').add_e('created').from_('marko').to('lop').add_e('created').from_('josh').to('lop').add_e('created').from_('josh').to('ripple').add_e('created').from_('peter').to('lop')), (lambda g, vid2=None,vid1=None:g.V(vid2).property(__.V(vid1).project('friendCount', 'softwareCreated').by(__.out('knows').count()).by(__.out('created').values('name')))), (lambda g, vid2=None,vid1=None:g.V().has('friendCount', long(2))), (lambda g, vid2=None,vid1=None:g.V().has('softwareCreated', 'lop'))], 
    'g_VXvid2X_propertyXVXvid1X_projectXoriginalName_originalLabelX_byXnameX_byXlabelXX': [(lambda g, vid2=None,vid1=None:g.add_v('person').property('name', 'marko').property('age', 29).as_('marko').add_v('person').property('name', 'vadas').property('age', 27).add_v('software').property('name', 'lop').property('lang', 'java').as_('lop').add_v('person').property('name', 'josh').property('age', 32).add_v('person').property('name', 'peter').property('age', 35).add_v('software').property('name', 'ripple').property('lang', 'java')), (lambda g, vid2=None,vid1=None:g.V(vid2).property(__.V(vid1).project('originalName', 'originalLabel').by(__.values('name')).by(__.label()))), (lambda g, vid2=None,vid1=None:g.V(vid2).has('originalName', 'marko')), (lambda g, vid2=None,vid1=None:g.V(vid2).has('originalLabel', 'person'))], 
    'g_VXvid1X_propertyXlist_friends_outXknowsX_valuesXnameXX': [(lambda g, vid1=None:g.add_v('person').property('name', 'marko').property('age', 29).as_('marko').add_v('person').property('name', 'vadas').property('age', 27).as_('vadas').add_v('software').property('name', 'lop').property('lang', 'java').add_v('person').property('name', 'josh').property('age', 32).as_('josh').add_v('person').property('name', 'peter').property('age', 35).add_v('software').property('name', 'ripple').property('lang', 'java').add_e('knows').from_('marko').to('vadas').add_e('knows').from_('marko').to('josh')), (lambda g, vid1=None:g.V(vid1).property(Cardinality.list_, 'friends', __.out('knows').values('name'))), (lambda g, vid1=None:g.V(vid1).properties('friends'))], 
    'g_VXvid1X_propertyXset_langs_outXcreatedX_valuesXlangXX': [(lambda g, vid1=None:g.add_v('person').property('name', 'marko').property('age', 29).add_v('person').property('name', 'vadas').property('age', 27).add_v('software').property('name', 'lop').property('lang', 'java').as_('lop').add_v('person').property('name', 'josh').property('age', 32).as_('josh').add_v('person').property('name', 'peter').property('age', 35).add_v('software').property('name', 'ripple').property('lang', 'java').as_('ripple').add_e('created').from_('josh').to('lop').add_e('created').from_('josh').to('ripple')), (lambda g, vid1=None:g.V(vid1).property(Cardinality.set_, 'langs', __.out('created').values('lang'))), (lambda g, vid1=None:g.V(vid1).properties('langs'))], 
    'g_VXvid1X_propertyXsingle_friend_outXknowsX_valuesXnameXX': [(lambda g, vid1=None:g.add_v('person').property('name', 'marko').property('age', 29).as_('marko').add_v('person').property('name', 'vadas').property('age', 27).as_('vadas').add_v('software').property('name', 'lop').property('lang', 'java').add_v('person').property('name', 'josh').property('age', 32).as_('josh').add_v('person').property('name', 'peter').property('age', 35).add_v('software').property('name', 'ripple').property('lang', 'java').add_e('knows').from_('marko').to('vadas').add_e('knows').from_('marko').to('josh')), (lambda g, vid1=None:g.V(vid1).property(Cardinality.single, 'friend', __.out('knows').values('name')))], 
    'g_VXvid1X_propertyXVXvid1X_groupX_byXidX_byXvaluesXnameXXX': [(lambda g, vid1=None:g.add_v('person').property('name', 'marko').property('age', 29)), (lambda g, vid1=None:g.V(vid1).property(__.V(vid1).group().by(__.id_()).by(__.values('name'))))], 
