...
world.gremlins = {
    ...
    'g_V_hasXname_VXvid1X_outXcreatedX_valuesXnameXX': [(lambda g, vid1=None:g.V().has('name', __.V(vid1).out('created').values('name')))], 
    ...
    'g_VXvid1X_outXcreatedX_asXsoftwareX_V_hasXname_selectXsoftwareX_valuesXnameXX_inXcreatedX_name': [(lambda g, vid1=None:g.V(vid1).out('created').as_('sw').V().has('name', __.select('sw').values('name')).in_('created').values('name'))], 
    'g_VXvid1X_VXoutXknowsX_idX_name': [(lambda g, vid1=None:g.V(vid1).V(__.out('knows').id_()).values('name'))], 
    'g_VXvid1X_VXoutXknowsX_hasXname_joshX_idX_valuesXageX': [(lambda g, vid1=None:g.V(vid1).V(__.out('knows').has('name', 'josh').id_()).values('age'))], 
    'g_VXvid1X_VXoutXknowsX_outXknowsX_idX_name': [(lambda g, vid1=None:g.V(vid1).V(__.out('knows').out('knows').id_()).values('name'))], 
    'g_VXvid1X_VXoutXcreatedX_idX_valuesXlangX': [(lambda g, vid1=None:g.V(vid1).V(__.out('created').id_()).values('lang'))], 
    'g_VXvid1X_EXoutE_idX': [(lambda g, vid1=None:g.V(vid1).E(__.out_e().id_()))], 
    'g_VXvid1X_EXoutEXknowsX_hasXweight_05X_idX': [(lambda g, vid1=None:g.V(vid1).E(__.out_e('knows').has('weight', 0.5).id_()))], 
    'g_VXvid1X_EXoutXknowsX_outXknowsX_outE_idX': [(lambda g, vid1=None:g.V(vid1).E(__.out('knows').out('knows').out_e().id_()))], 
    ...
    'g_VXvid2X_propertyXalias_VXvid1X_valuesXnameXX': [(lambda g, vid2=None,vid1=None:g.V(vid2).property('alias', __.V(vid1).values('name'))), (lambda g, vid2=None,vid1=None:g.V().has('alias', 'marko'))], 
    'g_VXvid1X_propertyXcreatorCount_VXvid1X_inXcreatedX_countX': [(lambda g, vid1=None:g.V(vid1).property('creatorCount', __.V(vid1).in_('created').count())), (lambda g, vid1=None:g.V().has('creatorCount', long(3)))], 
    'g_VXvid1X_propertyXknownCount_outXknowsX_countX': [(lambda g, vid1=None:g.V(vid1).property('knownCount', __.out('knows').count())), (lambda g, vid1=None:g.V().has('knownCount', long(2)))], 
    'g_VXvid1X_propertyXcreator_inXcreatedX_valuesXnameXX': [(lambda g, vid1=None:g.V(vid1).property('creator', __.in_('created').values('name'))), (lambda g, vid1=None:g.V().has('creator'))], 
    'g_VXvid2X_propertyXVXvid1X_projectXfriendCount_softwareCreatedXX': [(lambda g, vid2=None,vid1=None:g.V(vid2).property(__.V(vid1).project('friendCount', 'softwareCreated').by(__.out('knows').count()).by(__.out('created').values('name')))), (lambda g, vid2=None,vid1=None:g.V().has('friendCount', long(2))), (lambda g, vid2=None,vid1=None:g.V().has('softwareCreated', 'lop'))], 
    'g_VXvid2X_propertyXVXvid1X_projectXoriginalName_originalLabelX_byXnameX_byXlabelXX': [(lambda g, vid2=None,vid1=None:g.V(vid2).property(__.V(vid1).project('originalName', 'originalLabel').by(__.values('name')).by(__.label()))), (lambda g, vid2=None,vid1=None:g.V(vid2).has('originalName', 'marko')), (lambda g, vid2=None,vid1=None:g.V(vid2).has('originalLabel', 'person'))], 
    'g_VXvid1X_propertyXlist_friends_outXknowsX_valuesXnameXX': [(lambda g, vid1=None:g.V(vid1).property(Cardinality.list_, 'friends', __.out('knows').values('name'))), (lambda g, vid1=None:g.V(vid1).properties('friends'))], 
    'g_VXvid1X_propertyXlist_creators_inXcreatedX_valuesXnameXX': [(lambda g, vid1=None:g.V(vid1).property(Cardinality.list_, 'creators', __.in_('created').values('name'))), (lambda g, vid1=None:g.V(vid1).properties('creators'))], 
    'g_VXvid1X_propertyXset_langs_outXcreatedX_valuesXlangXX': [(lambda g, vid1=None:g.V(vid1).property(Cardinality.set_, 'langs', __.out('created').values('lang'))), (lambda g, vid1=None:g.V(vid1).properties('langs'))], 
    'g_VXvid1X_propertyXsingle_friend_outXknowsX_valuesXnameXX': [(lambda g, vid1=None:g.V(vid1).property(Cardinality.single, 'friend', __.out('knows').values('name')))], 
    'g_VXvid1X_propertyXVXvid1X_groupX_byXidX_byXvaluesXnameXXX': [(lambda g, vid1=None:g.V(vid1).property(__.V(vid1).group().by(__.id_()).by(__.values('name'))))], 
