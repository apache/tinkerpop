...
world.gremlins = {
    ...
    'g_addEXknowsvarX_fromXaX_toXbX_propertyXweight_0_1X': [(lambda g, xx1=None,v6=None,xx2=None,v1=None:g.add_v('person').property('name', 'marko').property('age', 29).as_('marko').add_v('person').property('name', 'vadas').property('age', 27).as_('vadas').add_v('software').property('name', 'lop').property('lang', 'java').as_('lop').add_v('person').property('name', 'josh').property('age', 32).as_('josh').add_v('software').property('name', 'ripple').property('lang', 'java').as_('ripple').add_v('person').property('name', 'peter').property('age', 35).as_('peter').add_e('knows').from_('marko').to('vadas').property('weight', 0.5).add_e('knows').from_('marko').to('josh').property('weight', 1.0).add_e('created').from_('marko').to('lop').property('weight', 0.4).add_e('created').from_('josh').to('ripple').property('weight', 1.0).add_e('created').from_('josh').to('lop').property('weight', 0.4).add_e('created').from_('peter').to('lop').property('weight', 0.2)), (lambda g, xx1=None,v6=None,xx2=None,v1=None:g.add_e(xx1).from_(v1).to(v6).property('weight', xx2)), (lambda g, xx1=None,v6=None,xx2=None,v1=None:g.E()), (lambda g, xx1=None,v6=None,xx2=None,v1=None:g.V(v1).out_e('knows')), (lambda g, xx1=None,v6=None,xx2=None,v1=None:g.V(v1).out('knows').has('name', 'peter'))], 
    ...
    'g_injectXa_null_bX_combineXa_cX': [(lambda g, xx1=None:g.inject(xx1).combine(['a', 'c']))], 
    'g_injectXa_null_bX_combineXa_null_cX': [(lambda g, xx1=None:g.inject(xx1).combine(['a', None, 'c']))], 
    'g_injectX3_threeX_combineXfive_three_7X': [(lambda g, xx1=None:g.inject(xx1).combine(['five', 'three', 7]))], 
    ...
    'g_injectXa_null_bX_differenceXa_cX': [(lambda g, xx1=None:g.inject(xx1).difference(['a', 'c']))], 
    'g_injectXa_null_bX_differenceXa_null_cX': [(lambda g, xx1=None:g.inject(xx1).difference(['a', None, 'c']))], 
    'g_injectX3_threeX_differenceXfive_three_7X': [(lambda g, xx1=None:g.inject(xx1).difference(['five', 'three', 7]))], 
    ...
    'g_injectXa_null_bX_intersectXa_cX': [(lambda g, xx1=None:g.inject(xx1).intersect(['a', 'c']))], 
    'g_injectXa_null_bX_intersectXa_null_cX': [(lambda g, xx1=None:g.inject(xx1).intersect(['a', None, 'c']))], 
    'g_injectX3_threeX_intersectXfive_three_7X': [(lambda g, xx1=None:g.inject(xx1).intersect(['five', 'three', 7]))], 
    ...
    'g_injectXa_null_bX_mergeXa_cX': [(lambda g, xx1=None:g.inject(xx1).merge(['a', 'c']))], 
    'g_injectXa_null_bX_mergeXa_null_cX': [(lambda g, xx1=None:g.inject(xx1).merge(['a', None, 'c']))], 
    'g_injectX3_threeX_mergeXfive_three_7X': [(lambda g, xx1=None:g.inject(xx1).merge(['five', 'three', 7]))], 
