...
world.gremlins = {
    ...
    'g_V_valuesXnameX_isXtypeOfXGType_STRINGXX': [(lambda g:g.V().values('name').is_(P.type_of(GType.STRING))), (lambda g:g.V().values('name').is_(P.type_of(GType.STRING)))], 
    ...
    'g_V_orXhasXname_typeOfXGType_STRINGXX__hasXage_typeOfXGType_INTXXX_valuesXnameX': [(lambda g:g.V().or_(__.has('name', P.type_of(GType.STRING)), __.has('age', P.type_of(GType.INT))).values('name')), (lambda g:g.V().or_(__.has('name', P.type_of(GType.STRING)), __.has('age', P.type_of(GType.INT))).values('name'))], 
    'g_V_andXhasXname_typeOfXGType_STRINGXX__hasXage_typeOfXGType_INTXXX_valuesXnameX': [(lambda g:g.V().and_(__.has('name', P.type_of(GType.STRING)), __.has('age', P.type_of(GType.INT))).values('name')), (lambda g:g.V().and_(__.has('name', P.type_of(GType.STRING)), __.has('age', P.type_of(GType.INT))).values('name'))], 
    ...
    'g_V_orXvaluesXageX_isXtypeOfXGType_INTXX__valuesXnameX_isXtypeOfXGType_STRINGXXX_count': [(lambda g:g.V().or_(__.values('age').is_(P.type_of(GType.INT)), __.values('name').is_(P.type_of(GType.STRING))).count()), (lambda g:g.V().or_(__.values('age').is_(P.type_of(GType.INT)), __.values('name').is_(P.type_of(GType.STRING))).count())], 
    ...
    'g_V_hasLabelXgeneralX_valuesXbooleanX_isXtypeOfXGType_BOOLEANXX': [(lambda g:g.V().has_label('data').values('boolean').is_(P.type_of(GType.BOOLEAN)))], 
    'g_V_hasLabelXgeneralX_valuesXstringX_isXtypeOfXGType_STRINGXX': [(lambda g:g.V().has_label('data').values('string').is_(P.type_of(GType.STRING)))], 
    'g_V_hasLabelXgeneralX_valuesXuuidX_isXtypeOfXGType_UUIDXX': [(lambda g:g.V().has_label('data').values('uuid').is_(P.type_of(GType.UUID)))], 
    'g_inject_XtimeX_valuesXdatetimeX_isXtypeOfXGType_DATETIMEXX': [(lambda g:g.inject(datetime.datetime.fromisoformat('2023-08-08T00:00+00:00')).is_(P.type_of(GType.DATETIME)))], 
    'g_V_hasLabelXcollectionX_valuesXlistX_isXtypeOfXGType_LISTXX': [(lambda g:g.V().has_label('data').values('list').is_(P.type_of(GType.LIST)))], 
    'g_V_hasLabelXcollectionX_valuesXsetX_isXtypeOfXGType_SETXX': [(lambda g:g.V().has_label('data').values('set').is_(P.type_of(GType.SET)))], 
    'g_V_hasLabelXcollectionX_valuesXmapX_isXtypeOfXGType_MAPXX': [(lambda g:g.V().has_label('data').values('map').is_(P.type_of(GType.MAP)))], 
    ...
    'g_V_isXtypeOfXGType_VERTEXXX_count': [(lambda g:g.V().is_(P.type_of(GType.VERTEX)).count())], 
    'g_E_isXtypeOfXGType_EDGEXX_count': [(lambda g:g.E().is_(P.type_of(GType.EDGE)).count())], 
    'g_V_propertiesXnameX_isXtypeOfXGType_PROPERTYXX_count': [(lambda g:g.V().properties('name').is_(P.type_of(GType.PROPERTY)).count())], 
    'g_V_valuesXageX_isXtypeOfXGType_NUMBERXX': [(lambda g:g.V().values('age').is_(P.type_of(GType.NUMBER)))], 
    ...
    'g_V_valuesXageX_isXtypeOfXGType_LONGXX': [(lambda g:g.V().values('age').is_(P.type_of(GType.LONG)))], 
    ...
    'g_V_valuesXageX_isXtypeOfXjava_lang_IntegerXX': [(lambda g:g.V().values('age').is_(P.type_of('Integer')))], 
    'g_V_hasXage_typeOfXGType_NUMBERXX_valuesXnameX': [(lambda g:g.V().has('age', P.type_of(GType.NUMBER)).values('name'))], 
    'g_V_valuesXageX_isXtypeOfXGType_INTX_orXtypeOfXGType_LONGXXX': [(lambda g:g.V().values('age').is_(P.type_of(GType.INT).or_(P.type_of(GType.LONG))))], 
    ...
    'g_V_valuesXage_nameX_isXtypeOfXintegerStringXX': [(lambda g:g.V().values('age', 'name').is_(P.type_of('Integer')))], 
    'g_V_orXvaluesXageX_isXtypeOfXGType_BYTEXX__valuesXageX_isXtypeOfXGType_SHORTXXX_count': [(lambda g:g.V().or_(__.values('age').is_(P.type_of(GType.BYTE)), __.values('age').is_(P.type_of(GType.SHORT))).count())], 
    'g_V_orXvaluesXageX_isXtypeOfXGType_NUMBERXX__valuesXnameX_isXtypeOfXGType_BOOLEANXXX_valuesXnameX': [(lambda g:g.V().or_(__.values('age').is_(P.type_of(GType.NUMBER)), __.values('name').is_(P.type_of(GType.BOOLEAN))).values('name'))], 
    'g_V_whereXvaluesXageX_isXtypeOfXGType_NUMBERXXX_valuesXnameX': [(lambda g:g.V().where(__.values('age').is_(P.type_of(GType.NUMBER))).values('name'))], 
    'g_V_whereXvaluesXageX_isXtypeOfXGType_BYTEXX_orXvaluesXageX_isXtypeOfXGType_SHORTXXXX_count': [(lambda g:g.V().where(__.values('age').is_(P.type_of(GType.BYTE)).or_(__.values('age').is_(P.type_of(GType.SHORT)))).count())], 
    'g_V_hasLabelXnumberX_isXtypeOfXGType_NUMBERXX_valuesXnameX': [(lambda g:g.V().has_label('data').values().is_(P.type_of(GType.NUMBER)))], 
    'g_V_hasLabelXnumberX_valuesXintX_isXtypeOfXGType_INTXX': [(lambda g:g.V().has_label('data').values('int').is_(P.type_of(GType.INT)))], 
    'g_V_hasLabelXnumberX_valuesXlongX_isXtypeOfXGType_LONGXX': [(lambda g:g.V().has_label('data').values('long').is_(P.type_of(GType.LONG)))], 
    'g_V_hasLabelXnumberX_valuesXfloatX_isXtypeOfXGType_FLOATXX': [(lambda g:g.V().has_label('data').values('float').is_(P.type_of(GType.FLOAT)))], 
    'g_V_hasLabelXnumberX_valuesXdoubleX_isXtypeOfXGType_DOUBLEXX': [(lambda g:g.V().has_label('data').values('double').is_(P.type_of(GType.DOUBLE)))], 
    'g_V_hasLabelXnumberX_valuesXintX_asNumberXGType_BYTEX_isXtypeOfXGType_BYTEXX': [(lambda g:g.V().has_label('data').values('int').as_number(GType.BYTE).is_(P.type_of(GType.BYTE)))], 
    'g_V_hasLabelXnumberX_valuesXintX_asNumberXGType_SHORTX_isXtypeOfXGType_SHORTXX': [(lambda g:g.V().has_label('data').values('int').as_number(GType.SHORT).is_(P.type_of(GType.SHORT)))], 
    'g_V_hasLabelXnumberX_valuesXintX_asNumberXGType_BIGINTX_isXtypeOfXGType_BIGINTXX': [(lambda g:g.V().has_label('data').values('int').as_number(GType.BIGINT).is_(P.type_of(GType.BIGINT)).count())], 
    'g_V_hasLabelXnumberX_valuesXintX_asNumberXGType_BIGDECIMALX_isXtypeOfXGType_BIGDECIMALXX': [(lambda g:g.V().has_label('data').values('int').as_number(GType.BIGDECIMAL).is_(P.type_of(GType.BIGDECIMAL)).count())], 
