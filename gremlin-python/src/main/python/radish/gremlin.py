...
world.gremlins = {
    ...
    'g_withStrategiesXRepeatUnrollStrategyX_V_repeatXout_hasXnameXX_timesX2X': [(lambda g:g.with_strategies(RepeatUnrollStrategy()).V().repeat(__.out().has('name', TextP.not_starting_with('z'))).times(2))], 
    'g_withoutStrategiesXRepeatUnrollStrategyX_V_repeatXout_hasXnameXX_timesX2X': [(lambda g:g.without_strategies(*[GremlinType('org.apache.tinkerpop.gremlin.process.traversal.strategy.optimization.RepeatUnrollStrategy')]).V().repeat(__.out().has('name', TextP.not_starting_with('z'))).times(2))], 
    'g_withStrategiesXRepeatUnrollStrategyX_V_repeatXin_hasXnameXX_timesX2X': [(lambda g:g.with_strategies(RepeatUnrollStrategy()).V().repeat(__.in_().has('age', P.gt(20))).times(2))], 
    'g_withoutStrategiesXRepeatUnrollStrategyX_V_repeatXin_hasXnameXX_timesX2X': [(lambda g:g.without_strategies(*[GremlinType('org.apache.tinkerpop.gremlin.process.traversal.strategy.optimization.RepeatUnrollStrategy')]).V().repeat(__.in_().has('age', P.gt(20))).times(2))], 
    ...
    'g_withStrategiesXRepeatUnrollStrategyX_V_repeatXbothE_otherV_hasXage_gtX30XXX_timesX2X': [(lambda g:g.with_strategies(RepeatUnrollStrategy()).V().repeat(__.both_e().other_v().has('age', P.lt(30))).times(2))], 
    'g_withoutStrategiesXRepeatUnrollStrategyX_V_repeatXbothE_otherV_hasXage_gtX30XXX_timesX2X': [(lambda g:g.without_strategies(*[GremlinType('org.apache.tinkerpop.gremlin.process.traversal.strategy.optimization.RepeatUnrollStrategy')]).V().repeat(__.both_e().other_v().has('age', P.lt(30))).times(2))], 
