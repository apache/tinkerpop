...
world.gremlins = {
    ...
    'g_withSackXBigInteger_TEN_powX1000X_assignX_V_localXoutXknowsX_barrierXnormSackXX_inXknowsX_barrier_sack': [(lambda g, xx1=None:g.withSack(xx1,Operator.assign).V().local(__.out('knows').barrier(Barrier.normSack)).in_('knows').barrier().sack())], 
