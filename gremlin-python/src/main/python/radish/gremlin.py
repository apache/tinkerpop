...
world.gremlins = {
    ...
    'g_withoutStrategiesXCountStrategyX_V_count': [(lambda g:g.without_strategies(CountStrategy).V().count())], 
    ...
    'g_injectXdatetimeXstrXX_dateAddXDT_hour_2X': [(lambda g:g.inject(datetime.datetime.fromtimestamp(1690934400).astimezone(datetime.timezone.utc)).date_add(DT.hour, 2))], 
    'g_injectXdatetimeXstrXX_dateAddXhour_2X': [(lambda g:g.inject(datetime.datetime.fromtimestamp(1690934400).astimezone(datetime.timezone.utc)).date_add(DT.hour, 2))], 
    'g_injectXdatetimeXstrXX_dateAddXhour_1X': [(lambda g:g.inject(datetime.datetime.fromtimestamp(1690934400).astimezone(datetime.timezone.utc)).date_add(DT.hour, -1))], 
    'g_injectXdatetimeXstrXX_dateAddXminute_10X': [(lambda g:g.inject(datetime.datetime.fromtimestamp(1690934400).astimezone(datetime.timezone.utc)).date_add(DT.minute, 10))], 
    'g_injectXdatetimeXstrXX_dateAddXsecond_20X': [(lambda g:g.inject(datetime.datetime.fromtimestamp(1690934400).astimezone(datetime.timezone.utc)).date_add(DT.second, 20))], 
    'g_injectXdatetimeXstrXX_dateAddXday_11X': [(lambda g:g.inject(datetime.datetime.fromtimestamp(1693958400).astimezone(datetime.timezone.utc)).date_add(DT.day, 11))], 
    'g_injectXdatetimeXstr1XX_dateDiffXdatetimeXstr2XX': [(lambda g:g.inject(datetime.datetime.fromtimestamp(1690934400).astimezone(datetime.timezone.utc)).date_diff(datetime.datetime.fromtimestamp(1691539200).astimezone(datetime.timezone.utc)))], 
    'g_injectXdatetimeXstr1XX_dateDiffXconstantXdatetimeXstr2XXX': [(lambda g:g.inject(datetime.datetime.fromtimestamp(1691452800).astimezone(datetime.timezone.utc)).date_diff(__.constant(datetime.datetime.fromtimestamp(1690848000).astimezone(datetime.timezone.utc))))], 
    'g_injectXdatetimeXstr1XX_dateDiffXinjectXdatetimeXstr2XXX': [(lambda g:g.inject(datetime.datetime.fromtimestamp(1691452800).astimezone(datetime.timezone.utc)).date_diff(__.inject(datetime.datetime.fromtimestamp(1696982400).astimezone(datetime.timezone.utc))))], 
    ...
    'g_mergeV_mergeE_combination_new_vertices': [(lambda g, xx1=None,xx2=None:g.merge_v(xx1).as_('outV').merge_v(xx2).as_('inV').merge_e({ Direction.OUT: Merge.out_v, Direction.IN: Merge.in_v, T.label: 'knows' }).option(Merge.out_v, __.select('outV')).option(Merge.in_v, __.select('inV'))), (lambda g, xx1=None,xx2=None:g.V()), (lambda g, xx1=None,xx2=None:g.E()), (lambda g, xx1=None,xx2=None:g.V().has('name', 'marko').out('knows').has('name', 'vadas'))], 
    'g_mergeV_mergeE_combination_existing_vertices': [(lambda g, xx1=None,xx2=None:g.add_v('person').property('name', 'marko').add_v('person').property('name', 'vadas')), (lambda g, xx1=None,xx2=None:g.merge_v(xx1).as_('outV').merge_v(xx2).as_('inV').merge_e({ Direction.OUT: Merge.out_v, Direction.IN: Merge.in_v, T.label: 'knows' }).option(Merge.out_v, __.select('outV')).option(Merge.in_v, __.select('inV'))), (lambda g, xx1=None,xx2=None:g.V()), (lambda g, xx1=None,xx2=None:g.E()), (lambda g, xx1=None,xx2=None:g.V().has('name', 'marko').out('knows').has('name', 'vadas'))], 
    'g_V_asXvX_mergeEXxx1X_optionXMerge_onMatch_xx2X_optionXMerge_outV_selectXvXX_optionXMerge_inV_selectXvXX': [(lambda g, xx1=None:g.add_v('person').property('name', 'marko').property('age', 29)), (lambda g, xx1=None:g.V().as_('v').merge_e({ T.label: 'self', Direction.OUT: Merge.out_v, Direction.IN: Merge.in_v }).option(Merge.on_match, xx1).option(Merge.out_v, __.select('v')).option(Merge.in_v, __.select('v')))], 
    ...
    'g_injectX1_1X_set': [(lambda g, xx1=None:g.inject({1, 1})), (lambda g, xx1=None:g.inject(xx1)), (lambda g, xx1=None:g.inject(xx1))], 
