...
world.gremlins = {
    ...
    'g_injectX1X_chooseXisX1X__constantX10Xfold__foldX': [(lambda g:g.inject(1).choose(__.is_(1), __.constant(10).fold(), __.fold()))], 
    'g_injectX2X_chooseXisX1X__constantX10Xfold__foldX': [(lambda g:g.inject(2).choose(__.is_(1), __.constant(10).fold(), __.fold()))], 
...
<<<<<<< HEAD
    'g_V_unionXconstantX1X_constantX2X_constantX3XX': [(lambda g, xx1=None,xx3=None,xx2=None,vid2=None:g.V(vid2).union(__.constant(xx1), __.constant(xx2), __.constant(xx3)))], 
=======
    'g_V_unionXconstantX1X_constantX2X_constantX3XX': [(lambda g, v2=None:g.V(v2).union(__.constant(1), __.constant(2), __.constant(3)))], 
>>>>>>> 9b2ecfc86b (Squash of WIP GValue commits)
...
>>>>>>> 9b2ecfc86b (Squash of WIP GValue commits)
    ...
    'g_injectXa_null_bX_disjunctXa_cX': [(lambda g, xx1=None:g.inject(xx1).disjunct(['a', 'c']))], 
    'g_injectXa_null_bX_disjunctXa_null_cX': [(lambda g, xx1=None:g.inject(xx1).disjunct(['a', None, 'c']))], 
    'g_injectX3_threeX_disjunctXfive_three_7X': [(lambda g, xx1=None:g.inject(xx1).disjunct(['five', 'three', 7]))], 
    'g_E': [(lambda g:g.E())], 
...
>>>>>>> 9b2ecfc86b (Squash of WIP GValue commits)
    ...
    'g_injectXa_null_bX_productXa_cX_unfold': [(lambda g, xx1=None:g.inject(xx1).product(['a', 'c']).unfold())], 
    'g_injectXa_null_bX_productXa_null_cX_unfold': [(lambda g, xx1=None:g.inject(xx1).product(['a', None, 'c']).unfold())], 
    'g_injectX3_threeX_productXfive_three_7X_unfold': [(lambda g, xx1=None:g.inject(xx1).product(['five', 'three', 7]).unfold())], 
    ...
    'g_withSideEffectXa_setX_V_both_name_aggregateXlocal_aX_capXaX': [(lambda g:g.with_side_effect('a', set()).V().both().values('name').aggregate(Scope.local, 'a').cap('a'))], 
    ...
    'g_withSideEffectXa_setX_V_both_name_storeXaX_capXaX': [(lambda g:g.with_side_effect('a', set()).V().both().values('name').store('a').cap('a'))], 
