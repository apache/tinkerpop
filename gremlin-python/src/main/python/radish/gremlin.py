...
world.gremlins = {
    ...
    'g_VX3X_repeatXout_order_byXperformancesX_limitX5X_tailX1XX_timesX2X_valuesXnameX': [(lambda g, vid3=None:g.V(vid3).repeat(__.out().order().by('performances').limit(5).tail(1)).times(2).values('name'))], 
    ...
    'g_injectX42X_asNumberXGType_SHORTX_isXtypeOfXGType_SHORTXX_storeXaX_capXaX': [(lambda g:g.inject(42).as_number(GType.SHORT).is_(P.type_of(GType.SHORT)).store('a').cap('a'))], 
    ...
    'g_withSideEffectXa_setX_V_both_name_aggregateXlocal_aX_capXaX': [(lambda g:g.V().both().values('name').aggregate(Scope.local, 'a').cap('a'))], 
    ...
    'g_withSideEffectXa_1_2_3_addAllX_V_aggregateXlocal_aX_byXageX_capXaX': [(lambda g:g.with_side_effect('a', [1, 2, 3], Operator.add_all).V().aggregate(Scope.local, 'a').by('age').cap('a'))], 
    ...
    'g_withSideEffectXa_1_2_3_assignX_V_order_byXageX_aggregateXlocal_aX_byXageX_capXaX': [(lambda g:g.with_side_effect('a', [1, 2, 3], Operator.assign).V().order().by('age').aggregate(Scope.local, 'a').by('age').cap('a'))], 
    ...
    'g_withSideEffectXx_setX_V_both_both_sideEffectXstoreXxX_byXnameXX_capXxX_unfold': [(lambda g:g.with_side_effect('x', set()).V().both().both().side_effect(__.store('x').by('name')).cap('x').unfold())], 
    ...
    'g_withSideEffectXa_setX_V_both_name_storeXaX_capXaX': [(lambda g:g.V().both().values('name').store('a').cap('a'))], 
