...
world.gremlins = {
    ...
    'g_VXnameXJAMXX_repeatXoutXfollowedByX_limitX2XX_timesX2X': [(lambda g:g.V().has('name', 'JAM').repeat(__.out('followedBy').limit(2)).times(2))], 
    'g_VXnameXJAMXX_outXfollowedByX_limitX2X_outXfollowedByX_limitX2X': [(lambda g:g.V().has('name', 'JAM').out('followedBy').limit(2).out('followedBy').limit(2))], 
    'g_VXnameXDRUMSXX_repeatXinXfollowedByX_rangeX1_4XX_timesX2X': [(lambda g:g.V().has('name', 'DRUMS').repeat(__.in_('followedBy').range_(1, 4)).times(2))], 
    'g_VXnameXDRUMSXX_inXfollowedByX_rangeX1_4X_inXfollowedByX_rangeX1_4X': [(lambda g:g.V().has('name', 'DRUMS').in_('followedBy').range_(1, 4).in_('followedBy').range_(1, 4))], 
