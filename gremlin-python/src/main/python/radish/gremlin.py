...
world.gremlins = {
    ...
    'g_injectX1_2_3_4_0x5X_asNumber_sum_asNumberXbyteX': [(lambda g, xx1=None,xx3=None,xx2=None:g.inject(xx1, xx2, xx3, '4', '0x5').as_number().sum_().as_number(N.byte))], 
    ...
    'g_withSideEffectXx_100X_V_age_mathX__plus_xX_asNumberXlongX': [(lambda g, xx1=None:g.with_side_effect('x', xx1).V().values('age').math('_ + x').as_number(N.long))], 
