...
world.gremlins = {
    ...
    'g_V_repeatXout_whereXhasXnameX_order_limitX1XXX_timesX2X': [(lambda g:g.V().repeat(__.out().where(__.has('name').order().limit(1))).times(2))], 
    'g_V_out_whereXhasXnameX_order_limitX1XX_out_whereXhasXnameX_order_limitX1XX': [(lambda g:g.V().out().where(__.has('name').order().limit(1)).out().where(__.has('name').order().limit(1)))], 
    'g_V_hasXnameXJAMXX_repeatXoutXfollowedByX_order_limitX2XX_timesX2X': [(lambda g:g.V().has('name', 'JAM').repeat(__.out('followedBy').order().limit(2)).times(2))], 
    'g_V_hasXnameXJAMXX_outXfollowedByX_order_limitX2X_outXfollowedByX_order_limitX2X': [(lambda g:g.V().has('name', 'JAM').out('followedBy').order().limit(2).out('followedBy').order().limit(2))], 
    'g_V_hasXnameXDRUMSXX_repeatXinXfollowedByX_order_rangeX1_4XX_timesX2X': [(lambda g:g.V().has('name', 'DRUMS').repeat(__.in_('followedBy').order().range_(1, 4)).times(2))], 
    'g_V_hasXnameXDRUMSXX_inXfollowedByX_order_rangeX1_4X_inXfollowedByX_order_rangeX1_4X': [(lambda g:g.V().has('name', 'DRUMS').in_('followedBy').order().range_(1, 4).in_('followedBy').order().range_(1, 4))], 
    'g_V_chooseXvaluesXageX_isXlteX30XX_out_order_limitX1X_out_order_limitX2XX': [(lambda g:g.V().choose(__.values('age').is_(P.lte(30)), __.out().order().limit(1), __.out().order().limit(2)))], 
    'g_V_chooseXvaluesXageX_isXlteX30XX_localXout_order_limitX1XX_localXout_order_limitX2XXX': [(lambda g:g.V().choose(__.values('age').is_(P.lte(30)), __.local(__.out().order().limit(1)), __.local(__.out().order().limit(2))))], 
    'g_V_hasXnameXHEY_BO_DIDDLEYXX_unionXoutXfollowedByX_order_limitX2X_outXsungByX_order_limitX1XX_unionXoutXfollowedByX_order_limitX2X_outXsungByX_order_limitX1XX': [(lambda g:g.V().has('name', 'HEY BO DIDDLEY').union(__.out('followedBy').order().limit(2), __.out('sungBy').order().limit(1)).union(__.out('followedBy').order().limit(2), __.out('sungBy').order().limit(1)))], 
    'g_V_hasXnameXHEY_BO_DIDDLEYXX_repeatXunionXoutXfollowedByX_order_limitX2X_outXsungByX_order_limitX1XXX_timesX2X': [(lambda g:g.V().has('name', 'HEY BO DIDDLEY').repeat(__.union(__.out('followedBy').order().limit(2), __.out('sungBy').order().limit(1))).times(2))], 
