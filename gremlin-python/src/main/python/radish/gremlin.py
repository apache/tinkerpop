...
world.gremlins = {
    ...
    'g_withoutStrategiesXRepeatUnrollStrategyX_VX5X_repeatXlimitX1X_inX_timesX2X_valuesXnameX': [(lambda g, vid5=None:g.without_strategies(*[GremlinType('org.apache.tinkerpop.gremlin.process.traversal.strategy.optimization.RepeatUnrollStrategy')]).V(vid5).repeat(__.limit(1).in_()).times(2).values('name'))], 
    'g_withoutStrategiesXRepeatUnrollStrategyX_VX5X_repeatXlimitX1X_inX_untilXloopsXisX2XXX_valuesXnameX': [(lambda g, vid5=None:g.without_strategies(*[GremlinType('org.apache.tinkerpop.gremlin.process.traversal.strategy.optimization.RepeatUnrollStrategy')]).V(vid5).repeat(__.limit(1).in_()).until(__.loops().is_(2)).values('name'))], 
    'g_withoutStrategiesXRepeatUnrollStrategyX_VX5X_limitX1X_in_limitX1X_in_valuesXnameX': [(lambda g, vid5=None:g.without_strategies(*[GremlinType('org.apache.tinkerpop.gremlin.process.traversal.strategy.optimization.RepeatUnrollStrategy')]).V(vid5).limit(1).in_().limit(1).in_().values('name'))], 
    'g_withoutStrategiesXRepeatUnrollStrategyX_VX5X_repeatXlimitX1X_inX_timesX1X_repeatXlimitX1X_inX_timesX1X_valuesXnameX': [(lambda g, vid5=None:g.without_strategies(*[GremlinType('org.apache.tinkerpop.gremlin.process.traversal.strategy.optimization.RepeatUnrollStrategy')]).V(vid5).repeat(__.limit(1).in_()).times(1).repeat(__.limit(1).in_()).times(1).values('name'))], 
    'g_withoutStrategiesXRepeatUnrollStrategyX_VX5X_repeatXlimitX1X_in_aggregateXxXX_timesX2X_capXxX': [(lambda g, vid5=None:g.without_strategies(*[GremlinType('org.apache.tinkerpop.gremlin.process.traversal.strategy.optimization.RepeatUnrollStrategy')]).V(vid5).repeat(__.limit(1).in_().aggregate('x')).times(2).cap('x'))], 
    'g_withoutStrategiesXRepeatUnrollStrategyX_VX5X_repeatXrangeX0_1X_inX_timesX2X_valuesXnameX': [(lambda g, vid5=None:g.without_strategies(*[GremlinType('org.apache.tinkerpop.gremlin.process.traversal.strategy.optimization.RepeatUnrollStrategy')]).V(vid5).repeat(__.range_(0, 1).in_()).times(2).values('name'))], 
    'g_withoutStrategiesXRepeatUnrollStrategyX_VX5X_repeatXrangeX0_1X_inX_untilXloopsXisX2XXX_valuesXnameX': [(lambda g, vid5=None:g.without_strategies(*[GremlinType('org.apache.tinkerpop.gremlin.process.traversal.strategy.optimization.RepeatUnrollStrategy')]).V(vid5).repeat(__.range_(0, 1).in_()).until(__.loops().is_(2)).values('name'))], 
    'g_withoutStrategiesXRepeatUnrollStrategyX_VX5X_rangeX0_1X_in_rangeX0_1X_in_valuesXnameX': [(lambda g, vid5=None:g.without_strategies(*[GremlinType('org.apache.tinkerpop.gremlin.process.traversal.strategy.optimization.RepeatUnrollStrategy')]).V(vid5).range_(0, 1).in_().range_(0, 1).in_().values('name'))], 
    'g_withoutStrategiesXRepeatUnrollStrategyX_VX5X_repeatXrangeX0_1X_in_repeatXrangeX0_1X_inX_timesX1XX_timesX1X_valuesXnameX': [(lambda g, vid5=None:g.without_strategies(*[GremlinType('org.apache.tinkerpop.gremlin.process.traversal.strategy.optimization.RepeatUnrollStrategy')]).V(vid5).repeat(__.range_(0, 1).in_().repeat(__.range_(0, 1).in_()).times(1)).times(1).values('name'))], 
    'g_withoutStrategiesXRepeatUnrollStrategyX_VX5X_repeatXrangeX0_1X_in_aggregateXxXX_timesX2X_capXxX': [(lambda g, vid5=None:g.without_strategies(*[GremlinType('org.apache.tinkerpop.gremlin.process.traversal.strategy.optimization.RepeatUnrollStrategy')]).V(vid5).repeat(__.range_(0, 1).in_().aggregate('x')).times(2).cap('x'))], 
    'g_withoutStrategiesXRepeatUnrollStrategyX_VXnameXJAMXX_repeatXoutXfollowedByX_limitX2XX_timesX2X': [(lambda g:g.without_strategies(*[GremlinType('org.apache.tinkerpop.gremlin.process.traversal.strategy.optimization.RepeatUnrollStrategy')]).V().has('name', 'JAM').repeat(__.out('followedBy').limit(2)).times(2))], 
    'g_withoutStrategiesXRepeatUnrollStrategyX_VXnameXJAMXX_outXfollowedByX_limitX2X_outXfollowedByX_limitX2X': [(lambda g:g.without_strategies(*[GremlinType('org.apache.tinkerpop.gremlin.process.traversal.strategy.optimization.RepeatUnrollStrategy')]).V().has('name', 'JAM').out('followedBy').limit(2).out('followedBy').limit(2))], 
    'g_withoutStrategiesXRepeatUnrollStrategyX_VXnameXDRUMSXX_repeatXinXfollowedByX_rangeX1_4XX_timesX2X': [(lambda g:g.without_strategies(*[GremlinType('org.apache.tinkerpop.gremlin.process.traversal.strategy.optimization.RepeatUnrollStrategy')]).V().has('name', 'DRUMS').repeat(__.in_('followedBy').range_(1, 4)).times(2))], 
    'g_withoutStrategiesXRepeatUnrollStrategyX_VXnameXDRUMSXX_inXfollowedByX_rangeX1_4X_inXfollowedByX_rangeX1_4X': [(lambda g:g.without_strategies(*[GremlinType('org.apache.tinkerpop.gremlin.process.traversal.strategy.optimization.RepeatUnrollStrategy')]).V().has('name', 'DRUMS').in_('followedBy').range_(1, 4).in_('followedBy').range_(1, 4))], 
