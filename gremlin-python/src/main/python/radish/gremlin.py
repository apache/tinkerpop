...
world.gremlins = {
    ...
    'g_callXlistX_withXstring_stringX': [(lambda g:g.call('--list').with_('service', 'tinker.search.text'))], 
    'g_callXlistX_withXstring_traversalX': [(lambda g:g.call('--list').with_('service', __.constant('tinker.search.text')))], 
    'g_callXlist_mapX': [(lambda g, xx1=None:g.call('--list', xx1))], 
    'g_callXlist_traversalX': [(lambda g:g.call('--list', __.project('service').by(__.constant('tinker.search.text'))))], 
    'g_callXlist_map_traversalX': [(lambda g, xx1=None:g.call('--list', xx1, __.project('service').by(__.constant('tinker.search.text'))))], 
    'g_callXsearch_mapX': [(lambda g, xx1=None:g.call('tinker.search.text', xx1).element())], 
    'g_callXsearch_traversalX': [(lambda g:g.call('tinker.search.text', __.project('search').by(__.constant('vada'))).element())], 
    'g_callXsearchX_withXstring_stringX': [(lambda g:g.call('tinker.search.text').with_('search', 'vada').element())], 
    'g_callXsearchX_withXstring_traversalX': [(lambda g:g.call('tinker.search.text').with_('search', __.constant('vada')).element())], 
    'g_callXsearch_mapX_withXstring_VertexX': [(lambda g, xx1=None:g.call('tinker.search.text', xx1).with_('type', 'Vertex').element())], 
    'g_callXsearch_mapX_withXstring_EdgeX': [(lambda g, xx1=None:g.call('tinker.search.text', xx1).with_('type', 'Edge').element())], 
    'g_callXsearch_mapX_withXstring_VertexPropertyX': [(lambda g, xx1=None:g.call('tinker.search.text', xx1).with_('type', 'VertexProperty').element())], 
