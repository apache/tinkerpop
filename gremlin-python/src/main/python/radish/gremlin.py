...
world.gremlins = {
    ...
    'g_V_valuesXageX_isXtypeOfXGType_VPXX': [(lambda g:g.V().values('age').is_(P.type_of(GType.VP)))], 
    ...
    'g_V_valuesXageX_isXtypeOfXinvalid_type_NameXX': [(lambda g:g.V().values('age').is_(P.type_of('invalid.type.Name')))], 
    ...
    'g_E_orXisXtypeOfXGType_EDGEXX__isXtypeOfXGType_VERTEXXX_count': [(lambda g:g.E().or_(__.is_(P.type_of(GType.EDGE)), __.is_(P.type_of(GType.VERTEX))).count())], 
    ...
    'g_V_whereXisXtypeOfXGType_VERTEXXX_andXhasXnameXXX_valuesXnameX': [(lambda g:g.V().where(__.is_(P.type_of(GType.VERTEX)).and_(__.has('name'))).values('name'))], 
    'g_E_whereXisXtypeOfXGType_EDGEXXX_count': [(lambda g:g.E().where(__.is_(P.type_of(GType.EDGE))).count())], 
    'g_V_whereXpropertiesXnameX_isXtypeOfXGType_PROPERTYXXX_valuesXnameX': [(lambda g:g.V().where(__.properties('name').is_(P.type_of(GType.PROPERTY))).values('name'))], 
