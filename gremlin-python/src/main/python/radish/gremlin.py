...
world.gremlins = {
    ...
    'g_withSideEffectXa_g_VX2XX_VX1X_out_whereXneqXaXX': [(lambda g, vid2=None,vid1=None:g.with_side_effect('a', vid2).V(vid1).out().where(__.id_().where(P.neq('a'))))], 
    ...
    'g_withSideEffectXb_bX_VXaX_addEXknowsX_toXbX_propertyXweight_0_5X': [(lambda g, vid6=None,vid1=None:g.add_v('person').property('name', 'marko').property('age', 29).as_('marko').add_v('person').property('name', 'vadas').property('age', 27).as_('vadas').add_v('software').property('name', 'lop').property('lang', 'java').as_('lop').add_v('person').property('name', 'josh').property('age', 32).as_('josh').add_v('software').property('name', 'ripple').property('lang', 'java').as_('ripple').add_v('person').property('name', 'peter').property('age', 35).as_('peter').add_e('knows').from_('marko').to('vadas').property('weight', 0.5).add_e('knows').from_('marko').to('josh').property('weight', 1.0).add_e('created').from_('marko').to('lop').property('weight', 0.4).add_e('created').from_('josh').to('ripple').property('weight', 1.0).add_e('created').from_('josh').to('lop').property('weight', 0.4).add_e('created').from_('peter').to('lop').property('weight', 0.2)), (lambda g, vid6=None,vid1=None:g.with_side_effect('b', vid6).V(vid1).add_e('knows').to('b').property('weight', 0.5)), (lambda g, vid6=None,vid1=None:g.E()), (lambda g, vid6=None,vid1=None:g.V(vid1).both_e()), (lambda g, vid6=None,vid1=None:g.V(vid1).in_e('knows')), (lambda g, vid6=None,vid1=None:g.V(vid1).out_e('knows')), (lambda g, vid6=None,vid1=None:g.V(vid1).both_e('knows').has('weight', 0.5)), (lambda g, vid6=None,vid1=None:g.V(vid6).both_e()), (lambda g, vid6=None,vid1=None:g.V(vid6).in_e('knows')), (lambda g, vid6=None,vid1=None:g.V(vid6).out_e('knows')), (lambda g, vid6=None,vid1=None:g.V(vid6).both_e('knows').has('weight', 0.5))], 
    ...
    'g_injectXlist1_list2X_mergeEXlimitXlocal_1X_unfoldX_optionXonCreate_rangeXlocal_1_2X_unfoldX_optionXonMatch_tailXlocalX_unfoldX_to_match': [(lambda g, xx1=None,xx2=None:g.add_v('person').property('name', 'marko').property('age', 29).as_('marko').add_v('person').property('name', 'vadas').property('age', 27).as_('vadas').add_v('software').property('name', 'lop').property('lang', 'java').as_('lop').add_v('person').property('name', 'josh').property('age', 32).as_('josh').add_v('software').property('name', 'ripple').property('lang', 'java').as_('ripple').add_v('person').property('name', 'peter').property('age', 35).as_('peter').add_e('knows').from_('marko').to('vadas').property('weight', 0.5).add_e('knows').from_('marko').to('josh').property('weight', 1.0).add_e('created').from_('marko').to('lop').property('weight', 0.4).add_e('created').from_('josh').to('ripple').property('weight', 1.0).add_e('created').from_('josh').to('lop').property('weight', 0.4).add_e('created').from_('peter').to('lop').property('weight', 0.2)), (lambda g, xx1=None,xx2=None:g.inject(xx1, xx1, xx2).fold().merge_e(__.limit(Scope.local, 1).unfold()).option(Merge.on_create, __.range_(Scope.local, 1, 2).unfold()).option(Merge.on_match, __.tail(Scope.local).unfold())), (lambda g, xx1=None,xx2=None:g.V()), (lambda g, xx1=None,xx2=None:g.E()), (lambda g, xx1=None,xx2=None:g.E().has('created', 'N')), (lambda g, xx1=None,xx2=None:g.V().has('person', 'name', 'marko').out_e('knows').has('created', 'N').in_v().has('person', 'name', 'vadas'))], 
    'g_injectXlist1_list2X_mergeEXlimitXlocal_1X_unfoldX_optionXonCreate_rangeXlocal_1_2X_unfoldX_optionXonMatch_tailXlocalX_unfoldX_to_create': [(lambda g, xx1=None,xx2=None:g.add_v('person').property('name', 'marko').property('age', 29).as_('marko').add_v('person').property('name', 'vadas').property('age', 27).as_('vadas').add_v('software').property('name', 'lop').property('lang', 'java').as_('lop').add_v('person').property('name', 'josh').property('age', 32).as_('josh').add_v('software').property('name', 'ripple').property('lang', 'java').as_('ripple').add_v('person').property('name', 'peter').property('age', 35).as_('peter').add_e('knows').from_('marko').to('vadas').property('weight', 0.5).add_e('knows').from_('marko').to('josh').property('weight', 1.0).add_e('created').from_('marko').to('lop').property('weight', 0.4).add_e('created').from_('josh').to('ripple').property('weight', 1.0).add_e('created').from_('josh').to('lop').property('weight', 0.4).add_e('created').from_('peter').to('lop').property('weight', 0.2)), (lambda g, xx1=None,xx2=None:g.inject(xx1, xx1, xx2).fold().merge_e(__.limit(Scope.local, 1).unfold()).option(Merge.on_create, __.range_(Scope.local, 1, 2).unfold()).option(Merge.on_match, __.tail(Scope.local).unfold())), (lambda g, xx1=None,xx2=None:g.V()), (lambda g, xx1=None,xx2=None:g.E()), (lambda g, xx1=None,xx2=None:g.E().has_not('created')), (lambda g, xx1=None,xx2=None:g.V().has('person', 'name', 'marko').out_e('knows').has_not('created').in_v().has('person', 'name', 'vadas')), (lambda g, xx1=None,xx2=None:g.V().has('person', 'name', 'vadas').out_e('self').has_not('weight').in_v().has('person', 'name', 'vadas'))], 
    ...
    'g_injectXlist1_list2X_mergeVXlimitXlocal_1X_unfoldX_optionXonCreate_rangeXlocal_1_2X_unfoldX_optionXonMatch_tailXlocalX_unfoldX_to_match': [(lambda g, xx1=None,xx2=None:g.add_v('person').property('name', 'marko').property('age', 29)), (lambda g, xx1=None,xx2=None:g.inject(xx1, xx1, xx2).fold().merge_v(__.limit(Scope.local, 1).unfold()).option(Merge.on_create, __.range_(Scope.local, 1, 2).unfold()).option(Merge.on_match, __.tail(Scope.local).unfold())), (lambda g, xx1=None,xx2=None:g.V().has('person', 'name', 'marko').has('created', 'N')), (lambda g, xx1=None,xx2=None:g.V())], 
    'g_injectXlist1_list2X_mergeVXlimitXlocal_1X_unfoldX_optionXonCreate_rangeXlocal_1_2X_unfoldX_optionXonMatch_tailXlocalX_unfoldX_to_create': [(lambda g, xx1=None,xx2=None:g.add_v('person').property('name', 'marko').property('age', 29)), (lambda g, xx1=None,xx2=None:g.inject(xx1, xx1, xx2).fold().merge_v(__.limit(Scope.local, 1).unfold()).option(Merge.on_create, __.range_(Scope.local, 1, 2).unfold()).option(Merge.on_match, __.tail(Scope.local).unfold())), (lambda g, xx1=None,xx2=None:g.V().has('person', 'name', 'stephen').has_not('created')), (lambda g, xx1=None,xx2=None:g.V())], 
