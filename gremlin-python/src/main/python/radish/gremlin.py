...
world.gremlins = {
    ...
    'g_withoutStrategiesXRepeatUnrollStrategyX_V_repeatXboth_aggregateXxXX_timesX2X_limitX5X': [(lambda g:g.without_strategies(RepeatUnrollStrategy).V().order().repeat(__.both().order().aggregate('x')).times(2).limit(5))], 
