...
world.gremlins = {
    ...
    'g_V_chooseXTlabelX_optionXblah__outXknowsXX_optionXbleep__outXcreatedXX_name': [(lambda g:g.V().choose(T.label).option('blah', __.out('knows')).option('bleep', __.out('created')).values('name'))], 
    ...
    'g_V_chooseXageX_optionXbetweenX26_30X_nameX': [(lambda g:g.V().choose(__.values('age')).option(P.between(26, 30), __.values('name')))], 
