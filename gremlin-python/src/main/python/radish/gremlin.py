...
world.gremlins = {
    ...
    'g_V_chooseXout_countX_optionX2L_nameX_optionX3L_ageX_optionXnone_noneX': [(lambda g, xx1=None,xx2=None:g.V().choose(__.out().count()).option(xx1, __.values('name')).option(xx2, __.values('age')).option(Pick.none, __.none()))], 
    ...
    'g_V_chooseXTlabelX_optionXblah__outXknowsXX_optionXbleep__outXcreatedXX_name': [(lambda g:g.V().choose(T.label).option('blah', __.out('knows')).option('bleep', __.out('created')).option(Pick.none, __.none()).values('name'))], 
    ...
    'g_V_chooseXageX_optionXbetweenX26_30X_nameX': [(lambda g:g.V().choose(__.values('age')).option(P.between(26, 30), __.values('name')).option(Pick.none, __.none()))], 
    ...
    'g_V_hasLabelXpersonX_age_chooseXP_eqX29X__valuesXnameX__constantXotherXX': [(lambda g:g.V().has_label('person').values('age').choose(P.eq(29), __.constant('matched'), __.constant('other')))], 
    'g_V_hasLabelXpersonX_age_chooseXP_eqX29X__valuesXnameXX': [(lambda g:g.V().has_label('person').values('age').choose(P.eq(29), __.constant('matched')))], 
