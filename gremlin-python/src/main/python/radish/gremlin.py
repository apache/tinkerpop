...
world.gremlins = {
    ...
    'g_injectX1_2_3_4_0x5X_asNumber_sum_asNumberXnbyteX': [(lambda g, xx1=None,xx3=None,xx2=None:g.inject(xx1, xx2, xx3, '4', '0x5').as_number().sum_().as_number(N.nbyte))], 
    'g_VX1X_asNumberXN_nintX': [(lambda g:g.inject(None).as_number(N.nint))], 
    'g_V_asXaX_outXknowsX_asXbX_mathXa_plus_bX_byXageX_asNumberXnintX': [(lambda g:g.V().as_('a').out('knows').as_('b').math('a + b').by('age').as_number(N.nint))], 
    'g_withSideEffectXx_100X_V_age_mathX__plus_xX_asNumberXnlongX': [(lambda g, xx1=None:g.with_side_effect('x', xx1).V().values('age').math('_ + x').as_number(N.nlong))], 
