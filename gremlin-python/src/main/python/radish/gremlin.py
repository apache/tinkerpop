...
world.gremlins = {
    ...
    'g_V_hasXnameXDRUMSXX_repeatXinXfollowedByX_rangeX1_4XX_timesX2X': [(lambda g:g.V().has('name', 'DRUMS').repeat(__.in_('followedBy').range_(1, 4)).times(2))], 
    'g_V_hasXnameXDRUMSXX_inXfollowedByX_rangeX1_4X_inXfollowedByX_rangeX1_4X': [(lambda g:g.V().has('name', 'DRUMS').in_('followedBy').range_(1, 4).in_('followedBy').range_(1, 4))], 
    'g_V_chooseXvaluesXageX_isXlteX30XX_outX_limitX1X_outX_limitX2XX': [(lambda g:g.V().choose(__.values('age').is_(P.lte(30)), __.out().limit(1), __.out().limit(2)))], 
    'g_V_chooseXvaluesXageX_isXlteX30XX_localXoutX_limitX1XX_localXoutX_limitX2XXX': [(lambda g:g.V().choose(__.values('age').is_(P.lte(30)), __.local(__.out().limit(1)), __.local(__.out().limit(2))))], 
    'g_V_hasXnameXHEY_BO_DIDDLEYXX_unionXoutXfollowedByX_limitX2X_outXsungByX_limitX1XX_unionXoutXfollowedByX_limitX2X_outXsungByX_limitX1XX': [(lambda g:g.V().has('name', 'HEY BO DIDDLEY').union(__.out('followedBy').limit(2), __.out('sungBy').limit(1)).union(__.out('followedBy').limit(2), __.out('sungBy').limit(1)))], 
    'g_V_hasXnameXHEY_BO_DIDDLEYXX_repeatXunionXoutXfollowedByX_limitX2X_outXsungByX_limitX1XXX_timesX2X': [(lambda g:g.V().has('name', 'HEY BO DIDDLEY').repeat(__.union(__.out('followedBy').limit(2), __.out('sungBy').limit(1))).times(2))], 
