...
world.gremlins = {
    ...
    'g_unionXselectXmX_selectXmX_constantXcreated_NXX_fold_mergeEXlimitXlocal_1X_unfoldX_optionXonCreate_rangeXlocal_1_2X_unfoldX_optionXonMatch_tailXlocalX_unfoldX_to_match': [(lambda g:g.add_v('person').property('name', 'marko').property('age', 29).as_('marko').add_v('person').property('name', 'vadas').property('age', 27).as_('vadas').add_v('software').property('name', 'lop').property('lang', 'java').as_('lop').add_v('person').property('name', 'josh').property('age', 32).as_('josh').add_v('software').property('name', 'ripple').property('lang', 'java').as_('ripple').add_v('person').property('name', 'peter').property('age', 35).as_('peter').add_e('knows').from_('marko').to('vadas').property('weight', 0.5).add_e('knows').from_('marko').to('josh').property('weight', 1.0).add_e('created').from_('marko').to('lop').property('weight', 0.4).add_e('created').from_('josh').to('ripple').property('weight', 1.0).add_e('created').from_('josh').to('lop').property('weight', 0.4).add_e('created').from_('peter').to('lop').property('weight', 0.2)), (lambda g:g.union(__.select('m'), __.select('m'), __.constant({ 'created': 'N' })).fold().merge_e(__.limit(Scope.local, 1).unfold()).option(Merge.on_create, __.range_(Scope.local, 1, 2).unfold()).option(Merge.on_match, __.tail(Scope.local).unfold())), (lambda g:g.V()), (lambda g:g.E()), (lambda g:g.E().has('created', 'N')), (lambda g:g.V().has('person', 'name', 'marko').out_e('knows').has('created', 'N').in_v().has('person', 'name', 'vadas'))], 
    'g_unionXselectXmX_selectXmX_constantXcreated_NXX_fold_mergeEXlimitXlocal_1X_unfoldX_optionXonCreate_rangeXlocal_1_2X_unfoldX_optionXonMatch_tailXlocalX_unfoldX_to_create': [(lambda g:g.add_v('person').property('name', 'marko').property('age', 29).as_('marko').add_v('person').property('name', 'vadas').property('age', 27).as_('vadas').add_v('software').property('name', 'lop').property('lang', 'java').as_('lop').add_v('person').property('name', 'josh').property('age', 32).as_('josh').add_v('software').property('name', 'ripple').property('lang', 'java').as_('ripple').add_v('person').property('name', 'peter').property('age', 35).as_('peter').add_e('knows').from_('marko').to('vadas').property('weight', 0.5).add_e('knows').from_('marko').to('josh').property('weight', 1.0).add_e('created').from_('marko').to('lop').property('weight', 0.4).add_e('created').from_('josh').to('ripple').property('weight', 1.0).add_e('created').from_('josh').to('lop').property('weight', 0.4).add_e('created').from_('peter').to('lop').property('weight', 0.2)), (lambda g:g.union(__.select('m'), __.select('m'), __.constant({ 'created': 'N' })).fold().merge_e(__.limit(Scope.local, 1).unfold()).option(Merge.on_create, __.range_(Scope.local, 1, 2).unfold()).option(Merge.on_match, __.tail(Scope.local).unfold())), (lambda g:g.V()), (lambda g:g.E()), (lambda g:g.E().has_not('created')), (lambda g:g.V().has('person', 'name', 'marko').out_e('knows').has_not('created').in_v().has('person', 'name', 'vadas')), (lambda g:g.V().has('person', 'name', 'vadas').out_e('self').has_not('weight').in_v().has('person', 'name', 'vadas'))], 
    ...
    'g_injectXlist1_list2X_mergeVXlimitXlocal_1X_unfoldX_optionXonCreate_rangeXlocal_1_2X_unfoldX_optionXonMatch_tailXlocalX_unfoldX_to_match': [(lambda g:g.add_v('person').property('name', 'marko').property('age', 29)), (lambda g:g.inject({ T.label: 'person', 'name': 'marko' }, { T.label: 'person', 'name': 'marko' }, { 'created': 'N' }).fold().merge_v(__.limit(Scope.local, 1).unfold()).option(Merge.on_create, __.range_(Scope.local, 1, 2).unfold()).option(Merge.on_match, __.tail(Scope.local).unfold())), (lambda g:g.V().has('person', 'name', 'marko').has('created', 'N')), (lambda g:g.V())], 
    'g_injectXlist1_list2X_mergeVXlimitXlocal_1X_unfoldX_optionXonCreate_rangeXlocal_1_2X_unfoldX_optionXonMatch_tailXlocalX_unfoldX_to_create': [(lambda g:g.add_v('person').property('name', 'marko').property('age', 29)), (lambda g:g.inject({ T.label: 'person', 'name': 'stephen' }, { T.label: 'person', 'name': 'stephen' }, { 'created': 'N' }).fold().merge_v(__.limit(Scope.local, 1).unfold()).option(Merge.on_create, __.range_(Scope.local, 1, 2).unfold()).option(Merge.on_match, __.tail(Scope.local).unfold())), (lambda g:g.V().has('person', 'name', 'stephen').has_not('created')), (lambda g:g.V())], 
