...
import com.apache.tinkerpop.gremlin.tinkergraph.process.computer.TinkerGraphComputer;
import com.apache.tinkerpop.gremlin.tinkergraph.process.computer.TinkerGraphView;
import com.apache.tinkerpop.gremlin.tinkergraph.process.graph.traversal.strategy.TinkerElementStepStrategy;
import com.apache.tinkerpop.gremlin.tinkergraph.process.graph.traversal.strategy.TinkerGraphStepStrategy;
...
public class TinkerGraph implements Graph, Graph.Iterators {
    ...
    /**
     * An empty private constructor that initializes {@link TinkerGraph} with no {@link com.apache.tinkerpop.gremlin.structure.strategy.GraphStrategy}.  Primarily
     ...
     * <p/>
     * <b>Reference Implementation Help:</b> If a {@link com.apache.tinkerpop.gremlin.structure.Graph } implementation does not require a
     ...
     * {@link com.apache.tinkerpop.gremlin.structure.util.GraphFactory} to instantiate
     * {@link com.apache.tinkerpop.gremlin.structure.Graph} instances.  This method must be overridden for the Blueprint Test
     ...
     * by way of {@link com.apache.tinkerpop.gremlin.structure.util.GraphFactory}. As such, the exceptions get generalized
     * behind that facade and since {@link com.apache.tinkerpop.gremlin.structure.util.GraphFactory} is the preferred method
     * to opening graphs it will be consistent at that level.
     *
     * @param configuration the configuration for the instance
     * @return a newly opened {@link com.apache.tinkerpop.gremlin.structure.Graph}
     */
