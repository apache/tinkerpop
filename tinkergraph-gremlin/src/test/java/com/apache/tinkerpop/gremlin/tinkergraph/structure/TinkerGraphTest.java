...
import com.apache.tinkerpop.gremlin.process.graph.traversal.strategy.RangeByIsCountStrategy;
...
public class TinkerGraphTest {
    ...
    public void shouldWriteGratefulDead() throws IOException {
        ...
        try (final InputStream stream = AbstractGremlinTest.class.getResourceAsStream("/com/apache/tinkerpop/gremlin/structure/io/kryo/grateful-dead.gio")) {
        ...
        try (final InputStream stream = AbstractGremlinTest.class.getResourceAsStream("/com/apache/tinkerpop/gremlin/structure/io/graphson/grateful-dead.json")) {
            reader.readGraph(stream, g);
        }
        */
