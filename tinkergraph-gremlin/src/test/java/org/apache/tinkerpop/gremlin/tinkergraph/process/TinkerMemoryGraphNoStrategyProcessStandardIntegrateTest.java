...
@GraphProviderClass(provider = TinkerMemoryGraphNoStrategyProvider.class, graph = TinkerMemoryGraph.class)
public class TinkerMemoryGraphNoStrategyProcessStandardIntegrateTest {
}
