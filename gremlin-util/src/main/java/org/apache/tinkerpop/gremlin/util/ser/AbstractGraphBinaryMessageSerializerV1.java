...
public abstract class AbstractGraphBinaryMessageSerializerV1 extends AbstractMessageSerializer<GraphBinaryMapper> implements MessageTextSerializer<GraphBinaryMapper> {
     ...
     */
    public AbstractGraphBinaryMessageSerializerV1() {
        this(TypeSerializerRegistry.INSTANCE);
    }

    public AbstractGraphBinaryMessageSerializerV1(final TypeSerializerRegistry registry) {
    ...
    public AbstractGraphBinaryMessageSerializerV1(final TypeSerializerRegistry.Builder builder) {
        this(builder.create());
    }

    protected abstract String obtainMimeType();

    protected abstract String obtainStringdMimeType();
    ...
    public ByteBuf serializeRequestAsBinary(final RequestMessage requestMessage, final ByteBufAllocator allocator) throws SerializationException {
        final byte[] header = obtainMimeType().getBytes(UTF_8);
    ...
    public String[] mimeTypesSupported() {
        return new String[] {serializeToString ? obtainStringdMimeType() : obtainMimeType()};
    }
