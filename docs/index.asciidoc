...
| link:http://test.com[Luca Garulli] (2012) | Orient Technologies representative and Gremlin structure theorist.| link:http://www.orientechnologies.com/orientdb/[*OrientDB*]
...
| link:http://test.com[Sridhar Ramachandran] (2013) | Lambda Zen representative and Gremlin traversal theorist.| link:https://bitbucket.org/lambdazen/bitsy/wiki/Home[*Bitsy*]
...
| link:http://test.com[Michael Hackstein] (2014) | ArangoDB representative.| link:http://arangodb.org/[*ArangoDB*]
|=========================================================
...
[width="100%"]
|=========================================================
| image:arangodb-logo.png[width=200,link="http://arangodb.com"] | image:aurelius-logo.png[width=200,link="http://thinkaurelius.com"] | image:bigdata-logo.png[width=200,link="http://bigdata.com"]
| image:foundationdb-logo.png[width=200,link="https://foundationdb.com/"] | image:objectivity-logo.png[width=200,link="http://www.objectivity.com"] | image:lambda-zen-logo.png[width=200,link="http://lambdazen.blogspot.com"]
