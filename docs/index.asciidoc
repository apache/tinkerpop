...
==>tinkergraph[vertices:6 edges:6]
==>sideEffects[size:3]
gremlin> result.getValue1().get(Graph.Key.hidden('cap'))
==>32=3
==>35=1
==>27=1
==>29=3
...
image:neotechnology-logo.png[width=150,float=left] link:http://neotechnology.com[Neo Technology] are the developers of the link:http://neo4j.org[Neo4j graph database]. Neo4j natively supports the property graph data model. Note that Neo4j requires that the value objects in the property map of an element be Java primitives, `java.lang.String` values, or arrays of primitives and `java.lang.String` values.
...
|`hdfs.copyFromLocat(String from, String to)`| Copy the specified local path to the specified HDFS path.
...
| link:http://se.linkedin.com/in/neubauer[Peter Neubauer] (2009) | TinkerPop co-founder and Neo Technology representative.
...
| link:http://test.com[Pierre DeWilde] (2011) | Documentation support and evangelist.
| link:http://test.com[Derrick Wiebe] (2011) | Creator of Pacer and Gremlin traversal developer.
| link:http://test.com[Luca Garulli] (2012) | Orient Technologies representative and Gremlin structure theorist.
| link:http://www.matthiasb.com[Matthias Bröcheler] (2012) | Aurelius representative and full-stack theorist.
| link:http://test.com[Bryn Cooke] (2013) | Gremlin domain specific language theorist.
| link:http://test.com[James Thornton] (2013) | Creator of Bulbs and TinkerPop evangelist.
| link:http://test.com[Sridhar Ramachandran] (2013) | Lambda Zen representative and Gremlin traversal engine theorist.
| link:http://test.com[Nicholas Quinn] (2013) | Objectivity representative.
| link:http://test.com[Xavier Sanchez] (2013) | Sparksee representative.
| link:http://test.com[Daniel Kuppitz] (2014) | Gremlin traversal theorist and public technology support.
| link:http://test.com[Michael Pollmeier] (2014) | Gremlin-Scala creator and traversal API theorist.
| link:http://test.com[Jean-Baptiste Musso] (2014) | Gremlin-JavaScript creator.
| link:http://test.com[Bob Briody] (2014) | Gremlin visualization creator.
| link:http://test.com[Mike Personick] (2014) | BigData representative and Gremlin OLAP theorist.
| link:http://test.com[Michael Hackstein] (2014) | ArrangoDB representative.
|=========================================================
...
[width="100%"]
|=========================================================
| image:arangodb-logo.png[width=200,link="http://arangodb.com"] | image:aurelius-logo.png[width=200,link="http://thinkaurelius.com"] | image:bigdata-logo.png[width=200,link="http://www.systap.com/"]
| image:foundationdb-logo.png[width=200,link="https://foundationdb.com/"] | image:infinitegraph-logo.png[width=200,link="http://www.objectivity.com/infinitegraph"] | image:lambda-zen-logo.png[width=200,link="http://lambdazen.blogspot.com"]
| image:neotechnology-logo.png[width=200,link="http://neotechnology.com"] | image:orientechnologies-logo.png[width=200,link="http://www.orientechnologies.com"] | image:sparsity-technologies-logo.png[width=200,link="http://www.sparsity-technologies.com/"]
|=========================================================
