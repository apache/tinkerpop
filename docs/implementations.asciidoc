...
** The graph must fit within the total disk space of the Hadoop cluster (supports massive graphs). Message passing is coordinates via MapReduce jobs on the on-dks graph (slow traversals).
