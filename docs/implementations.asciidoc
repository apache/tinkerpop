...
gremlin.traversalVertexProgram.traversalSupplier=com.tinkerpop.gremlin.giraph.process.graph.example.TraversalSupplier1
gremlin.traversalVertexProgram.traversalSupplierType=CLASS
...
|gremlin.traversalVertexProgram.traversalSupplier |For `TraversalVertexProgram`, the location of the Gremlin traversal to use (if not using Gremlin Console).
|gremlin.traversalVertexProgram.traversalSupplierType | Whether the traversal supplier is a CLASS, SCRIPT, or OBJECT.
