...
gremlin> g.v(2).in('knows').out('knows').has('age',T.gt,30).
               outE('created').has('weight',T.gt,0.5f).inV.name
==>ripple
...
==>[v[5]]
gremlin> traversal.sideEffects().get('1').get()
==>v[2]
gremlin> traversal.sideEffects().get('2').get()
==>v[1]
gremlin> traversal.sideEffects().get('3').get()
==>v[4]
gremlin> traversal.sideEffects().get('4').get()
==>v[5]
gremlin> 
gremlin> :> traversal
