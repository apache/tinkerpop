...
==>[v[5]]
gremlin> traversal.memory().get('1').get()
==>[v[2]]
gremlin> traversal.memory().get('2').get()
==>[v[1]]
gremlin> traversal.memory().get('3').get()
==>[v[4]]
gremlin> traversal.memory().get('4').get()
==>[v[5]]
gremlin> 
gremlin> :> traversal
