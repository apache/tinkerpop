...
public class GremlinTreeprocessorTest {
    ...
    public void shouldRenderGraphBadgeForNamedGraph() {
        ...
        try (final Asciidoctor asciidoctor = Asciidoctor.Factory.create()) {
            ...
            assertThat(result, containsString("/reference/#tinkerpop-modern\">modern</a> graph."));
        }
    }
    ...
    public void shouldCarryForwardGraphLabelForExisting() {
        ...
        try (final Asciidoctor asciidoctor = Asciidoctor.Factory.create()) {
            ...
            final int badgeCount = result.split("/reference/#tinkerpop-modern\">modern</a>", -1).length - 1;
    ...
    public void shouldLabelExistingConsistentlyAcrossCachedSecondPass() {
        ...
        try (final Asciidoctor asciidoctor = Asciidoctor.Factory.create()) {
            ...
            final int htmlBadges = html.split("/reference/#tinkerpop-modern\">modern</a>", -1).length - 1;
