 ...
 *       reference section ({@link TabbedHtmlBuilder}).</li>
 * </ul>
...
final class GraphCatalog {
    ...
    /** A dataset entry: how to construct it, how to name it, and where its reference section lives. */
    static final class Entry {
        ...
        /** Reference-book section anchor, or {@code null} if the graph has no dedicated section. */
    ...
    static {
        ...
        final Entry crew = new Entry("graph = TinkerFactory.createTheCrew()", "crew", "the-crew-toy-graph");
        m.put("modern", new Entry("graph = TinkerFactory.createModern()", "modern", "tinkerpop-modern"));
