...
[source,groovy]
gremlin> g.V().repeat(g.of().both().groupCount('m').by{it.value('name')[1]}).until(10).cap('m')
...
gremlin> g.V().match('a',
            ...
            g.of().as('b').in('created').has('age', 29).as('c'),
            g.of().as('c').repeat(g.of().out()).until(2)). <2>
...
==>v[2]
==>v[3]
gremlin> g.V().repeat(g.of().both()).until(1000000).emit().range(6,10)
==>v[1]
==>v[5]
==>v[3]
==>v[1]
...
[source,groovy]
gremlin> g.V(1).repeat(g.of().out()).until(2).emit().path().by('name') <1>
==>[marko, lop]
==>[marko, vadas]
==>[marko, josh]
==>[marko, josh, ripple]
==>[marko, josh, lop]
gremlin> g.V(1).emit().repeat(g.of().out()).until(2).path().by('name') <2>
==>[marko]
==>[marko, lop]
==>[marko, vadas]
==>[marko, josh]
...
[source,groovy]
gremlin> g.V().withSack{1.0f}.repeat(g.of().outE().sack(mult,'weight').inV()).until(2)
==>v[5]
==>v[3]
gremlin> g.V().withSack{1.0f}.repeat(g.of().outE().sack(mult,'weight').inV()).until(2).sack()
==>1.0
==>0.4
gremlin> g.V().withSack{1.0f}.repeat(g.of().outE().sack(mult,'weight').inV()).until(2).path().by{it}.by('weight')
...
[source,groovy]
gremlin> g.V(1).repeat(g.of().local(
...
gremlin> g = TinkerFactory.createClassic()
==>tinkergraph[vertices:6 edges:6]
gremlin> sg = g.V(3).repeat(g.of().inE().outV()).until(3).emit().subgraph({true}).next()   <1>
...
gremlin> g = TinkerFactory.createClassic()
==>tinkergraph[vertices:6 edges:6]
gremlin> g.V().repeat(g.of().both().groupCount('m')).until(16).cap('m').next().sort{-it.value}
==>v[1]=2744208
==>v[3]=2744208
==>v[4]=2744208
==>v[2]=1136688
==>v[5]=1136688
==>v[6]=1136688
gremlin> clock(1){g.V().repeat(g.of().both().groupCount('m')).until(16).cap('m').next().sort{-it.value}}
==>11.996000
gremlin> g.V().repeat(g.of().timeLimit(2).both().groupCount('m')).until(16).cap('m').next().sort{-it.value}
==>v[1]=648473
==>v[3]=647510
==>v[4]=647499
==>v[5]=268540
==>v[6]=268533
==>v[2]=267941
gremlin> clock(1){g.V().repeat(g.of().timeLimit(2).both().groupCount('m')).until(16).cap('m').next().sort{-it.value}}
==>2.214000
...
==>3
==>[4, 5, [6]]
gremlin> g.of().inject(1,[2,3,[4,5,[6]]]).repeat(g.of().unfold()).until{!(it.get() instanceof List)}
==>1
==>2
==>3
==>4
