...
under the License.
////
[llms-summary="Recipe: There are many measures of centrality which are meant to help identify the most important vertices in a graph."]
[[centrality]]
== Centrality
...
the link:https://tinkerpop.apache.org/docs/x.y.z/data/#grateful-dead[Grateful Dead graph] with only 808 vertices
