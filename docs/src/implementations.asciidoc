...
15/09/11 08:02:11 INFO job.GiraphJob: run: Since checkpointing is disabled (default), do not allow any task retries (setting mapred.map.max.attempts = 0, old value = 4)
15/09/11 08:02:11 INFO client.RMProxy: Connecting to ResourceManager at /0.0.0.0:8032
...
15/09/11 08:02:12 INFO mapreduce.Job: The url to track the job: http://markos-macbook:8088/proxy/application_1441915907347_0028/
...
15/09/11 08:06:17 INFO mapreduce.Job: Counters: 80
	...
	Giraph Timers
		...
		Total (ms)=138788
	Zookeeper base path
		/_hadoopBsp/job_1441915907347_0028=0
	Zookeeper halt node
		/_hadoopBsp/job_1441915907347_0028/_haltComputation=0
