...
gremlin> :install com.apache.tinkerpop neo4j-gremlin x.y.z  <3>
...
[INFO] MetricManager - Configured Metrics Slf4jReporter configured with interval=180000ms and loggerName=com.apache.tinkerpop.gremlin.server.Settings$Slf4jReporterMetrics
[INFO] GremlinServer$WebSocketServerInitializer - Configured application/vnd.gremlin-v1.0+kryo with com.apache.tinkerpop.gremlin.driver.ser.KryoMessageSerializerV1d0
[INFO] GremlinServer$WebSocketServerInitializer - Configured application/vnd.gremlin-v1.0+kryo-stringd with com.apache.tinkerpop.gremlin.driver.ser.KryoMessageSerializerV1d0
...
[source,yaml]
channelizer: com.apache.tinkerpop.gremlin.server.channel.HttpChannelizer
...
[source,text]
----
bin/gremlin-server.sh -i com.apache.tinkerpop neo4j-gremlin x.y.z
----
...
[source,java]
----
include::{basedir}/gremlin-groovy/src/main/java/com/apache/tinkerpop/gremlin/groovy/plugin/GremlinPlugin.java[]
----
...
[source,java]
----
include::{basedir}/neo4j-gremlin/src/main/java/com/apache/tinkerpop/gremlin/neo4j/groovy/plugin/Neo4jGremlinPlugin.java[]
----
...
There is one other step to follow to ensure that the `GremlinPlugin` is visible to its hosts.  `GremlinPlugin` implementations are loaded via link:http://docs.oracle.com/javase/8/docs/api/java/util/ServiceLoader.html[ServiceLoader] and therefore need a resource file added to the jar file where the plugin exists.  Add a file called `com.apache.tinkerpop.gremlin.groovy.plugin.GremlinPlugin` to `META-INF.services`.  In the case of the Neo4j plugin above, that file will have this line in it:

[source,java]
----
include::{basedir}/neo4j-gremlin/src/main/resources/META-INF/services/com.apache.tinkerpop.gremlin.groovy.plugin.GremlinPlugin[]
----
...
. Start Gremlin Console and try the `:install` command.  For the case of the Neo4j plugin, it would look like this: `:install com.apache.tinkerpop neo4j-gremlin x.y.z`.
...
[source,java]
----
include::{basedir}/gremlin-groovy/src/main/java/com/apache/tinkerpop/gremlin/groovy/plugin/RemoteAcceptor.java[]
----
...
61.8        0.02     0.02      1    22.60    22.60   22.60   22.60   22.60   22.60  com.apache.tinkerpop.gremlin.tinkergraph.process.graph.TinkerGraphTraversal.iterate
23.5        0.03     0.00      1     8.62     8.62    8.62    8.62    8.62    8.62  com.apache.tinkerpop.gremlin.tinkergraph.structure.TinkerGraph.V                   
13.4        0.03     0.00      1     4.93    36.57    4.93   36.57    4.93   36.57  groovysh_evaluate$_run_closure1.doCall                                      
 1.0        0.03     0.00      1     0.38     0.40    0.38    0.40    0.38    0.40  com.apache.tinkerpop.gremlin.groovy.loaders.GremlinLoader.isStep                   
...
[1]     100.0  0.00      0.03      1  groovysh_evaluate$_run_closure1.doCall [1]                                          
               0.02      0.00    1/1      com.apache.tinkerpop.gremlin.tinkergraph.process.graph.TinkerGraphTraversal.iterate [2]
               0.00      0.00    1/1      com.apache.tinkerpop.gremlin.tinkergraph.structure.TinkerGraph.V [3]                   
               0.00      0.00    1/1      com.apache.tinkerpop.gremlin.groovy.loaders.GremlinLoader.isStep [4]                   
--------------------------------------------------------------------------------------------------------------------------
               0.02      0.00    1/1      groovysh_evaluate$_run_closure1.doCall [1]                                      
[2]      61.8  0.02      0.00      1  com.apache.tinkerpop.gremlin.tinkergraph.process.graph.TinkerGraphTraversal.iterate [2]    
--------------------------------------------------------------------------------------------------------------------------
               0.00      0.00    1/1      groovysh_evaluate$_run_closure1.doCall [1]                                      
[3]      23.5  0.00      0.00      1  com.apache.tinkerpop.gremlin.tinkergraph.structure.TinkerGraph.V [3]                       
--------------------------------------------------------------------------------------------------------------------------
               0.00      0.00    1/1      groovysh_evaluate$_run_closure1.doCall [1]                                      
[4]       1.1  0.00      0.00      1  com.apache.tinkerpop.gremlin.groovy.loaders.GremlinLoader.isStep [4]                       
...
==>
IMPLEMENTATION - com.apache.tinkerpop.gremlin.hadoop.structure.HadoopGraph
TINKERPOP TEST SUITE
- Compliant with (4 of 8 suites)
> com.apache.tinkerpop.gremlin.process.ProcessStandardSuite
> com.apache.tinkerpop.gremlin.process.ProcessComputerSuite
> com.apache.tinkerpop.gremlin.process.GroovyProcessStandardSuite
> com.apache.tinkerpop.gremlin.process.GroovyProcessComputerSuite
- Opts out of 12 individual tests
> com.apache.tinkerpop.gremlin.process.graph.step.map.MatchTest$StandardTest#g_V_matchXa_hasXname_GarciaX__a_0writtenBy_b__a_0sungBy_bX
...
...
> com.apache.tinkerpop.gremlin.process.graph.step.map.MatchTest$JavaMatchTest#g_V_matchXa_inXsungByX_b__a_inXsungByX_c__b_outXwrittenByX_d__c_outXwrittenByX_e__d_hasXname_George_HarisonX__e_hasXname_Bob_MarleyXX
	"Hadoop-Gremlin is OLAP-oriented and for OLTP operations, linear-scan joins are required. This particular tests takes many minutes to execute."
