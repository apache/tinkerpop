...
TODO: // how to load plugins using standard groovy methods? [gremlin,modern]
----
g.V().repeat(__.both().groupCount('m')).times(16).cap('m').next().sort{-it.value}
clock(1){g.V().repeat(__.both().groupCount('m')).times(16).cap('m').next().sort{-it.value}}
g.V().repeat(__.timeLimit(2).both().groupCount('m')).times(16).cap('m').next().sort{-it.value}
clock(1){g.V().repeat(__.timeLimit(2).both().groupCount('m')).times(16).cap('m').next().sort{-it.value}}
----
