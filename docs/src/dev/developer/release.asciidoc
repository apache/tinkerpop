...
. Check the state of `docs/upgrade/prompts` to ensure there is an `upgrade-x.y.z-helper.md` for the current version and
that it is up to date. **This process needs to be refined.**
