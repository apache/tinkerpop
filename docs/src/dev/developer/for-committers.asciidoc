...
a book, then it should also be included in the `index.asciidoc` file for that book. Likewise, if a whole new book
(subdirectory) is added, it must include an `index.asciidoc` file.
