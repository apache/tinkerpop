...
3. If a new serialization format version is released (e.g. increment the version of Gryo).

The second and third cases, require some additional discussion. When a new version is added the following classes will
need to be updated in the following ways:
