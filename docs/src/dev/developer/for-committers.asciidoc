...
Beads accumulate as the work proceeds and are pinned once it merges, which marks them as
permanent and protects them from routine cleanup. The result is a record that outlives the branch
it was written on.
