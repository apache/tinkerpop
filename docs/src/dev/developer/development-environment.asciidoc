...
Before generating documentation, build all the dependencies that the process consumes:
...
To generate the website locally, there is no need for any of the above infrastructure. Site generation is a simple
shell script:
