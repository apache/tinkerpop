...
At a minimum, development of TinkerPop requires link:https://openjdk.java.net/projects/jdk8/[Java 8] (but will build
with link:https://openjdk.java.net/projects/jdk/11/[Java 11] cross-compiled to Java 8)
