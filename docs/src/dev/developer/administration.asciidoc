...
the PMC chair to link:http://www.apache.org/dev/pmc.html#newcommitter[handle such things].
...
* link:http://www.apache.org/dev/committers.html[Apache Committer Gu]ide]
