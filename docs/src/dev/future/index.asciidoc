...
|link:https://github.com/apache/tinkerpop/blob/master/docs/src/dev/future/proposal-gql-engine-10.asciidoc[Proposal 10] |Generalized GQL Execution Engine (`gql-gremlin` Module) |Future |N
|=========================================================
