...
*Syntax:* `asString()` | `asString(Scope)`
...
*Syntax:* `replace(String, String)` | `replace(Scope, String, String)`
...
*Syntax:* `split(String)` | `split(Scope, String)`
...
*Syntax:* `substring(int, int)` | `substring(Scope, int, int)`
