...
The variable values are used in the order that the first one will be found: Element properties, than Scope values.
...
See: link:https://github.com/apache/tinkerpop/tree/x.y.z/gremlin-core/src/main/java/org/apache/tinkerpop/gremlin/process/traversal/step/map/FromatStep.java[source],
...
*Description:* Returns the lowercase representation of incoming string traverser.
...
*Description:* Returns the uppercase representation of incoming string traverser.
