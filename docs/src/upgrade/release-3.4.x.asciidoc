...
This release introduces Gryo 3.1 which is now the default Gryo version. Those using older versions of TinkerPop drivers
(e.g. 3.3.5) connecting to a 3.4.0 server can still expect Gryo 3.0 to work and be fully compatible. Gremlin Server
still has Gryo 3.0 serializer configurations present in its default packaging.
