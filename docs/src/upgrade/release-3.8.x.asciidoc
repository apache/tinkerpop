...
Previously the use of Vertex/ReferenceVertex was allowed in the grammar. This has now been removed and the Vertex ID should 
be used instead in traversals.
