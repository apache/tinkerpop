...
link:https://tinkerpop.apache.org/docs/4.0.0/reference/#vertex-labels[Vertex Labels],
...
See the link:https://tinkerpop.apache.org/docs/4.0.0/reference/#vertex-labels[vertex labels] reference docs more details
