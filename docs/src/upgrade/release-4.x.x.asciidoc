...
<<where-step,where()>> in the Reference Documentation for full details and additional examples.
...
See: link:https://issues.apache.org/jira/browse/TINKERPOP-2586[TINKERPOP-2586],
