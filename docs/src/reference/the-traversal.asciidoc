...
<3> Index all person names in their alphabetical order and store the result in an ordered map.
...
Learn more about hwo to implement these DSLs in the <<gremlin-drivers-variants,Gremlin Language Variants>> section
