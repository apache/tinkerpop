...
[llms-summary="The filter() step maps the traverser from the current object to either true or false where the latter will not pass the traverser to the next step in the proces"]
[[filter-step]]
=== Filter Step
...
[llms-summary="The propertiesMap()-step yields a Map representation of the properties of an element."]
[[propertymap-step]]
=== PropertyMap Step
...
[llms-summary="The trim()-step (map) returns a string with leading and leading whitespace removed."]
[[trim-step]]
=== Trim Step
