...
IMPORTANT: 4.0.0-beta.2 Release - These authorization mechanisms don't currently apply due to the removal of Bytecode.
...
IMPORTANT: 4.0.0-beta.2 Release - passive and active authorization mechanisms are not supported in this beta
