...
link:https://tinkerpop.apache.org/docs/current/reference/#start-steps[start step], one can apply so-called
link:https://tinkerpop.apache.org/docs/current/reference/#traversalstrategy[TraversalStrategy instances] to these
