...
kinds of troublesome scripts.  A user can configure the script engine with a `GroovyCompilerGremlinPlugin`
...
image:giraph-logo.png[width=100,float=left]  The Giraph Plugin installs as part of `giraph-gremlin` and provides
