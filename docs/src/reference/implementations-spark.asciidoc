...
under the License.
////
// SparkGraphComputer requires Scala 2.12 while Neo4j 3.4 requires Scala 2.11; they cannot share
// the console's flat classpath, so exclude neo4j-gremlin to restart the console without Neo4j's jars.
