...
g.V().has("name", "Alice").call("tinker.search.vector.topKByElement", byElementParams) <5>
byElementParams = [key: "embedding", topK: 2, element: "vertex"] <6>
embedding = new float[]{1.0f, 0.0f, 0.0f}
g.inject([embedding]).unfold().call("tinker.search.vector.topKByEmbedding", params) <7>
----
