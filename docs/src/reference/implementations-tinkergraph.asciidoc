...
|gremlin.tinkergraph.graphLocation |The directory in which `TinkerStorageGraph` stores its durable data. Required when
...
`gremlin.tinkergraph.graphLocation` names the directory that holds the durable data. The value of the storage key is
