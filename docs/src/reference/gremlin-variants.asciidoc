...
Tiny Gremlin executes a defined subset of Gremlin locally and in-process against a detached `Graph` held in
memory. No Gremlin Server or remote connection is involved. A local traversal source is created by passing a
