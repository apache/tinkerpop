...
[llms-summary="Using Gremlin from Groovy: installing gremlinpython, building traversals, Pythonic syntax differences, and connecting to a remote Gremlin Server."]
[[gremlin-groovy]]
== Gremlin-Groovy
...
[llms-summary="Using Gremlin from .NET: installing gremlinpython, building traversals, Pythonic syntax differences, and connecting to a remote Gremlin Server."]
