...
|ConnectTimeout | Timeout for establishing the connection (TCP connect plus TLS handshake). |5 seconds
...
|IdleTimeout | How long idle connections remain in the pool before being closed. |180 seconds
|KeepAliveTime | Idle time before TCP keep-alive probes begin. |30 seconds
|ReadTimeout | Idle-read timeout reset on each read of the response body. Set to `0` to disable. |0
...
|DefaultBatchSize |The connection-level default batch size used when a request does not specify one. |64
