...
The only truly protected namespace is the _hidden namespace_ provided to graph systems. From there, its up to engineers to respect the namespacing conventions presented.
