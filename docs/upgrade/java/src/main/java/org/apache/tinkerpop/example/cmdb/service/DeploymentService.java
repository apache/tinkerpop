...
public class DeploymentService {
    ...
    public DeploymentService(GremlinGateway gateway) {
        this.gateway = gateway;
    }

    public List<Map<Object, Object>> timeline(String deployId) {
        return gateway.fetch(TraversalBuilders.deploymentTimeline(deployId));
    }
}
