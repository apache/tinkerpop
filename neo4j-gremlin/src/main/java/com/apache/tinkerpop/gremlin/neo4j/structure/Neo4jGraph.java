...
import com.apache.tinkerpop.gremlin.neo4j.process.graph.traversal.step.util.Neo4jCypherIterator;
import com.apache.tinkerpop.gremlin.neo4j.process.graph.traversal.strategy.Neo4jGraphStepStrategy;
...
import com.apache.tinkerpop.gremlin.structure.util.wrapped.WrappedGraph;
...
@Graph.OptOut(
        test = "com.apache.tinkerpop.gremlin.structure.VertexTest$ExceptionConsistencyWhenVertexRemovedTest",
