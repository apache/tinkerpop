...
public class DefaultNeo4jGraphTraversal<S, E> extends DefaultGraphTraversal<S, E> implements Neo4jGraphTraversal<S, E> {
    ...
    static {
        ...
        TraversalStrategies.GlobalCache.registerStrategies(DefaultNeo4jGraphTraversal.class, traversalStrategies);
    }

    public DefaultNeo4jGraphTraversal() {
        super();
    }

    public DefaultNeo4jGraphTraversal(final Neo4jGraph neo4jGraph) {
        super(neo4jGraph);
    }
