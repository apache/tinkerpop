...
public interface Neo4jVertexTraversal extends Neo4jElementTraversal<Vertex>, VertexTraversal {
    ...
    public default <E2> Neo4jTraversal<Vertex, MetaProperty<E2>> properties(final String... propertyKeys) {
        return (Neo4jTraversal) this.start().properties(propertyKeys);
    }

    public default <E2> Neo4jTraversal<Vertex, Map<String, List<MetaProperty<E2>>>> propertyMap(final String... propertyKeys) {
        return (Neo4jTraversal) this.start().propertyMap(propertyKeys);
    }

    public default <E2> Neo4jTraversal<Vertex, MetaProperty<E2>> hiddens(final String... propertyKeys) {
        return (Neo4jTraversal) this.start().hiddens(propertyKeys);
    }

    public default <E2> Neo4jTraversal<Vertex, Map<String, List<MetaProperty<E2>>>> hiddenMap(final String... propertyKeys) {
