...
public interface Neo4jGraphTraversal<S, E> extends GraphTraversal.Admin<S, E>, GraphTraversal<S, E> {
	...
	public default Neo4jGraphTraversal<S, E> and(com.tinkerpop.gremlin.process.Traversal<?, ?>... arg0) {
	...
	public default Neo4jGraphTraversal<S, E> barrier() {
	...
	public default <M,E2> Neo4jGraphTraversal<S, E2> branch(com.tinkerpop.gremlin.process.Traversal<?, M> arg0) {
	...
	public default Neo4jGraphTraversal<S, E> by(com.tinkerpop.gremlin.process.Traversal<?, ?> arg0) {
		return (Neo4jGraphTraversal) com.tinkerpop.gremlin.process.graph.GraphTraversal.super.by(arg0);
	}

	public default Neo4jGraphTraversal<S, E> by(com.tinkerpop.gremlin.structure.Order arg0) {
		return (Neo4jGraphTraversal) com.tinkerpop.gremlin.process.graph.GraphTraversal.super.by(arg0);
	}
	...
	public default <M,E2> Neo4jGraphTraversal<S, E2> choose(com.tinkerpop.gremlin.process.Traversal<?, M> arg0) {
	...
	public default <E2> Neo4jGraphTraversal<S, E2> choose(com.tinkerpop.gremlin.process.Traversal<?, ?> arg0, com.tinkerpop.gremlin.process.Traversal<?, E2> arg1, com.tinkerpop.gremlin.process.Traversal<?, E2> arg2) {
	...
	public default Neo4jGraphTraversal<S, E> is(java.lang.Object arg0) {
		return (Neo4jGraphTraversal) com.tinkerpop.gremlin.process.graph.GraphTraversal.super.is(arg0);
	}

	public default Neo4jGraphTraversal<S, E> is(java.util.function.BiPredicate arg0, java.lang.Object arg1) {
		return (Neo4jGraphTraversal) com.tinkerpop.gremlin.process.graph.GraphTraversal.super.is(arg0, arg1);
	}
	...
	public default Neo4jGraphTraversal<S, java.lang.Double> mean() {
	...
	public default Neo4jGraphTraversal<S, E> or(com.tinkerpop.gremlin.process.Traversal<?, ?>... arg0) {
	...
	public default Neo4jGraphTraversal<S, E> order(com.tinkerpop.gremlin.process.Scope arg0) {
		return (Neo4jGraphTraversal) com.tinkerpop.gremlin.process.graph.GraphTraversal.super.order(arg0);
	}
	...
	public default Neo4jGraphTraversal<S, com.tinkerpop.gremlin.structure.Edge> subgraph() {
		return (Neo4jGraphTraversal) com.tinkerpop.gremlin.process.graph.GraphTraversal.super.subgraph();
	}
