...
namespace Gremlin.Net.UnitTest.Driver
{
    public class HttpConnectionTests
    {
        ...
        public async Task ShouldSetContentTypeHeader()
        {
            ...
            using var connection = new HttpConnection(TestUri, serializer, settings, httpClient);
        ...
        public async Task ShouldSetAcceptEncodingWhenCompressionEnabled()
        {
            var (httpClient, handler) = CreateMockHttpClient();
            var serializer = CreateMockSerializer();
            var settings = new HttpConnectionSettings { EnableCompression = true };
            using var connection = new HttpConnection(TestUri, serializer, settings, httpClient);
        ...
        public async Task ShouldNotSetAcceptEncodingWhenCompressionDisabled()
        {
            var (httpClient, handler) = CreateMockHttpClient();
            var serializer = CreateMockSerializer();
            var settings = new HttpConnectionSettings { EnableCompression = false };
            using var connection = new HttpConnection(TestUri, serializer, settings, httpClient);
        ...
        public async Task ShouldSetUserAgentWhenEnabled()
        {
            var (httpClient, handler) = CreateMockHttpClient();
            var serializer = CreateMockSerializer();
            var settings = new HttpConnectionSettings { EnableUserAgentOnConnect = true };
            using var connection = new HttpConnection(TestUri, serializer, settings, httpClient);
        ...
        public async Task ShouldNotSetUserAgentWhenDisabled()
        {
            var (httpClient, handler) = CreateMockHttpClient();
            var serializer = CreateMockSerializer();
            var settings = new HttpConnectionSettings { EnableUserAgentOnConnect = false };
            using var connection = new HttpConnection(TestUri, serializer, settings, httpClient);
        ...
        public async Task ShouldSetBulkResultsHeaderWhenEnabled()
        {
            var (httpClient, handler) = CreateMockHttpClient();
            var serializer = CreateMockSerializer();
            var settings = new HttpConnectionSettings { BulkResults = true };
            using var connection = new HttpConnection(TestUri, serializer, settings, httpClient);
        ...
        public async Task ShouldNotSetBulkResultsHeaderWhenDisabled()
        {
            var (httpClient, handler) = CreateMockHttpClient();
            var serializer = CreateMockSerializer();
            var settings = new HttpConnectionSettings { BulkResults = false };
            using var connection = new HttpConnection(TestUri, serializer, settings, httpClient);
        ...
        public void ShouldDisposeWithoutError()
        {
            ...
            var serializer = CreateMockSerializer();
            var settings = new HttpConnectionSettings();
            var connection = new HttpConnection(TestUri, serializer, settings, httpClient);
