...
import com.apache.tinkerpop.gremlin.groovy.NoImportCustomizerProvider;
...
import com.apache.tinkerpop.gremlin.util.config.YamlConfiguration;
...
public class GremlinGroovyScriptEngineTest extends AbstractGremlinTest {
    ...
    public void shouldLoadImportsViaDependencyManagerInterface() throws Exception {
        ...
        engine.addImports(new HashSet<>(Arrays.asList("import com.apache.tinkerpop.gremlin.structure.Vertex")));
        assertEquals(Vertex.class.getName(), engine.eval("Vertex.class.getName()"));
    }
