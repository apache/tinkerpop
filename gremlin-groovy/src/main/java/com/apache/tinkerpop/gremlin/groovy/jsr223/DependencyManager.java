 ...
 * under the License.
 */
package com.apache.tinkerpop.gremlin.groovy.jsr223;

import com.apache.tinkerpop.gremlin.groovy.plugin.GremlinPlugin;
import com.apache.tinkerpop.gremlin.groovy.plugin.GremlinPluginException;
...
public interface DependencyManager {
     ...
     * implementations in the classloader.  The {@link com.apache.tinkerpop.gremlin.groovy.jsr223.GremlinGroovyScriptEngine}
     * implementation uses ServiceLoader to figure out if there are such classes to return.
     * <br/>
     * It is up to the caller to execute the
     * {@link GremlinPlugin#pluginTo(com.apache.tinkerpop.gremlin.groovy.plugin.PluginAcceptor)} method.  The reason for
     * this has to do with conflicts that can occur with mapper imports that are added via the
     * {@link com.apache.tinkerpop.gremlin.groovy.ImportCustomizerProvider} and scripts executed through the
     * {@link com.apache.tinkerpop.gremlin.groovy.plugin.PluginAcceptor}. Generally speaking, all calls to this "use" method
     * should be complete prior to calling
     * {@link GremlinPlugin#pluginTo(com.apache.tinkerpop.gremlin.groovy.plugin.PluginAcceptor)}.
     */
