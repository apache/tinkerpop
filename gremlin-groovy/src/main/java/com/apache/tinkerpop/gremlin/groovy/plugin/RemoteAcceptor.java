...
public interface RemoteAcceptor extends Closeable {
     ...
     * @throws com.apache.tinkerpop.gremlin.groovy.plugin.RemoteException if there is a problem with connecting
     */
     ...
     *
     * @return an object to display as output to the user
     * @throws com.apache.tinkerpop.gremlin.groovy.plugin.RemoteException if there is a problem with configuration
     */
     ...
     *
     * @return an object to display as output to the user
     * @throws com.apache.tinkerpop.gremlin.groovy.plugin.RemoteException if there is a problem with submission
     */
