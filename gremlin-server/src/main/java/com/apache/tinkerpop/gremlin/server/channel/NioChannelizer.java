...
import com.apache.tinkerpop.gremlin.server.handler.NioGremlinBinaryRequestDecoder;
import com.apache.tinkerpop.gremlin.server.handler.NioGremlinResponseEncoder;
...
/**
 * A {@link com.apache.tinkerpop.gremlin.server.Channelizer} that exposes an NIO-based Gremlin endpoint with a custom
 * protocol.
 *
