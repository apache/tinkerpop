...
public abstract class Auth implements RequestInterceptor {
    ...
    public static Auth sigv4(final String regionName, final AWSCredentialsProvider awsCredentialsProvider) {
        return new Sigv4(regionName, awsCredentialsProvider, NEPTUNE_SERVICE_NAME);
    }

    public static Auth sigv4(final String regionName, final AWSCredentialsProvider awsCredentialsProvider, final String serviceName) {
    ...
    public static class Sigv4 extends Auth {
        ...
        private Sigv4(final String regionName, final AWSCredentialsProvider awsCredentialsProvider, final String serviceName) {
