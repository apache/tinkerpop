 ...
 */
public abstract class AbstractTinkerGraphProvider extends AbstractGraphProvider {

    protected static final String GREMLIN_TINKERGRAPH_SKIP_TEST = "gremlin.tinkergraph.skipTest";
    ...
    public Map<String, Object> getBaseConfiguration(final String graphName, final Class<?> test, final String testMethodName,
        ...
        return new HashMap<String, Object>() {{
            ...
            put(GREMLIN_TINKERGRAPH_SKIP_TEST, getSkipTests().contains(testMethodName) || getSkipTests().contains(test.getCanonicalName()));
            ...
            if (null != loadGraphWith) {
                put(TinkerGraph.GREMLIN_TINKERGRAPH_GRAPH_LOCATION, getGraphLocation(loadGraphWith));
                put(TinkerGraph.GREMLIN_TINKERGRAPH_GRAPH_FORMAT, "gryo");
            }
        }};
    }
    ...
    private final String getGraphLocation(final LoadGraphWith.GraphData graphData) {
