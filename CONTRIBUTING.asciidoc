...
Code modifications must go through a review process before being merged into a release branch. All committers should
follow the pattern below, where "you" refers to the committer wanting to put code into a release branch.
...
* Before you can merge your branch into the release branch, you must have at lease 3 +1 link:http://www.apache.org/foundation/glossary.html#ConsensusApproval[consensus votes].
...
* Votes are issued as comments to the pull request.
