...
func NewGraphTraversalSource(graph *Graph, traversalStrategies *TraversalStrategies, bytecode *bytecode) *GraphTraversalSource {
	return &GraphTraversalSource{graph: graph, traversalStrategies: traversalStrategies, bytecode: newBytecode(bytecode)}
}
...
func (gts *GraphTraversalSource) clone() *GraphTraversalSource {
	return NewGraphTraversalSource(gts.graph, gts.traversalStrategies, newBytecode(gts.bytecode))
}
...
func (gts *GraphTraversalSource) E(args ...interface{}) *GraphTraversal {
	traversal := NewGraphTraversal(gts.graph, gts.traversalStrategies, newBytecode(gts.bytecode))
