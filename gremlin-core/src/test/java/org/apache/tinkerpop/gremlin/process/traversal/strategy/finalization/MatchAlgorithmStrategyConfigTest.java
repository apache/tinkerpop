...
public class MatchAlgorithmStrategyConfigTest {

    @Parameterized.Parameter(0)
    public MatchAlgorithmStrategy expectedStrategy;
    ...
    public void shouldRoundTripConfiguration() {
        ...
        final MatchAlgorithmStrategy recreatedStrategy = MatchAlgorithmStrategy.create(configuration);

        // Assert that the recreated strategy matches the expected strategy
        assertEquals(expectedStrategy.getMatchAlgorithmClass(), recreatedStrategy.getMatchAlgorithmClass());
    }
}