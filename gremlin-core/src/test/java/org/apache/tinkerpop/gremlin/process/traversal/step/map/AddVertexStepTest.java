...
public class AddVertexStepTest {
    ...
    @Test
    public void testPopInstructions() {
        // Vertex Step Test
        AddVertexStep addVertexStep = new AddVertexStep(__.identity().asAdmin(),
        ...
        AddVertexStartStep addVertexStartStep = new AddVertexStartStep(__.identity().asAdmin(),
