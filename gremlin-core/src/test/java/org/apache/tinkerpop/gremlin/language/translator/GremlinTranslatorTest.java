        ...
        public static Collection<Object[]> data() {
            return Arrays.asList(new Object[][]{
                    ...
                    {"g.V(Vertex(1, \"person\")).limit(1)",
                            null,
                            "g.V(Vertex(number0, string0)).limit(number0)",
                            ...
                            "g.V(Vertex(1, 'person')).limit(1)",},
                    {"g.V(Vertex(1)).limit(1)",
                            null,
                            "g.V(Vertex(number0)).limit(number0)",
                            "g.V(new Vertex(1)).Limit<object>(1)",
                            "g.V(gremlingo.Vertex{Element{1}}).Limit(1)",
                            "g.V(new ReferenceVertex(1)).limit(1)",
                            "g.V(new ReferenceVertex(1)).limit(1)",
                            "g.V(new Vertex(1)).limit(1)",
                            "g.V(Vertex(1)).limit(1)",},
