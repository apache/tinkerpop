...
public class JavascriptTranslatorTest {
    ...
    public void shouldHaveNull() {
        assertEquals("g.inject(null,null)", translator.translate(g.inject(null, null).asAdmin().getGremlinLang()).getScript());
        assertEquals("g.V()", translator.translate(g.V().asAdmin().getGremlinLang()).getScript());
        assertEquals("g.V(null)", translator.translate(g.V(null).asAdmin().getGremlinLang()).getScript());
        assertEquals("g.V(null,null)", translator.translate(g.V(null, null).asAdmin().getGremlinLang()).getScript());
        assertEquals("g.E()", translator.translate(g.E().asAdmin().getGremlinLang()).getScript());
        assertEquals("g.E(null)", translator.translate(g.E(null).asAdmin().getGremlinLang()).getScript());
        assertEquals("g.E(null,null)", translator.translate(g.E(null, null).asAdmin().getGremlinLang()).getScript());
    }
