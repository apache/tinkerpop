...
public final class ListNoneStep<S, S2> extends FilterStep<S> {

    private P<S2> predicate;

    public ListNoneStep(final Traversal.Admin traversal, final P<S2> predicate) {
        super(traversal);
    ...
    @Override
    public ListNoneStep<S, S2> clone() {
        final ListNoneStep<S, S2> clone = (ListNoneStep<S, S2>) super.clone();
