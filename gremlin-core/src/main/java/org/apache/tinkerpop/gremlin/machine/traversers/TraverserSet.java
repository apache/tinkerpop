 ...
 * under the License.
 */
package org.apache.tinkerpop.gremlin.machine.traversers;

import org.apache.tinkerpop.gremlin.machine.Traverser;
import org.apache.tinkerpop.gremlin.machine.util.FastNoSuchElementException;
 ...
 */
public class TraverserSet<C, S> extends AbstractSet<Traverser<C, S>> implements Set<Traverser<C, S>>, Queue<Traverser<C, S>> {
