...
public class GraphSONMapper implements Mapper<ObjectMapper> {
    ...
    private static final List<String> GRAPHSON_1_0_ALLOWED_EXTRA_TYPE_NAMES = Arrays.asList(
            ...
            "java.util.TreeMap",
            "java.util.TreeSet",
            // gremlin-util depends on gremlin-core, so the V1 message envelope is named here without a class reference
    ...
    public static class Builder implements Mapper.Builder<Builder> {
         ...
         * <p/>
         * Has no effect on GraphSON 2.0 or 3.0, which resolve types through a fixed registry rather than by name.
         */
