...
public class LP_NL_O_OB_P_S_SE_SL_Traverser<T> extends LP_O_OB_P_S_SE_SL_Traverser<T> implements NL_SL_Traverser<T> {
    ...
    private void cloneLoopState(final LP_NL_O_OB_P_S_SE_SL_Traverser<?> clone) {
