 ...
 */
public class AddVertexStepPlaceholder<S> extends AbstractStep<S, Vertex>
    ...
    public AddVertexStepPlaceholder(final Traversal.Admin traversal, final Traversal.Admin<S,String> vertexLabelTraversal) {
        ...
        if (vertexLabelTraversal instanceof GValueConstantTraversal) {
            traversal.getGValueManager().track(((GValueConstantTraversal<S, String>) vertexLabelTraversal).getGValue());
        }
    }
