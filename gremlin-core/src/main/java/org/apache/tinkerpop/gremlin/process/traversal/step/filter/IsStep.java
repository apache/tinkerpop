...
import org.apache.tinkerpop.gremlin.process.traversal.step.util.structure.filter.IsStepStructure;
 ...
 */
public final class IsStep<S> extends FilterStep<S> implements IsStepStructure<S> {
