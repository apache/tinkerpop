...
public class ConstantStepGV<S> extends GValueStep<ConstantStep, S, S> implements ConstantStepStructure<GValue<S>> {

    private final GValue<S> constant;

    public ConstantStepGV(final Traversal.Admin traversal, final GValue<S> constant) {
