...
public class IsStepGV<S> extends GValueStep<IsStep, S, S> implements IsStepStructure<S> {
    private P<S> predicate;

    public IsStepGV(final Traversal.Admin traversal, final P<S> predicate) {
        super(traversal, new IsStep(traversal, GValue.resolveGValuesInP(predicate)));
