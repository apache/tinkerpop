...
public interface Step<S, E> extends Iterator<Traverser<E>>, Cloneable {
     ...
     * Moreover, the previous and next steps should be set to {@link com.apache.tinkerpop.gremlin.process.traversal.step.EmptyStep}.
     *
    ...
    /**
     * Provide the necessary {@link com.apache.tinkerpop.gremlin.process.traverser.TraverserRequirement} that must be met by the traverser in order for the step to function properly.
