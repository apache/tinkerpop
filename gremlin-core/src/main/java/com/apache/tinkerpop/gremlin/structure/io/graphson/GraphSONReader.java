 ...
 * {@link com.apache.tinkerpop.gremlin.structure.Element} is used as a key, it is coerced to its identifier.  Other complex
...
public class GraphSONReader implements GraphReader {
    ...
    public static class Builder {
         ...
         * {@link com.apache.tinkerpop.gremlin.structure.util.batch.BatchGraph.Builder#vertexIdKey} when reading data into
         * the {@link Graph}.
         */
        ...
        /**
         * The name of the key to supply to
         * {@link com.apache.tinkerpop.gremlin.structure.util.batch.BatchGraph.Builder#edgeIdKey} when reading data into
         * the {@link Graph}.
         */
