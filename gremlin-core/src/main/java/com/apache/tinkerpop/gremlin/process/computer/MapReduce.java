 ...
 * under the License.
 */
package com.apache.tinkerpop.gremlin.process.computer;
 ...
 * The map() stage processes the vertices of the {@link com.apache.tinkerpop.gremlin.structure.Graph} in a logically parallel manner.
...
public interface MapReduce<MK, MV, RK, RV, R> extends Cloneable {
    ...
    /**
     * The final result can be generated and added to {@link Memory} and accessible via {@link com.apache.tinkerpop.gremlin.process.computer.util.DefaultComputerResult}.
    ...
    public interface MapEmitter<K, V> {
        ...
        /**
         * A default method that assumes the key is {@link com.apache.tinkerpop.gremlin.process.computer.MapReduce.NullObject}.
         *
