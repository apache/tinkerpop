...
import com.apache.tinkerpop.gremlin.process.traversal.DefaultTraversalStrategies;
...
import com.apache.tinkerpop.gremlin.util.tools.MultiMap;
...
public interface TraversalStrategies extends Cloneable {
    ...
    /**
     * Sorts the list of provided strategies such that the {@link com.apache.tinkerpop.gremlin.process.TraversalStrategy#applyPost()}
