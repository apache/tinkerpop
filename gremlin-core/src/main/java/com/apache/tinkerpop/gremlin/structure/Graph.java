...
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.sideEffect.GraphStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.DefaultGraphTraversal;
import com.apache.tinkerpop.gremlin.structure.io.DefaultIo;
import com.apache.tinkerpop.gremlin.structure.io.graphml.GraphMLReader;
import com.apache.tinkerpop.gremlin.structure.io.graphml.GraphMLWriter;
import com.apache.tinkerpop.gremlin.structure.io.graphson.GraphSONMapper;
import com.apache.tinkerpop.gremlin.structure.io.graphson.GraphSONReader;
import com.apache.tinkerpop.gremlin.structure.io.graphson.GraphSONWriter;
import com.apache.tinkerpop.gremlin.structure.io.kryo.KryoMapper;
...
import com.apache.tinkerpop.gremlin.structure.strategy.GraphStrategy;
import com.apache.tinkerpop.gremlin.structure.strategy.SequenceStrategy;
import com.apache.tinkerpop.gremlin.structure.strategy.StrategyGraph;
import com.apache.tinkerpop.gremlin.structure.util.FeatureDescriptor;
...
public interface Graph extends AutoCloseable {
     ...
     * Whatever configuration was passed to {@link com.apache.tinkerpop.gremlin.structure.util.GraphFactory#open(org.apache.commons.configuration.Configuration)}
     ...
     * without constructing a {@link com.apache.tinkerpop.gremlin.process.Traversal} object.
     */
     ...
     * methods to provider mapper configurations to the default {@link com.apache.tinkerpop.gremlin.structure.io.GraphReader}
     * and {@link com.apache.tinkerpop.gremlin.structure.io.GraphWriter} implementations (i.e. to register mapper
     * serialization classes).
     */
    public interface Io {
        /**
         * Creates a {@link com.apache.tinkerpop.gremlin.structure.io.GraphReader} builder for Kryo serializations. This
         * method calls the {@link Io#kryoMapper} method to supply to
         * {@link com.apache.tinkerpop.gremlin.structure.io.kryo.KryoReader.Builder#mapper} which means that implementers
        ...
        /**
         * Creates a {@link com.apache.tinkerpop.gremlin.structure.io.GraphWriter} builder for Kryo serializations. This
         * method calls the {@link Io#kryoMapper} method to supply to
         * {@link com.apache.tinkerpop.gremlin.structure.io.kryo.KryoWriter.Builder#mapper} which means that implementers
         * should usually just override {@link Io#kryoMapper} to append in their mapper classes.
         */
        ...
        /**
         * By default, this method creates an instance of the most current version of {@link com.apache.tinkerpop.gremlin.structure.io.kryo.KryoMapper} which is
         ...
         * registered to the returned {@link com.apache.tinkerpop.gremlin.structure.io.kryo.KryoMapper}.
         * <br/>
         ...
         * written with {@link com.apache.tinkerpop.gremlin.structure.io.kryo.KryoMapper} will not be readable without this serializer configuration.  It is
         * considered good practice to make serialization classes generally available so that users may
         * register these classes themselves if necessary when building up a mapper {@link com.apache.tinkerpop.gremlin.structure.io.kryo.KryoMapper}
         * instance.
         * <br/>
        ...
        /**
         * Creates a {@link com.apache.tinkerpop.gremlin.structure.io.GraphReader} builder for GraphML serializations. GraphML
        ...
        /**
         * Creates a {@link com.apache.tinkerpop.gremlin.structure.io.GraphWriter} builder for GraphML serializations. GraphML
         * is the most portable of all the formats, but comes at the price of the least flexibility.
         * {@code Graph} implementations that have mapper classes that need to be serialized will not be able
         * to properly use this format effectively.
         */
        ...
        /**
         * Creates a {@link com.apache.tinkerpop.gremlin.structure.io.GraphReader} builder for GraphSON serializations.
         * GraphSON is forgiving for implementers and will typically do a "reasonable" job in serializing most
         * mapper classes.  This method by default uses the {@link com.apache.tinkerpop.gremlin.structure.io.graphson.GraphSONMapper} created by
        ...
        /**
         * Creates a {@link com.apache.tinkerpop.gremlin.structure.io.GraphWriter} builder for GraphML serializations.
         * GraphSON is forgiving for implementers and will typically do a "reasonable" job in serializing most
         * mapper classes.  This method by default uses the {@link com.apache.tinkerpop.gremlin.structure.io.graphson.GraphSONMapper} created by
         * {@link #graphSONMapper}. That method enables implementers to register mapper serialization
         * modules for classes that do not serialize nicely by the default JSON serializers or completely
         ...
         * {@link com.apache.tinkerpop.gremlin.structure.io.graphson.GraphSONMapper.Builder} which is can produce a
         * {@link com.apache.tinkerpop.gremlin.structure.io.Mapper} implementation for GraphSON to
         ...
         * register these classes themselves if necessary when building up a mapper {@link com.apache.tinkerpop.gremlin.structure.io.graphson.GraphSONMapper}
         * instance.
         * <br/>
         * Note that this method is meant to return a {@link com.apache.tinkerpop.gremlin.structure.io.graphson.GraphSONMapper.Builder} with default configuration
    ...
    public interface Features {
        ...
        public interface GraphFeatures extends FeatureSet {
             ...
             * {@link com.apache.tinkerpop.gremlin.process.computer.GraphComputer} based processing.
             */
             ...
             * to be executed across multiple threads via {@link com.apache.tinkerpop.gremlin.structure.Transaction#create()}.
             */
        ...
        /**
         * Features for {@link com.apache.tinkerpop.gremlin.structure.Graph.Variables}.
         */
        public interface VariableFeatures extends DataTypeFeatures {
            public static final String FEATURE_VARIABLES = "Variables";

            /**
             * If any of the features on {@link com.apache.tinkerpop.gremlin.structure.Graph.Features.VariableFeatures} is
    ...
    public @interface OptIn {
        public static String SUITE_STRUCTURE_STANDARD = "com.apache.tinkerpop.gremlin.structure.StructureStandardSuite";
        public static String SUITE_STRUCTURE_PERFORMANCE = "com.apache.tinkerpop.gremlin.structure.StructurePerformanceSuite";
        public static String SUITE_PROCESS_COMPUTER = "com.apache.tinkerpop.gremlin.process.ProcessComputerSuite";
        public static String SUITE_PROCESS_STANDARD = "com.apache.tinkerpop.gremlin.process.ProcessStandardSuite";
        public static String SUITE_PROCESS_PERFORMANCE = "com.apache.tinkerpop.gremlin.process.ProcessPerformanceSuite";
        public static String SUITE_GROOVY_PROCESS_STANDARD = "com.apache.tinkerpop.gremlin.process.GroovyProcessStandardSuite";
        public static String SUITE_GROOVY_PROCESS_COMPUTER = "com.apache.tinkerpop.gremlin.process.GroovyProcessComputerSuite";
        public static String SUITE_GROOVY_ENVIRONMENT = "com.apache.tinkerpop.gremlin.groovy.GroovyEnvironmentSuite";
        public static String SUITE_GROOVY_ENVIRONMENT_INTEGRATE = "com.apache.tinkerpop.gremlin.groovy.GroovyEnvironmentIntegrateSuite";
        public static String SUITE_GROOVY_ENVIRONMENT_PERFORMANCE = "com.apache.tinkerpop.gremlin.groovy.GroovyEnvironmentPerformanceSuite";
