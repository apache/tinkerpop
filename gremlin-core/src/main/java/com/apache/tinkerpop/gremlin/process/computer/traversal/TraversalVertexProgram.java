 ...
 * under the License.
 */
package com.apache.tinkerpop.gremlin.process.computer.traversal;
...
import com.apache.tinkerpop.gremlin.process.computer.MessageScope;
import com.apache.tinkerpop.gremlin.process.computer.Messenger;
import com.apache.tinkerpop.gremlin.process.computer.VertexProgram;
import com.apache.tinkerpop.gremlin.process.computer.traversal.step.sideEffect.mapreduce.TraverserMapReduce;
import com.apache.tinkerpop.gremlin.process.computer.util.AbstractVertexProgramBuilder;
import com.apache.tinkerpop.gremlin.process.computer.util.LambdaHolder;
...
import com.apache.tinkerpop.gremlin.process.traversal.TraversalMatrix;
...
/**
 * TraversalVertexProgram enables the evaluation of a {@link Traversal} on a {@link com.apache.tinkerpop.gremlin.process.computer.GraphComputer}.
 * At the start of the computation, each {@link Vertex} (or {@link com.apache.tinkerpop.gremlin.structure.Edge}) is assigned a single {@link Traverser}.
...
public final class TraversalVertexProgram implements VertexProgram<TraverserSet<?>> {
     ...
     * The supplier is either a {@link Class}, {@link com.apache.tinkerpop.gremlin.process.computer.util.ScriptEngineLambda}, or a direct Java8 lambda.
     *
