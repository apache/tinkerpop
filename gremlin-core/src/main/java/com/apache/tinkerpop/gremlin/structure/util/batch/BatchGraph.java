 ...
 * - {@link Vertex#addEdge(String, com.apache.tinkerpop.gremlin.structure.Vertex, Object...)} for adding edges
 ...
 * operation with {@link com.apache.tinkerpop.gremlin.structure.strategy.IdStrategy}.
 * <br/>
 * Note that {@code BatchGraph} itself is not a {@link com.apache.tinkerpop.gremlin.structure.strategy.GraphStrategy} because
 * it requires that the {@link Vertex} implementation not hold on to the underlying {@link Vertex} reference and
 * {@link com.apache.tinkerpop.gremlin.structure.strategy.StrategyVertex} does that by it's very nature.  While it might
 * be possible to work around this issue, it is likely better for performance to simply leave this as a "half-wrapper"
 * implementation, instead of forcing it into a {@link com.apache.tinkerpop.gremlin.structure.strategy.GraphStrategy}.
 *
...
public class BatchGraph<G extends Graph> implements Graph, Graph.Iterators {
    ...
    public static class Builder<G extends Graph> {
        ...
        /**
         * Number of mutations to perform between calls to {@link com.apache.tinkerpop.gremlin.structure.Transaction#commit}.
         */
