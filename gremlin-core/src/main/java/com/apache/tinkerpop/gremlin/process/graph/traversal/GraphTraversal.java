...
import com.apache.tinkerpop.gremlin.process.Scope;
...
import com.apache.tinkerpop.gremlin.process.graph.traversal.lambda.LoopTraversal;
...
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.branch.BranchStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.branch.ChooseStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.branch.LocalStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.branch.RepeatStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.branch.UnionStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.filter.AndStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.filter.CoinStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.filter.CyclicPathStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.filter.DedupStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.filter.ExceptStep;
...
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.filter.HasTraversalStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.filter.IsStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.filter.OrStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.filter.RangeStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.filter.RetainStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.filter.SampleStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.filter.SimplePathStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.filter.TimeLimitStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.filter.WhereStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.map.BackStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.map.CoalesceStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.map.CountStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.map.EdgeOtherVertexStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.map.EdgeVertexStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.map.FlatMapStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.map.FoldStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.map.IdStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.map.KeyStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.map.LabelStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.map.MapStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.map.MaxStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.map.MeanStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.map.MinStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.map.OrderGlobalStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.map.OrderLocalStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.map.PathStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.map.PropertiesStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.map.PropertyMapStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.map.PropertyValueStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.map.SackStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.map.SelectOneStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.map.SelectStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.map.SumStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.map.UnfoldStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.map.VertexStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.map.match.MatchStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.sideEffect.AddEdgeStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.sideEffect.AggregateStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.sideEffect.GroupCountStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.sideEffect.GroupStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.sideEffect.IdentityStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.sideEffect.InjectStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.sideEffect.ProfileStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.sideEffect.SackElementValueStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.sideEffect.SackObjectStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.sideEffect.SideEffectCapStep;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.sideEffect.SideEffectStep;
...
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.sideEffect.SubgraphStep;
...
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.util.PathIdentityStep;
import com.apache.tinkerpop.gremlin.process.graph.util.HasContainer;
import com.apache.tinkerpop.gremlin.process.traversal.lambda.ElementValueTraversal;
import com.apache.tinkerpop.gremlin.process.traversal.lambda.FilterTraversal;
import com.apache.tinkerpop.gremlin.process.traversal.lambda.FilterTraverserTraversal;
import com.apache.tinkerpop.gremlin.process.traversal.lambda.IdentityTraversal;
import com.apache.tinkerpop.gremlin.process.traversal.lambda.MapTraversal;
import com.apache.tinkerpop.gremlin.process.traversal.lambda.MapTraverserTraversal;
import com.apache.tinkerpop.gremlin.process.traversal.lambda.TrueTraversal;
import com.apache.tinkerpop.gremlin.process.traversal.step.ElementFunctionComparator;
import com.apache.tinkerpop.gremlin.process.traversal.step.ElementValueComparator;
...
import com.apache.tinkerpop.gremlin.structure.Contains;
