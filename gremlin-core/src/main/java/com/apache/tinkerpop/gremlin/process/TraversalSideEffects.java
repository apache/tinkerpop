...
public interface TraversalSideEffects extends Cloneable {
    ...
    /**
     * In a distributed {@link com.apache.tinkerpop.gremlin.process.computer.GraphComputer} traversal, the sideEffects of the traversal are not a single object within a single JVM.
     * Instead, the sideEffects are distributed across the graph and the pieces are stored on the computing vertices.
     * This method is necessary to call when the {@link com.apache.tinkerpop.gremlin.process.Traversal} is processing the {@link com.apache.tinkerpop.gremlin.process.Traverser}s at a particular {@link com.apache.tinkerpop.gremlin.structure.Vertex}.
     *
