 ...
 * over the vertices in the {@link com.apache.tinkerpop.gremlin.structure.Graph}. It is up to the {@link GraphComputer} implementation to determine the
...
public interface GraphComputer {
     ...
     *
     * @return a {@link Future} denoting a reference to the asynchronous computation and where to get the {@link com.apache.tinkerpop.gremlin.process.computer.util.DefaultComputerResult} when its is complete.
     */
