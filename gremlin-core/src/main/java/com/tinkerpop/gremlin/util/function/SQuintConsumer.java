 ...
 * {@link SQuintConsumer} is expected to operate via side-effects.
 * <p>
...
public interface SQuintConsumer<A, B, C, D, E> extends Serializable {
     ...
     * @return a composed {@link SQuintConsumer} that performs in sequence this
     * operation followed by the {@code after} operation
     * @throws NullPointerException if {@code after} is null
     */
    public default SQuintConsumer<A, B, C, D, E> andThen(final SQuintConsumer<? super A, ? super B, ? super C, ? super D, ? super E> after) {
