 ...
 */
@FunctionalInterface
public interface SHexFunction<A, B, C, D, E, F, R> extends Serializable {
     ...
     */
    public default <V> SHexFunction<A, B, C, D, E, F, V> andThen(final Function<? super R, ? extends V> after) {
