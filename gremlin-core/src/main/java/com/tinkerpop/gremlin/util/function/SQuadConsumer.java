 ...
 * {@link SQuadConsumer} is expected to operate via side-effects.
 * <p>
...
public interface SQuadConsumer<A, B, C, D> extends Serializable {
     ...
     * @return a composed {@link SQuadConsumer} that performs in sequence this
     * operation followed by the {@code after} operation
     * @throws NullPointerException if {@code after} is null
     */
    public default SQuadConsumer<A, B, C, D> andThen(final SQuadConsumer<? super A, ? super B, ? super C, ? super D> after) {
