 ...
 * {@link SHexConsumer} is expected to operate via side-effects.
 * <p>
 ...
 */
public interface SHexConsumer<A, B, C, D, E, F> extends Serializable {
     ...
     * @return a composed {@link SHexConsumer} that performs in sequence this
     * operation followed by the {@code after} operation
     * @throws NullPointerException if {@code after} is null
     */
    public default SHexConsumer<A, B, C, D, E, F> andThen(final SHexConsumer<? super A, ? super B, ? super C, ? super D, ? super E, ? super F> after) {
