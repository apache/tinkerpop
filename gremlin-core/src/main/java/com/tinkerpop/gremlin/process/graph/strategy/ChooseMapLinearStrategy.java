 ...
 */
public class ChooseMapLinearStrategy implements TraversalStrategy.NoDependencies {

    // TODO: recursively linearlize as a branch could have a choose() step (so forth and so on)

    private static final ChooseMapLinearStrategy INSTANCE = new ChooseMapLinearStrategy();

    private ChooseMapLinearStrategy() {
    }
    ...
    public void apply(final Traversal<?, ?> traversal) {
        ...
        for (final ChooseMapStep chooseStep : TraversalHelper.getStepsOfClass(ChooseMapStep.class, traversal)) {
    ...
    public static ChooseMapLinearStrategy instance() {
        return INSTANCE;
    }
}
