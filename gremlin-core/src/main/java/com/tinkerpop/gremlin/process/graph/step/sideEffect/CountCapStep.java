 ...
 */
public class CountCapStep<S> extends SideEffectStep<S> implements SideEffectCapable, Barrier, MapReducer<MapReduce.NullObject, Long, MapReduce.NullObject, Long, Long> {
