 ...
 */
public final class SumStep extends LazyBarrierStep<Number, Double> implements Reducing<Double, Traverser<Number>> {
    ...
    public SumStep(final Traversal traversal) {
        ...
        this.setFunction((seed, start) -> seed + (start.get().doubleValue() * start.bulk()));
    }
