 ...
 * {@link com.tinkerpop.gremlin.structure.strategy.Strategy.StrategyContext} which contains the context of the call being made and will have
 * a different {@link com.tinkerpop.gremlin.structure.strategy.Strategy.StrategyContext#getCurrent()} object depending on that context (e.g the
...
public interface GraphStrategy {
     ...
     */
    public default UnaryOperator<Function<Object[], Iterator<Vertex>>> getGraphIteratorsVertexIteratorStrategy(final Strategy.StrategyContext<StrategyGraph> ctx) {
     ...
     * and returns an enhanced strategy {@link java.util.function.Supplier} with the same signature
     */
    public default UnaryOperator<Function<Object[], Iterator<Edge>>> getGraphIteratorsEdgeIteratorStrategy(final Strategy.StrategyContext<StrategyGraph> ctx) {
        return UnaryOperator.identity();
    }
     ...
     * and returns an enhanced strategy {@link java.util.function.Supplier} with the same signature
     */
    public default UnaryOperator<Supplier<Set<String>>> getVariableKeysStrategy(final Strategy.StrategyContext<StrategyVariables> ctx) {
        return UnaryOperator.identity();
    }
     ...
     * and returns an enhanced strategy {@link java.util.function.Supplier} with the same signature
     */
    public default UnaryOperator<Supplier<Map<String, Object>>> getVariableAsMapStrategy(final Strategy.StrategyContext<StrategyVariables> ctx) {
        return UnaryOperator.identity();
    }
     ...
     */
    public default <R> UnaryOperator<Function<String, Optional<R>>> getVariableGetStrategy(final Strategy.StrategyContext<StrategyVariables> ctx) {
        return UnaryOperator.identity();
    }
     ...
     */
    public default UnaryOperator<BiConsumer<String, Object>> getVariableSetStrategy(final Strategy.StrategyContext<StrategyVariables> ctx) {
        return UnaryOperator.identity();
    }
     ...
     * and returns an enhanced strategy {@link java.util.function.BiConsumer} with the same signature
     */
    public default UnaryOperator<Consumer<String>> getVariableRemoveStrategy(final Strategy.StrategyContext<StrategyVariables> ctx) {
        return UnaryOperator.identity();
    }
     ...
     * and returns an enhanced strategy {@link java.util.function.Function} with the same signature
     */
    public default UnaryOperator<Function<Object[], Vertex>> getAddVertexStrategy(final Strategy.StrategyContext<StrategyGraph> ctx) {
        return UnaryOperator.identity();
    }
     ...
     * and returns an enhanced strategy {@link java.util.function.Function} with the same signature
     */
    public default UnaryOperator<TriFunction<String, Vertex, Object[], Edge>> getAddEdgeStrategy(final Strategy.StrategyContext<StrategyVertex> ctx) {
        return UnaryOperator.identity();
    }
     ...
     * and returns an enhanced strategy {@link java.util.function.Supplier} with the same signature
     */
    public default UnaryOperator<Supplier<Void>> getRemoveEdgeStrategy(final Strategy.StrategyContext<StrategyEdge> ctx) {
        return UnaryOperator.identity();
    }
     ...
     * and returns an enhanced strategy {@link java.util.function.Supplier} with the same signature
     */
    public default UnaryOperator<Supplier<Void>> getRemoveVertexStrategy(final Strategy.StrategyContext<StrategyVertex> ctx) {
        return UnaryOperator.identity();
    }
     ...
     * and returns an enhanced strategy {@link java.util.function.Supplier} with the same signature
     */
    public default <V> UnaryOperator<Supplier<Void>> getRemovePropertyStrategy(final Strategy.StrategyContext<StrategyProperty<V>> ctx) {
        return UnaryOperator.identity();
    }
     ...
     * and returns an enhanced strategy {@link java.util.function.Supplier} with the same signature
     */
    public default <V> UnaryOperator<Supplier<Void>> getRemoveVertexPropertyStrategy(final Strategy.StrategyContext<StrategyVertexProperty<V>> ctx) {
        return UnaryOperator.identity();
    }
     ...
     * and returns an enhanced strategy {@link java.util.function.Function} with the same signature
     */
    public default <V> UnaryOperator<Function<String, VertexProperty<V>>> getVertexGetPropertyStrategy(final Strategy.StrategyContext<StrategyVertex> ctx) {
        return UnaryOperator.identity();
    }
     ...
     * and returns an enhanced strategy {@link java.util.function.Supplier} with the same signature
     */
    public default UnaryOperator<Supplier<Set<String>>> getVertexKeysStrategy(final Strategy.StrategyContext<StrategyVertex> ctx) {
        return UnaryOperator.identity();
    }
     ...
     * and returns an enhanced strategy {@link java.util.function.Supplier} with the same signature
     */
    public default UnaryOperator<Supplier<String>> getVertexLabelStrategy(final Strategy.StrategyContext<StrategyVertex> ctx) {
        return UnaryOperator.identity();
    }
     ...
     */
    public default <V> UnaryOperator<BiFunction<String, V, VertexProperty<V>>> getVertexPropertyStrategy(final Strategy.StrategyContext<StrategyVertex> ctx) {
        return UnaryOperator.identity();
    }
     ...
     * and returns an enhanced strategy {@link java.util.function.Supplier} with the same signature
     */
    public default <V> UnaryOperator<Function<String[], Iterator<VertexProperty<V>>>> getVertexIteratorsPropertyIteratorStrategy(final Strategy.StrategyContext<StrategyVertex> ctx) {
        return UnaryOperator.identity();
    }
     ...
     * and returns an enhanced strategy {@link java.util.function.Supplier} with the same signature
     */
    public default UnaryOperator<BiFunction<Direction, String[], Iterator<Vertex>>> getVertexIteratorsVertexIteratorStrategy(final Strategy.StrategyContext<StrategyVertex> ctx) {
        return UnaryOperator.identity();
    }
     ...
     * and returns an enhanced strategy {@link java.util.function.Supplier} with the same signature
     */
    public default UnaryOperator<BiFunction<Direction, String[], Iterator<Edge>>> getVertexIteratorsEdgeIteratorStrategy(final Strategy.StrategyContext<StrategyVertex> ctx) {
        return UnaryOperator.identity();
    }
     ...
     * and returns an enhanced strategy {@link java.util.function.Supplier} with the same signature
     */
    public default <V> UnaryOperator<Function<String[], Iterator<V>>> getVertexIteratorsValueIteratorStrategy(final Strategy.StrategyContext<StrategyVertex> ctx) {
        return UnaryOperator.identity();
    }
     ...
     * and returns an enhanced strategy {@link java.util.function.Supplier} with the same signature
     */
    public default UnaryOperator<Supplier<Object>> getVertexIdStrategy(final Strategy.StrategyContext<StrategyVertex> ctx) {
        return UnaryOperator.identity();
    }
     ...
     * and returns an enhanced strategy {@link java.util.function.Supplier} with the same signature
     */
    public default UnaryOperator<Supplier<Graph>> getVertexGraphStrategy(final Strategy.StrategyContext<StrategyVertex> ctx) {
        return UnaryOperator.identity();
    }
     ...
     * and returns an enhanced strategy {@link java.util.function.Function} with the same signature
     */
    public default <V> UnaryOperator<Function<String, V>> getVertexValueStrategy(final Strategy.StrategyContext<StrategyVertex> ctx) {
        return UnaryOperator.identity();
    }
     ...
     * and returns an enhanced strategy {@link java.util.function.Function} with the same signature
     */
    public default <V> UnaryOperator<Function<String, Property<V>>> getEdgeGetPropertyStrategy(final Strategy.StrategyContext<StrategyEdge> ctx) {
        return UnaryOperator.identity();
    }
     ...
     * and returns an enhanced strategy {@link java.util.function.Supplier} with the same signature
     */
    public default UnaryOperator<Function<Direction, Iterator<Vertex>>> getEdgeIteratorsVertexIteratorStrategy(final Strategy.StrategyContext<StrategyEdge> ctx) {
        return UnaryOperator.identity();
    }
     ...
     * and returns an enhanced strategy {@link java.util.function.Supplier} with the same signature
     */
    public default <V> UnaryOperator<Function<String[], Iterator<V>>> getEdgeIteratorsValueIteratorStrategy(final Strategy.StrategyContext<StrategyEdge> ctx) {
        return UnaryOperator.identity();
    }
     ...
     * and returns an enhanced strategy {@link java.util.function.Supplier} with the same signature
     */
    public default <V> UnaryOperator<Function<String[], Iterator<Property<V>>>> getEdgeIteratorsPropertyIteratorStrategy(final Strategy.StrategyContext<StrategyEdge> ctx) {
        return UnaryOperator.identity();
    }
     ...
     * and returns an enhanced strategy {@link java.util.function.Supplier} with the same signature
     */
    public default UnaryOperator<Supplier<Set<String>>> getEdgeKeysStrategy(final Strategy.StrategyContext<StrategyEdge> ctx) {
        return UnaryOperator.identity();
    }
     ...
     * and returns an enhanced strategy {@link java.util.function.BiFunction} with the same signature
     */
    public default <V> UnaryOperator<BiFunction<String, V, Property<V>>> getEdgePropertyStrategy(final Strategy.StrategyContext<StrategyEdge> ctx) {
        return UnaryOperator.identity();
    }
     ...
     * and returns an enhanced strategy {@link java.util.function.Function} with the same signature
     */
    public default <V> UnaryOperator<Function<String, V>> getEdgeValueStrategy(final Strategy.StrategyContext<StrategyEdge> ctx) {
        return UnaryOperator.identity();
    }
     ...
     * and returns an enhanced strategy {@link java.util.function.Supplier} with the same signature
     */
    public default UnaryOperator<Supplier<Object>> getEdgeIdStrategy(final Strategy.StrategyContext<StrategyEdge> ctx) {
        return UnaryOperator.identity();
    }
     ...
     * and returns an enhanced strategy {@link java.util.function.Supplier} with the same signature
     */
    public default UnaryOperator<Supplier<Graph>> getEdgeGraphStrategy(final Strategy.StrategyContext<StrategyEdge> ctx) {
        return UnaryOperator.identity();
    }
     ...
     * and returns an enhanced strategy {@link java.util.function.Supplier} with the same signature
     */
    public default UnaryOperator<Supplier<String>> getEdgeLabelStrategy(final Strategy.StrategyContext<StrategyEdge> ctx) {
        return UnaryOperator.identity();
    }
     ...
     * and returns an enhanced strategy {@link java.util.function.Supplier} with the same signature
     */
    public default <V> UnaryOperator<Supplier<Object>> getVertexPropertyIdStrategy(final Strategy.StrategyContext<StrategyVertexProperty<V>> ctx) {
        return UnaryOperator.identity();
    }
     ...
     * and returns an enhanced strategy {@link java.util.function.Supplier} with the same signature
     */
    public default <V> UnaryOperator<Supplier<V>> getVertexPropertyValueStrategy(final Strategy.StrategyContext<StrategyVertexProperty<V>> ctx) {
        return UnaryOperator.identity();
    }
     ...
     * and returns an enhanced strategy {@link java.util.function.Supplier} with the same signature
     */
    public default <V> UnaryOperator<Supplier<String>> getVertexPropertyKeyStrategy(final Strategy.StrategyContext<StrategyVertexProperty<V>> ctx) {
        return UnaryOperator.identity();
    }
     ...
     * and returns an enhanced strategy {@link java.util.function.Supplier} with the same signature
     */
    public default <V, U> UnaryOperator<Function<String[], Iterator<Property<V>>>> getVertexPropertyIteratorsPropertyIteratorStrategy(final Strategy.StrategyContext<StrategyVertexProperty<U>> ctx) {
        return UnaryOperator.identity();
    }
     ...
     * and returns an enhanced strategy {@link java.util.function.Supplier} with the same signature
     */
    public default <V, U> UnaryOperator<Function<String[], Iterator<V>>> getVertexPropertyIteratorsValueIteratorStrategy(final Strategy.StrategyContext<StrategyVertexProperty<U>> ctx) {
        return UnaryOperator.identity();
    }
     ...
     * and returns an enhanced strategy {@link java.util.function.BiFunction} with the same signature
     */
    public default <V, U> UnaryOperator<BiFunction<String, V, Property<V>>> getVertexPropertyPropertyStrategy(final Strategy.StrategyContext<StrategyVertexProperty<U>> ctx) {
        return UnaryOperator.identity();
    }
     ...
     * and returns an enhanced strategy {@link java.util.function.Supplier} with the same signature
     */
    public default <V> UnaryOperator<Supplier<Graph>> getVertexPropertyGraphStrategy(final Strategy.StrategyContext<StrategyVertexProperty<V>> ctx) {
        return UnaryOperator.identity();
    }
     ...
     * and returns an enhanced strategy {@link java.util.function.Supplier} with the same signature
     */
    public default <V> UnaryOperator<Supplier<String>> getVertexPropertyLabelStrategy(final Strategy.StrategyContext<StrategyVertexProperty<V>> ctx) {
        return UnaryOperator.identity();
    }
     ...
     * and returns an enhanced strategy {@link java.util.function.Supplier} with the same signature
     */
    public default <V> UnaryOperator<Supplier<Set<String>>> getVertexPropertyKeysStrategy(final Strategy.StrategyContext<StrategyVertexProperty<V>> ctx) {
        return UnaryOperator.identity();
    }
     ...
     * and returns an enhanced strategy {@link java.util.function.Supplier} with the same signature
     */
    public default <V> UnaryOperator<Supplier<Vertex>> getVertexPropertyGetElementStrategy(final Strategy.StrategyContext<StrategyVertexProperty<V>> ctx) {
        return UnaryOperator.identity();
    }
     ...
     * and returns an enhanced strategy {@link java.util.function.Supplier} with the same signature
     */
    public default UnaryOperator<Supplier<Void>> getGraphCloseStrategy(final Strategy.StrategyContext<StrategyGraph> ctx) {
        return UnaryOperator.identity();
    }
     ...
     * and returns an enhanced strategy {@link java.util.function.Function} with the same signature
     */
    public default UnaryOperator<Function<Object[], GraphTraversal<Vertex, Vertex>>> getGraphVStrategy(final Strategy.StrategyContext<StrategyGraph> ctx) {
        return UnaryOperator.identity();
    }
     ...
     * and returns an enhanced strategy {@link java.util.function.Function} with the same signature
     */
    public default UnaryOperator<Function<Object[], GraphTraversal<Edge, Edge>>> getGraphEStrategy(final Strategy.StrategyContext<StrategyGraph> ctx) {
        return UnaryOperator.identity();
    }
     ...
     * and returns an enhanced strategy {@link java.util.function.Supplier} with the same signature
     */
    public default UnaryOperator<Supplier<GraphTraversal>> getGraphOfStrategy(final Strategy.StrategyContext<StrategyGraph> ctx) {
        return UnaryOperator.identity();
    }
     ...
     * and returns an enhanced strategy {@link java.util.function.Supplier} with the same signature
     */
    public default <V> UnaryOperator<Supplier<V>> getPropertyValueStrategy(final Strategy.StrategyContext<StrategyProperty<V>> ctx) {
        return UnaryOperator.identity();
    }
     ...
     * and returns an enhanced strategy {@link java.util.function.Supplier} with the same signature
     */
    public default <V> UnaryOperator<Supplier<String>> getPropertyKeyStrategy(final Strategy.StrategyContext<StrategyProperty<V>> ctx) {
        return UnaryOperator.identity();
    }
