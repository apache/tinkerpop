...
* Added typed numeric wrappers and `numberMode: 'precise'` connection option to `gremlin-javascript` for explicit control over numeric type serialization and deserialization.
