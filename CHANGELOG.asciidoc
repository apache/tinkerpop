...
* Added vector indexing to TinkerGraph with search services for `tinker.search.vector.topK.byElement` and `tinker.search.vector.topK.byEmbedding`.
* Added vector distance calculation functions for TinkerGraph.
* Renamed the regex based search service in TinkerGraph to `tinker.search.text`.
