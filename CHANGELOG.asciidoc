...
* Modified grammar to only require `id` for Vertex structure with `label` as optional, i.e. `Vertex(id)`, and removed the support for redundant `new` and `ReferenceVertex` keywords.
