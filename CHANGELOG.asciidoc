...
[[release-3-5-4]]
=== TinkerPop 3.5.4 (Release Date: NOT OFFICIALLY RELEASED YET)
...
* TINKERPOP-2708 Deprecated and removed functionality of the `connectOnStartup` option in `gremlin-javascript` to resolve potential `unhandledRejection` and race conditions.
