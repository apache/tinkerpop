...
* Added Tiny Gremlin semantics which provider a defined subset of Gremlin steps (navigation, filtering, value extraction, path tracking, range, ordering, looping, and local mutation) for use as an official lightweight Gremlin implementation.
