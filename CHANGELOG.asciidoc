...
* Added bulk `value_flag` `0x02` to List serializer in Java (read and write) and Python (read only) drivers.
* Added `bulking` header as a setting for server to return bulked traversers as bulklist
