...
* Moved `clock()` out of the Utility plugin. It is now available in Groovy and Java.
...
* Added `TraversableLambda` interfaces to allow steps to process such lambdas more easily.
