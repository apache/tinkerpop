...
* Add test cases to the Structure Suite to enforce consistent operations of reading properties after removal of their owning `Element`.
...
* Make the `toString` operations in `GraphStrategy` consistent.
* Add `VertexFeatures.supportsRemoveProperty`.
* Add `VertexPropertyFeatures.supportsRemoveProperty`.
* Add `EdgeFeatures.supportsRemoveProperty`.
* Add `VertexFeatures.supportsRemoveVertices`.
* Add `EdgeFeatures.supportsRemoveEdges`.
