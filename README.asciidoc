...
* link:http://tinkerpop.com/docs/3.0.0.M7/[user documentation]
* link:http://tinkerpop.com/javadocs/3.0.0.M7/core/[core javadoc]
* link:http://tinkerpop.com/javadocs/3.0.0.M7/full/[full javadoc]

Building and Testing
~~~~~~~~~~~~~~~~~~~~

* Build Project: `mvn clean install`
** Specify specific tests in a TinkerPop Suite to run: `mvn test -Dgremlin.tests={test class 1, test class 2...}` - note that including a specific test may require its inner class implementation (e.g. `com.tinkerpop.gremlin....UnionTest$ComputerTest`)
