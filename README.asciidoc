...
.. `svn co https://dist.apache.org/repos/dist/dev/incubator/tinkerpop/ /tmp` and `mkdir /tmp/tinkerpop/x.y.z`
.. `cp ~/.m2/repository/org/apache/tinkerpop/gremlin-console/x.y.z/gremlin-console-x.y.z-distribution.zip* /tmp/tinkerpop/x.y.z`
.. `cp ~/.m2/repository/org/apache/tinkerpop/gremlin-server/x.y.z/gremlin-server-x.y.z-distribution.zip* /tmp/tinkerpop/x.y.z`
.. `cp ~/.m2/repository/org/apache/tinkerpop/tinkerpop/x.y.z/tinkerpop-x.y.z-source-release.zip* /tmp/tinkerpop/x.y.z`
.. `cd /tmp/tinkerpop/x.y.z` and `for f in *.zip*; do  mv "$f" "apache-$f"; done`
