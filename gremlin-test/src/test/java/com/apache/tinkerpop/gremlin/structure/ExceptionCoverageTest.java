...
public class ExceptionCoverageTest {
    ...
    public void shouldCoverAllExceptionsInTests() {
        ...
        final Set<String> ignore = new HashSet<String>() {{
            ...
            add("com.apache.tinkerpop.gremlin.structure.Graph$Exceptions#argumentCanNotBeNull");

            // todo: need to write consistency tests for the following items still...........
            add("com.apache.tinkerpop.gremlin.process.computer.GraphComputer$Exceptions#adjacentElementPropertiesCanNotBeRead");
            add("com.apache.tinkerpop.gremlin.process.computer.GraphComputer$Exceptions#adjacentElementPropertiesCanNotBeWritten");
            add("com.apache.tinkerpop.gremlin.process.computer.GraphComputer$Exceptions#adjacentVerticesCanNotBeQueried");
        }};
