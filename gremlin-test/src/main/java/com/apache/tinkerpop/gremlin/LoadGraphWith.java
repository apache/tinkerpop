 ...
 * under the License.
 */
package com.apache.tinkerpop.gremlin;
...
import static com.apache.tinkerpop.gremlin.structure.Graph.Features.DataTypeFeatures.*;
import static com.apache.tinkerpop.gremlin.structure.Graph.Features.VertexFeatures.FEATURE_META_PROPERTIES;
import static com.apache.tinkerpop.gremlin.structure.Graph.Features.VertexFeatures.FEATURE_MULTI_PROPERTIES;
 ...
 * {@link GraphProvider#loadGraphData(com.apache.tinkerpop.gremlin.structure.Graph, LoadGraphWith, Class, String)} method
...
public @interface LoadGraphWith {
    ...
    public enum GraphData {
        ...
        /**
         * Load "The Crew" TinkerPop3 toy graph which includes {@link com.apache.tinkerpop.gremlin.structure.VertexProperty} data.
         */
        CREW,
    ...
    public static final String RESOURCE_PATH_PREFIX = "/com/apache/tinkerpop/gremlin/structure/io/kryo/";
