...
import com.apache.tinkerpop.gremlin.structure.Graph.Features.EdgeFeatures;
import com.apache.tinkerpop.gremlin.structure.Graph.Features.EdgePropertyFeatures;
import com.apache.tinkerpop.gremlin.structure.Graph.Features.GraphFeatures;
...
import static com.apache.tinkerpop.gremlin.structure.Graph.Features.ElementFeatures.*;
import static com.apache.tinkerpop.gremlin.structure.Graph.Features.GraphFeatures.*;
...
public class FeatureSupportTest {
    ...
    /**
     * Feature checks that test {@link com.apache.tinkerpop.gremlin.structure.Graph} functionality to determine if a feature should be on when it is marked
     * as not supported.
     */
    ...
    public static class GraphFunctionalityTest extends AbstractGremlinTest {
        ...
        /**
         * A {@link com.apache.tinkerpop.gremlin.structure.Graph} that does not support {@link com.apache.tinkerpop.gremlin.structure.Graph.Features.GraphFeatures#FEATURE_COMPUTER} must call
         * {@link com.apache.tinkerpop.gremlin.structure.Graph.Exceptions#graphComputerNotSupported()}.
         */
        @Test
        ...
        /**
         * A {@link com.apache.tinkerpop.gremlin.structure.Graph} that does not support {@link com.apache.tinkerpop.gremlin.structure.Graph.Features.GraphFeatures#FEATURE_TRANSACTIONS} must call
         * {@link com.apache.tinkerpop.gremlin.structure.Graph.Exceptions#transactionsNotSupported()}.
         */
        @Test
        ...
        /**
         * A {@link com.apache.tinkerpop.gremlin.structure.Graph} that does not support {@link com.apache.tinkerpop.gremlin.structure.Graph.Features.VariableFeatures#FEATURE_VARIABLES} must call
         * {@link com.apache.tinkerpop.gremlin.structure.Graph.Exceptions#variablesNotSupported()}.
         */
        @Test
    ...
    /**
     * Feature checks that test {@link com.apache.tinkerpop.gremlin.structure.Vertex} functionality to determine if a feature
    ...
    /**
     * Feature checks that test {@link com.apache.tinkerpop.gremlin.structure.Edge} functionality to determine if a feature
     * should be on when it is marked as not supported.
     */
    @ExceptionCoverage(exceptionClass = Vertex.Exceptions.class, methods = {
    ...
    /**
     * Feature checks that test {@link com.apache.tinkerpop.gremlin.structure.Element} {@link com.apache.tinkerpop.gremlin.structure.Property} functionality to determine if a feature should be on
    ...
    /**
     * Feature checks that tests if {@link com.apache.tinkerpop.gremlin.structure.Graph.Variables}
