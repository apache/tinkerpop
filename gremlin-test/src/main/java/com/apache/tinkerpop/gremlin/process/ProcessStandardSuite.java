...
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.util.TraversalSideEffectsTest;
...
import com.apache.tinkerpop.gremlin.process.util.PathTest;
 ...
 * implements {@link com.apache.tinkerpop.gremlin.GraphProvider} as a convenience only. It could be implemented in a
 * separate class file):
 * <p/>
 * <code>
 *
 ...
 * </code>
 * <p/>
 * Implementing {@link com.apache.tinkerpop.gremlin.GraphProvider} provides a way for the {@code ProcessStandardSuite} to
 ...
 * {@link com.apache.tinkerpop.gremlin.structure.Graph.Features} defined in the suite to determine which tests will be executed.
 * <br/>
 */
public class ProcessStandardSuite extends AbstractGremlinSuite {
    ...
    private static final Class<?>[] allTests = new Class<?>[]{
            ...
            com.apache.tinkerpop.gremlin.process.graph.traversal.step.map.PathTest.StandardTest.class,
    ...
    protected static Class<?>[] testsToEnforce = new Class<?>[]{
            ...
            MinTest.class,
            OrderTest.class,
            com.apache.tinkerpop.gremlin.process.graph.traversal.step.map.PathTest.class,
            SelectTest.class,
            VertexTest.class,
            UnfoldTest.class,
            ValueMapTest.class,
