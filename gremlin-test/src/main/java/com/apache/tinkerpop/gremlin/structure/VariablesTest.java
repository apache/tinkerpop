...
/**
 * Gremlin Test Suite for {@link com.apache.tinkerpop.gremlin.structure.Graph.Variables} operations.
 *
...
public class VariablesTest {
    ...
    /**
     * Basic tests to ensure that {@link com.apache.tinkerpop.gremlin.structure.Graph.Variables} have
    ...
    /**
     * Test exceptions around {@link com.apache.tinkerpop.gremlin.structure.Graph.Variables}.
     */
    ...
    /**
     * Ensure that the {@link com.apache.tinkerpop.gremlin.structure.Graph.Variables#asMap()} method returns some basics.
     * Other tests will enforce that all types are properly covered in {@link com.apache.tinkerpop.gremlin.structure.Graph.Variables}.
     */
    ...
    /**
     * Tests for feature support on {@link com.apache.tinkerpop.gremlin.structure.Graph.Variables}.  The tests validate if
     * {@link com.apache.tinkerpop.gremlin.structure.Graph.Features.VariableFeatures} should be turned on or off and if the
