...
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.map.match.Bindings;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.map.match.CrossJoinEnumerator;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.map.match.Enumerator;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.map.match.InnerJoinEnumerator;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.map.match.IteratorEnumerator;
import com.apache.tinkerpop.gremlin.process.graph.traversal.step.map.match.MatchStep;
import com.apache.tinkerpop.gremlin.process.traverser.B_O_PA_S_SE_SL_Traverser;
...
import static com.apache.tinkerpop.gremlin.LoadGraphWith.GraphData.GRATEFUL;
import static com.apache.tinkerpop.gremlin.LoadGraphWith.GraphData.MODERN;
import static com.apache.tinkerpop.gremlin.process.graph.traversal.__.as;
