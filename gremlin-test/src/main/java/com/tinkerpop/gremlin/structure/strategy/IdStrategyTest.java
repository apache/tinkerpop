...
public class IdStrategyTest {
    ...
    public static class DefaultIdStrategyInSafeModeTest extends AbstractGremlinTest {

        public DefaultIdStrategyInSafeModeTest() {
            super(SafeStrategy.instance(), IdStrategy.build(idKey).create());
        }

        @Test(expected = IllegalStateException.class)
        public void shouldBeInSafeMode() {
            ((StrategyGraph) g).getBaseGraph();
        }
