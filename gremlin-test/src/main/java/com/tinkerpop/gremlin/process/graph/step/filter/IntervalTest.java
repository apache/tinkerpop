...
public abstract class IntervalTest extends AbstractGremlinProcessTest {
    ...
    public abstract Traversal<Vertex, Vertex> get_g_VX1X_outE_intervalXweight_0_06X_inV(final Object v1Id);

    @Test
    @LoadGraphWith(MODERN)
    public void g_VX1X_outE_intervalXweight_0_06X_inV() {
        final Traversal<Vertex, Vertex> traversal = get_g_VX1X_outE_intervalXweight_0_06X_inV(convertToVertexId("marko"));
    ...
    public static class StandardTest extends IntervalTest {
        ...
        @Override
        public Traversal<Vertex, Vertex> get_g_VX1X_outE_intervalXweight_0_06X_inV(final Object v1Id) {
