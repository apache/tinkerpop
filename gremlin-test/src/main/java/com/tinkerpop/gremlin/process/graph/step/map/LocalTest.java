...
public abstract class LocalTest extends AbstractGremlinProcessTest {
    ...
    public abstract Traversal<Vertex, String> get_g_V_localXpropertiesXlocationX_orderByXvalueX_limitX2XX_value();
    ...
    public void g_V_localXpropertiesXlocationX_orderByXvalueX_limitX2XX_value() {
        final Traversal<Vertex, String> traversal = get_g_V_localXpropertiesXlocationX_orderByXvalueX_limitX2XX_value();
    ...
    public static class StandardTest extends LocalTest {
        ...
        public Traversal<Vertex, Long> get_g_V_localXoutE_countX() {
            return g.V().local(g.<Vertex>of().outE().count());
        }
    ...
    public static class ComputerTest extends LocalTest {
        ...
        @Override
        public Traversal<Vertex, Long> get_g_V_localXoutE_countX() {
            return g.V().local(g.<Vertex>of().outE().count()).submit(g.compute());
        }

        /*@Override
        public Traversal<Vertex, Map<Double, Long>> get_g_V_localXoutE_weight_groupCountX() {
            return g.V().local((Traversal) g.<Vertex>of().outE().values("weight").groupCount()).submit(g.compute());
        }*/
