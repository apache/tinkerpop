...
public abstract class AbstractGremlinTest {
    ...
    protected Object convertToVertexId(final Graph g, final String identifier) {
        return convertToVertex(g, identifier).id();
    }

    protected Vertex convertToVertex(final Graph g, final String identifier) {
        // all test graphs have "name" as a unique id which makes it easy to hardcode this...works for now
        return ((Vertex) g.V().has("name", identifier).next());
    }
