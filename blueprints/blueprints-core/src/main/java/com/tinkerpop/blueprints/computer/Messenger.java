 ...
 * For distributed systems, the messenger can implement a "message passing" system (distributed memory).
 * For single machine systems, the messenger can implement a "shared state" system (shared memory).
 *
