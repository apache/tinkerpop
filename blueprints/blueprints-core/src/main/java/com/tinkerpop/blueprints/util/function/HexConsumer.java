 ...
 * {@link com.tinkerpop.blueprints.util.function.HexConsumer} is expected to operate via side-effects.
 * <p/>
...
public interface HexConsumer<A,B,C,D,E,F> {
     ...
     * @return a composed {@link com.tinkerpop.blueprints.util.function.HexConsumer} that performs in sequence this
