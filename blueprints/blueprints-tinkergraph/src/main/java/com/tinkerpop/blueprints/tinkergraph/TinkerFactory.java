...
public class TinkerFactory {
    public static TinkerGraph createClassic() {
        ...
        final Vertex lop = graph.addVertex(Property.of(Property.Key.ID, 3, "name", "lop", "lang", "java"));
        final Vertex josh = graph.addVertex(Property.of(Property.Key.ID, 4, "name", "josh", "age", 32));
        final Vertex ripple = graph.addVertex(Property.of(Property.Key.ID, 5, "name", "ripple", "lang", "java"));
        final Vertex peter = graph.addVertex(Property.of(Property.Key.ID, 6, "name", "peter", "age", 35));
