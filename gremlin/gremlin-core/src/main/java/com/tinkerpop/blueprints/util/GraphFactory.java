...
/**
 * Factory to construct new {@link com.tinkerpop.blueprints.Graph} instances from a {@link org.apache.commons.configuration.Configuration} object or properties file.
 *
...
public class GraphFactory {
    ...
    /**
     * Open a graph.  See each {@link com.tinkerpop.blueprints.Graph} instance for its configuration options.
     *
     * @param configuration A configuration object that specifies the minimally required properties for a {@link com.tinkerpop.blueprints.Graph}
     *                      instance. This minimum is determined by the {@link com.tinkerpop.blueprints.Graph} instance itself.
     * @param strategy      A {@link com.tinkerpop.blueprints.strategy.GraphStrategy} to plug into the underlying {@link com.tinkerpop.blueprints.Graph} being constructed.
     * @return A {@link com.tinkerpop.blueprints.Graph} instance.
    ...
    /**
     * Open a graph.  See each {@link com.tinkerpop.blueprints.Graph} instance for its configuration options. This file may be XML, YAML,
     ...
     *                          for a {@link com.tinkerpop.blueprints.Graph} instance. This minimum is determined by the {@link com.tinkerpop.blueprints.Graph} instance
     *                          itself.
     * @return A {@link com.tinkerpop.blueprints.Graph} instance.
