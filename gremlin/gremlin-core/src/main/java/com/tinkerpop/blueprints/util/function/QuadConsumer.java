 ...
 * {@link com.tinkerpop.blueprints.util.function.QuadConsumer} is expected to operate via side-effects.
 * <p/>
...
public interface QuadConsumer<A,B,C,D> {
     ...
     * @return a composed {@link com.tinkerpop.blueprints.util.function.QuadConsumer} that performs in sequence this
