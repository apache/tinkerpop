...
public interface VertexProgram<M extends Serializable> extends Serializable {
     ...
     *
     * @param vertex      the {@link com.tinkerpop.blueprints.Vertex} to execute the {@link VertexProgram} on
     ...
     * to the {@link GraphComputer} and as such, is not called for each {@link com.tinkerpop.blueprints.Vertex}.
     *
