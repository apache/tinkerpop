...
/**
 * Utility class supporting common functions for {@link com.tinkerpop.blueprints.Element}.
 *
...
public class ElementHelper {
     ...
     * and that the key values in the list of arguments are {@link String} or {@link com.tinkerpop.blueprints.Element} objects.
     *
    ...
    /**
     * Extracts the value of the {@link com.tinkerpop.blueprints.Element#ID} key from the list of arguments.
     *
     * @param keyValues a list of key/value pairs
     * @return the value associated with {@link com.tinkerpop.blueprints.Element#ID}
     * @throws NullPointerException if the value for the {@link com.tinkerpop.blueprints.Element#ID} key is {@code null}
     */
    ...
    /**
     * Extracts the value of the {@link com.tinkerpop.blueprints.Element#LABEL} key from the list of arguments.
     *
     * @param keyValues a list of key/value pairs
     * @return the value associated with {@link com.tinkerpop.blueprints.Element#LABEL}
     * @throws ClassCastException   if the value of the label is not a {@link String}
     * @throws NullPointerException if the value for the {@link com.tinkerpop.blueprints.Element#LABEL} key is {@code null}
     */
    ...
    /**
     * Assign key/value pairs as properties to an {@link com.tinkerpop.blueprints.Element}.  If the value of {@link com.tinkerpop.blueprints.Element#ID} or
     * {@link com.tinkerpop.blueprints.Element#LABEL} is in the set of pairs, then they are ignored.
     *
    ...
    /**
     * A standard method for determining if two {@link com.tinkerpop.blueprints.Element} objects are equal. This method should be used by any
     * {@link Object#equals(Object)} implementation to ensure consistent behavior.
     *
     * @param a The first {@link com.tinkerpop.blueprints.Element}
     * @param b The second {@link com.tinkerpop.blueprints.Element} (as an {@link Object})
     ...
     *
     * @param a the first {@link com.tinkerpop.blueprints.Element}
     * @param b the second {@link com.tinkerpop.blueprints.Element}
    ...
    /**
     * A standard method for determining if two {@link com.tinkerpop.blueprints.Property} objects are equal. This method should be used by any
     * {@link Object#equals(Object)} implementation to ensure consistent behavior.
     *
     * @param a the first {@link com.tinkerpop.blueprints.Property}
     * @param b the second {@link com.tinkerpop.blueprints.Property}
