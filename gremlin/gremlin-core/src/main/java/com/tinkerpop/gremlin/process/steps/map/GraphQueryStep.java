 ...
 */
public class GraphQueryStep extends FlatMapStep<Element, Element> {

    public final Graph graph;
    public final GraphQueryBuilder queryBuilder;
    public final Class<? extends Element> returnClass;

    public GraphQueryStep(final Traversal traversal, final Graph graph, final GraphQueryBuilder queryBuilder, final Class<? extends Element> returnClass) {
        super(traversal);
