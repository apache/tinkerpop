 ...
 */
public class RetainPipe<S> extends FilterPipe<S> {

    public RetainPipe(final Traversal pipeline, final String variable) {
        super(pipeline);
    ...
    public RetainPipe(final Traversal pipeline, final Collection<S> exceptionCollection) {
        super(pipeline);
        this.setPredicate(holder -> exceptionCollection.contains(holder.get()));
    }

    public RetainPipe(final Traversal pipeline, final S exceptionObject) {
        super(pipeline);
