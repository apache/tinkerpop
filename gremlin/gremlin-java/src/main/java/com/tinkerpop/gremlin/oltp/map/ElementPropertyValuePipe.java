...
public class ElementPropertyValuePipe<E> extends MapPipe<Element, E> {
    ...
    public ElementPropertyValuePipe(final Pipeline pipeline, final String key) {
        super(pipeline);
        this.key = key;
    ...
    public ElementPropertyValuePipe(final Pipeline pipeline, final String key, final Supplier<E> defaultSupplier) {
        super(pipeline);
        this.key = key;
        this.defaultValue = Optional.empty();
