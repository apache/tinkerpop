...
public class ListTest {
    ...
    public void g_v1_listXlocationsX_intervalXstartTime_2004_2006X(final Iterator<AnnotatedValue<String>> pipe) {
    ...
    public void g_V_hasXlocationsX_listXlocationsX_hasXstartTime_2005X_value(final Iterator<String> pipe) {
