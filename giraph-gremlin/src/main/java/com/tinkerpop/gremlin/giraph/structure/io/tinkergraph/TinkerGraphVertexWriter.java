...
public class TinkerGraphVertexWriter extends VertexWriter {
    ...
    public void writeVertex(final Vertex giraphVertex) throws IOException {
        ...
        System.out.println(((GiraphVertex) giraphVertex).getGremlinVertex() + ":" + ((GiraphVertex) giraphVertex).getGremlinVertex().<TraversalCounters>getValue(PageRankVertexProgram.PAGE_RANK));
    }
