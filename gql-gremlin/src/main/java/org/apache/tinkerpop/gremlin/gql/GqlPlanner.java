 ...
 *
 * <p>Implementations are encouraged to cache the parsed {@link QueryGraph} keyed on the
 * query string; seed selection should be recomputed on each call so that graph mutations
 * are reflected in subsequent executions.</p>
 */
