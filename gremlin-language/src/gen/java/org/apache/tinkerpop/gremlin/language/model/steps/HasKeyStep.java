...
public abstract class HasKeyStep {
    private HasKeyStep() {}
    ...
    /**
     * An interface for applying a function to a HasKeyStep according to its variant (subclass)
     */
    ...
    /**
     * An interface for applying a function to a HasKeyStep according to its variant (subclass). If a visit() method for a
     * particular variant is not implemented, a default method is used instead.
     */
    public interface PartialVisitor<R> extends Visitor<R> {
        default R otherwise(HasKeyStep instance) {
     ...
     */
    public static final class Predicate extends HasKeyStep {
    ...
    public static final class WithLabels extends HasKeyStep {
